...
Error();k.equal=function(a,c,d){return k(a===c,d)};k.iface=function(a,c,d){k(a,c+" should be an object");for(var b in d)k.equal(h(a[b]),d[b],c+" should have property "+b+" as a "+d[b])};g.a=k},function(e,g,a){var l=this&&this.__extends||function(a,b){function c(){this.constructor=a}for(var d in b)b.hasOwnProperty(d)&&(a[d]=b[d]);a.prototype=null===b?Object.create(b):(c.prototype=b.prototype,new c)},k=a(42);e=a(5);var h=a(52),f=a(41);a=function(a){function b(d,f,k){a.call(this);this.syncErrorValue=
null;this.isStopped=this.syncErrorThrowable=this.syncErrorThrown=!1;switch(arguments.length){case 0:this.destination=h.empty;break;case 1:if(!d){this.destination=h.empty;break}if("object"===typeof d){d instanceof b?(this.destination=d,this.destination.add(this)):(this.syncErrorThrowable=!0,this.destination=new c(this,d));break}default:this.syncErrorThrowable=!0,this.destination=new c(this,d,f,k)}}l(b,a);b.prototype[f.$$rxSubscriber]=function(){return this};b.create=function(a,c,d){a=new b(a,c,d);
...
g,a){e=a(156);g.merge=e.mergeStatic},function(e,g,a){var l=a(7),k=a(16),h=a(64),f=a(0),c=a(39),d=a(131),b=a(40);g.subscribeToResult=function(a,n,e,g){var m=new d.InnerSubscriber(a,e,g);if(m.closed)return null;if(n instanceof f.Observable)return n._isScalar?(m.next(n.value),m.complete(),null):n.subscribe(m);if(k.isArray(n)){a=0;for(e=n.length;a<e&&!m.closed;a++)m.next(n[a]);m.closed||m.complete()}else{if(h.isPromise(n))return n.then(function(a){m.closed||(m.next(a),m.complete())},function(a){return m.error(a)}).then(null,
function(a){l.root.setTimeout(function(){throw a;})}),m;if("function"===typeof n[c.$$iterator]){n=n[c.$$iterator]();do{a=n.next();if(a.done){m.complete();break}m.next(a.value);if(m.closed)break}while(1)}else if("function"===typeof n[b.$$observable])if(n=n[b.$$observable](),"function"!==typeof n.subscribe)m.error(Error("invalid observable"));else return n.subscribe(new d.InnerSubscriber(a,e,g));else m.error(new TypeError("unknown type returned"))}return null}},function(e,g,a){g.isArray=Array.isArray||
function(a){return a&&"number"===typeof a.length}},function(e,g,a){g.isScheduler=function(a){return a&&"function"===typeof a.schedule}},function(e,g,a){function l(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function");}function k(a){for(var b=a.length,c=[],d=0;d<b;d++)c.push(new r(a.start(d),a.end(d),0));return c}function h(a){for(var b=a.length,c=[],d=0;d<b;d++)c.push(a[d].clone());return c}function f(a,b){return a.start<=b&&b<a.end}function c(a,b){for(var c=0;c<b.length;c++)if(d(a,
b[c]))return b[c];return null}function d(a,b){return f(a,b.start)||f(a,b.end)||f(b,a.start)}function b(a,b){return f(a,b.start)&&f(a,b.end)}function m(a){for(var b=1;b<a.length;b++){var c=a[b-1],d=a[b];c.bitrate===d.bitrate&&(Math.abs(d.start-c.end)<p||Math.abs(d.end-c.start)<p)&&(c=new r(Math.min(c.start,d.start),Math.max(c.end,d.end),d.bitrate),a.splice(--b,2,c))}return a}function n(a){a=h(a);for(var b=0;b<a.length;b++)a[b].bitrate=0;return m(a)}a.d(g,"b",function(){return k});a.d(g,"a",function(){return q});
a(1);var p=1/60,r=function(){function a(b,c,d){l(this,a);this.start=b;this.end=c;this.bitrate=d}a.prototype.isNil=function(){return this.start===this.end};a.prototype.clone=function(){return new a(this.start,this.end,this.bitrate)};return a}(),q=function(){function a(b){l(this,a);this.ranges=b=b?Array.isArray(b)?h(b):k(b):[];this.length=b.length}a.prototype.start=function(a){return this.ranges[a].start};a.prototype.end=function(a){return this.ranges[a].end};a.prototype.hasRange=function(a,b){for(var c=
a+b,d=0;d<this.ranges.length;d++){var f=this.ranges[d],m=f.start,f=f.end;if(m-a<=p&&a-f<=p&&m-c<=p&&c-f<=p)return this.ranges[d]}return null};a.prototype.getRange=function(a){for(var b=0;b<this.ranges.length;b++)if(f(this.ranges[b],a))return this.ranges[b];return null};a.prototype.getOuterRanges=function(a){for(var b=[],c=0;c<this.ranges.length;c++)f(this.ranges[c],a)||b.push(this.ranges[c]);return b};a.prototype.getGap=function(a){var b=this.getRange(a);return b?b.end-a:Infinity};a.prototype.getLoaded=
function(a){var b=this.getRange(a);return b?a-b.start:0};a.prototype.getSize=function(a){return(a=this.getRange(a))?a.end-a.start:0};a.prototype.getNextRangeGap=function(a){for(var b=this.ranges,c=-1,d=void 0;++c<b.length;){var f=b[c].start;if(f>a){d=f;break}}return null!=d?d-a:Infinity};a.prototype.insert=function(a,c,f){var h=this.ranges;a=new r(c,f,a);if(!a.isNil()){for(c=0;c<h.length;c++){f=h[c];var k=d(a,f),n=Math.abs(f.start-a.end)<p||Math.abs(f.end-a.start)<p;if(k||n)if(a.bitrate===f.bitrate)a=
new r(Math.min(a.start,f.start),Math.max(a.end,f.end),f.bitrate),h.splice(c--,1);else if(k)if(b(f,a))h.splice(++c,0,a),k=f.end,f.end=a.start,a=new r(a.end,k,f.bitrate);else if(b(a,f))h.splice(c--,1);else if(f.start<a.start)f.end=a.start;else{f.start=a.end;break}else break;else if(0===c){if(a.end<=h[0].start)break}else if(h[c-1].end<=a.start&&a.end<=f.start)break}h.splice(c,0,a);for(a=0;a<h.length;a++)h[a].isNil()&&h.splice(a++,1);m(h)}this.length=this.ranges.length;return this.ranges};a.prototype.remove=
function(b,c){this.intersect(new a([new r(0,b,0),new r(c,Infinity,0)]))};a.prototype.equals=function(a){a:{var b=a.ranges;a=n(this.ranges);for(var b=n(b),d=0;d<a.length;d++){var f=a[d],m=c(f,b);if(!(m&&Math.abs(m.start-f.start)<p&&Math.abs(m.end-f.end)<p)){a=!1;break a}}a=!0}return a};a.prototype.intersect=function(a){var b=this.ranges;a=a.ranges;for(var d=0;d<b.length;d++){var f=b[d],m=c(f,a);m?(m.start>f.start&&(f.start=m.start),m.end<f.end&&(f.end=m.end)):b.splice(d--,1)}this.length=this.ranges.length;
return this.ranges};return a}()},function(e,g,a){a.d(g,"a",function(){return l});var l=function h(){var a=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};if(!(this instanceof h))throw new TypeError("Cannot call a class as a function");this.id=a.id;this.duration=a.duration;this.isInit=!!a.init;this.range=a.range;this.time=a.time;this.indexRange=a.indexRange;this.number=a.number;this.timescale=a.timescale}},function(e,g,a){function l(a){if(null!=a){var b;"string"===typeof a?(b=a,a=!1):(b=
f(a.language),a=!!a.closedCaption);return{language:b,closedCaption:a}}}function k(a){if(null!=a){var b;"string"===typeof a?(b=a,a=!1):(b=f(a.language),a=!!a.audioDescription);return{language:b,audioDescription:a}}}function h(a,m){if(!m)return-1;m=f(m);for(var h=d;h<=b;h++)for(var k=0;k<a.length;k++){var n;n=f(a[k]);var e=m,g=h;if(n===e)n=!0;else{var p=n.split("-")[0],e=e.split("-")[0];n=g>=c.BASE_LANG_MATCH&&n===e?!0:g>=c.OTHER_SUBLANG_MATCH&&p===e?!0:!1}if(n)return k}return-1}function f(a){if(null==
a||""===a)return"";a=(""+a).toLowerCase().split("-");var b=a[0],c=void 0;2===b.length?c=m[b]:3===b.length&&(c=n[b]);(b=c||b)&&(a[0]=b);return a.join("-")}a.d(g,"c",function(){return f});a.d(g,"a",function(){return k});a.d(g,"b",function(){return l});a.d(g,"d",function(){return h});var c={PERFECT_MATCH:0,BASE_LANG_MATCH:1,OTHER_SUBLANG_MATCH:2},d=c.PERFECT_MATCH,b=c.OTHER_SUBLANG_MATCH,m={aa:"aar",ab:"abk",ae:"ave",af:"afr",ak:"aka",am:"amh",an:"arg",ar:"ara",as:"asm",av:"ava",ay:"aym",az:"aze",ba:"bak",
...
za:"zha",zh:"chi",zu:"zul"},n={tib:"bod",cze:"ces",wel:"cym",ger:"deu",gre:"ell",eus:"baq",per:"fas",fra:"fre",hye:"arm",isl:"ice",kat:"geo",mri:"mao",mkd:"mac",msa:"may",mya:"bur",nld:"dut",rum:"ron",slo:"slk",sqi:"alb",zho:"chi"}},function(e,g,a){var l=a(17),k=a(16),h=a(13),f=a(145);g.combineLatest=function(){for(var a=[],d=0;d<arguments.length;d++)a[d-0]=arguments[d];var b=d=null;l.isScheduler(a[a.length-1])&&(b=a.pop());"function"===typeof a[a.length-1]&&(d=a.pop());1===a.length&&k.isArray(a[0])&&
(a=a[0]);return(new h.ArrayObservable(a,b)).lift(new f.CombineLatestOperator(d))}},function(e,g,a){function l(a,c){if("function"!==typeof c&&null!==c)throw new TypeError("Super expression must either be null or a function, not "+typeof c);a.prototype=Object.create(c&&c.prototype,{constructor:{value:a,enumerable:!1,writable:!0,configurable:!0}});c&&(Object.setPrototypeOf?Object.setPrototypeOf(a,c):a.__proto__=c)}function k(a,c){if(!(a instanceof c))throw new TypeError("Cannot call a class as a function");
}function h(a){return"number"==typeof a&&!isNaN(a)||!isNaN(+a)?!0:!1}a.d(g,"b",function(){return c});a.d(g,"a",function(){return d});var f=a(34),c=function(){function b(a,c,d,f,e,g,l,w,v,y){k(this,b);this.id=d;this.ada=a;this.rep=c;this.time=h(e)?+e:-1;this.duration=h(g)?+g:-1;this.number=h(l)?+l:-1;this.media=f?""+f:"";this.range=Array.isArray(w)?w:null;this.indexRange=Array.isArray(v)?v:null;this.init=!!y}b.create=function(a,c,d,f,h,k,e,g,l,y){return new b(a,c,a.id+"_"+c.id+"_"+d,f,h,k,e,g,l,y)};
b.prototype.getId=function(){return this.id};b.prototype.getAdaptation=function(){return this.ada};b.prototype.getRepresentation=function(){return this.rep};b.prototype.getTime=function(){return this.time};b.prototype.getDuration=function(){return this.duration};b.prototype.getNumber=function(){return this.number};b.prototype.getMedia=function(){return this.media};b.prototype.getRange=function(){return this.range};b.prototype.getIndexRange=function(){return this.indexRange};b.prototype.isInitSegment=
function(){return this.init};b.prototype.getResolvedURL=function(){return a.i(f.b)(this.ada.rootURL,this.ada.baseURL,this.rep.baseURL)};return b}(),d=function(a){function b(c,d,f,h,m){k(this,b);c=a.call(this,c,d,c.id+"_"+d.id+"_init",f,-1,-1,-1,h,m,!0);if(!this)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!c||"object"!==typeof c&&"function"!==typeof c?this:c}l(b,a);return b}(c)},function(e,g,a){a.d(g,"a",function(){return h});var l=a(25),k=a(32),h=function(){function f(){var c=
0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};if(!(this instanceof f))throw new TypeError("Cannot call a class as a function");var d=a.i(k.a)();this.id=null==c.id?d:""+c.id;this.type=c.type||"";this.representations=Array.isArray(c.representations)?c.representations.map(function(a){return new l.a(a)}).sort(function(a,c){return a.bitrate-c.bitrate}):[];null!=c.lang?this.language=c.lang:null!=c.language&&(this.language=c.language);d=c.accessibility;Array.isArray(d)&&(d.includes("audioDescription")&&
(this.isAudioDescription=!0),d.includes("closedCaption")&&(this.isClosedCaption=!0));this.manual=c.manual}f.prototype.getAvailableBitrates=function(){return this.representations.map(function(a){return a.bitrate})};f.prototype.getRepresentationsForBitrate=function(a){return this.representations.filter(function(c){return c.bitrate===a})||null};return f}()},function(e,g,a){a.d(g,"b",function(){return l});a.d(g,"a",function(){return k});var l=function(a,f,c){var d=a.presentationTimeOffset||0;a=a.timescale||
1;return{up:f*a-d,to:(f+c)*a-d}},k=function(a){var f=a.ts,c=a.d;a=a.r;return-1===c?f:f+(a+1)*c}},function(e,g,a){a.d(g,"a",function(){return h});var l=a(32),k=a(115),h=function c(){var d=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};if(!(this instanceof c))throw new TypeError("Cannot call a class as a function");var b=a.i(l.a)();this.id=null==d.id?b:""+d.id;this.bitrate=d.bitrate;this.codec=d.codecs;null!=d.height&&(this.height=d.height);null!=d.width&&(this.width=d.width);null!=d.mimeType&&
(this.mimeType=d.mimeType);this.index=new k.a({index:d.index,rootId:this.id})}},function(e,g,a){e=a(59);a=a(60);g.async=new a.AsyncScheduler(e.AsyncAction)},function(e,g,a){g.errorObject={e:{}}},function(e,g,a){var l=a(22);e=function(){function a(h,f,c){if(!(this instanceof a))throw new TypeError("Cannot call a class as a function");this.adaptation=h;this.representation=f;this.index=c}a.getRangeEnd=function(a){var f=a.ts,c=a.d;a=a.r;return-1===c?f:f+(a+1)*c};a.getLiveEdge=function(h,f){var c=a.getRangeEnd(h.timeline[h.timeline.length-
1])/h.timescale-f.suggestedPresentationDelay;return Math.max(h.timeline[0].ts/h.timescale+1,c)};a.prototype.createSegment=function(a,f,c){return l.b.create(this.adaptation,this.representation,a,this.index.media,a,c,0,f,null,!1)};a.prototype.calculateRepeat=function(a,f){var c=a.r||0;0>c&&(c=Math.ceil(((f?f.t:Infinity)-a.ts)/a.d)-1);return c};a.prototype.checkDiscontinuity=function(h){var f=this.index.timeline;if(0>=h)return-1;var c=this.getSegmentIndex(h);if(0>c||c>=f.length-1)return-1;var d=f[c];
...
0};a.prototype.getSegments=function(a,f){var c=this.index.timeline,d=[],b=c.length,m=this.getSegmentIndex(a)-1,h=c.length&&c[0].d||0;a:for(;!(++m>=b);){var k=c[m],e=k.d,g=k.ts,l=k.range,h=Math.max(h,e);if(0>e){g+h<f&&d.push(this.createSegment(g,l,void 0));break}for(var k=this.calculateRepeat(k,c[m+1]),t=this.getSegmentNumber(g,a,e),w;(w=g+t*e)<f;)if(t++<=k)d.push(this.createSegment(w,l,e));else continue a;break}return d};a.prototype.addSegment=function(h,f){var c=this.index.timeline,d=c.length,b=
c[d-1];if(f&&h.ts===f.ts){var m=h.ts+h.d,k=m-(b.ts+b.d*b.r);if(0>=k)return!1;-1===b.d&&((d=c[d-2])&&d.d===k?(d.r++,c.pop()):b.d=k);c.push({d:-1,ts:m,r:0});return!0}return h.ts>=a.getRangeEnd(b)?(b.d===h.d?b.r++:c.push({d:h.d,ts:h.ts,r:0}),!0):!1};return a}();g.a=e},function(e,g,a){function l(b){var c=a.i(y.a)(b.locations[0]);(b=b.periods[0])&&b.baseURL&&(c+=""+b.baseURL);return c}function k(a,b,f,k){if(!b.transportType)throw new B.d("MANIFEST_PARSE_ERROR",null,!0);b.id=b.id||C++;b.type=b.type||"static";
var e=b.locations;e&&e.length||(b.locations=[a]);b.isLive="dynamic"==b.type;var n={rootURL:l(b),baseURL:b.baseURL,isLive:b.isLive};f&&(f=c(f));k&&(k=d(k));a=b.periods.map(function(a){return h(a,n,f,k)});b=m(b,a[0]);b.periods=null;b.duration||(b.duration=Infinity);b.isLive&&(b.suggestedPresentationDelay=b.suggestedPresentationDelay||D,b.availabilityStartTime=b.availabilityStartTime||0);return b}function h(a,b,c,d){a.id=a.id||C++;var m=a.adaptations,m=m.concat(c||[]),m=m.concat(d||[]),m=m.map(function(a){return f(a,
b)}),m=m.filter(function(a){return 0>H.indexOf(a.type)?(v.a.info("not supported adaptation type",a.type),!1):!0});if(0===m.length)throw new B.d("MANIFEST_PARSE_ERROR",null,!0);c={};for(d=0;d<m.length;d++){var h=m[d],k=h.type,e=h.representations;c[k]=c[k]||[];0<e.length&&c[k].push(h)}for(var n in c)if(0===c[n].length)throw new B.d("MANIFEST_INCOMPATIBLE_CODECS_ERROR",null,!0);a.adaptations=c;return a}function f(b,c){if("undefined"==typeof b.id)throw new B.d("MANIFEST_PARSE_ERROR",null,!0);var d=m(c,
b),f={};G.forEach(function(a){a in d&&(f[a]=d[a])});var h=d.representations.map(function(a){if("undefined"==typeof a.id)throw new B.d("MANIFEST_PARSE_ERROR",null,!0);a=m(f,a);a.index=a.index||{};a.index.timescale||(a.index.timescale=1);a.bitrate||(a.bitrate=1);"mp4a.40.02"==a.codecs&&(a.codecs="mp4a.40.2");return a}).sort(function(a,b){return a.bitrate-b.bitrate}),k=d.type,e=d.accessibility,e=void 0===e?[]:e;if(!k)throw new B.d("MANIFEST_PARSE_ERROR",null,!0);"video"==k||"audio"==k?(h=h.filter(function(b){return a.i(u.k)(r(b))}),
"audio"===k&&(k=e.includes("visuallyImpaired"),d.audioDescription=k)):"text"===k&&(k=e.includes("hardOfHearing"),d.closedCaption=k);d.representations=h;d.bitrates=h.map(function(a){return a.bitrate});return d}function c(a){Array.isArray(a)||(a=[a]);return a.reduce(function(a,b){var c=b.mimeType,d=b.url,f=b.language,m=b.languages,h=b.closedCaption;f&&(m=[f]);return a.concat(m.map(function(a){return{id:C++,type:"text",lang:a,closedCaption:!!h,baseURL:d,representations:[{id:C++,mimeType:c,index:{indexType:"template",
duration:Number.MAX_VALUE,timescale:1,startNumber:0}}]}}))},[])}function d(a){Array.isArray(a)||(a=[a]);return a.map(function(a){var b=a.mimeType;a=a.url;return{id:C++,type:"image",baseURL:a,representations:[{id:C++,mimeType:b,index:{indexType:"template",duration:Number.MAX_VALUE,timescale:1,startNumber:0}}]}})}function b(a,c){for(var d in a)if(c.hasOwnProperty(d)){var f=a[d],m=c[d];"string"==typeof f||"number"==typeof f||"object"==("undefined"===typeof f?"undefined":z(f))&&f instanceof Date?a[d]=
m:Array.isArray(f)?(f.length=0,Array.prototype.push.apply(f,m)):a[d]=b(f,m)}return a}function m(){for(var a={},b=arguments.length,c=Array(b),d=0;d<b;d++)c[d]=arguments[d];for(b=c.length-1;0<=b;b--){var d=c[b],f;for(f in d)if(!a.hasOwnProperty(f)){var h=d[f];h&&"object"===("undefined"===typeof h?"undefined":z(h))?h instanceof Date?a[f]=new Date(h.getTime()):Array.isArray(h)?a[f]=h.slice(0):a[f]=m(h):a[f]=h}}return a}function n(a,c){var d=a.adaptations,f=c.adaptations,m=function(a){var c=f[a];d[a].forEach(function(a,
d){a.representations.forEach(function(a,f){b(a.index,c[d].representations[f].index)})})},h;for(h in d)m(h);return a}function p(a){var b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:1;a.isLive&&(a.presentationLiveGap+=b)}function r(a){return a.mimeType+';codecs="'+a.codecs+'"'}function q(a){a=a.adaptations;if(!a)return[];var b=[],c;for(c in a){var d=a[c];b.push({type:c,adaptations:d,codec:r(d[0].representations[0])})}return b}function x(a,b){var c=a.adaptations;return(c=c&&c[b])?c:[]}function t(b){return x(b,
"audio").map(function(b){return{language:a.i(A.c)(b.lang),audioDescription:b.audioDescription,id:b.id}})}function w(b){return x(b,"text").map(function(b){return{language:a.i(A.c)(b.lang),closedCaption:b.closedCaption,id:b.id}})}a.d(g,"d",function(){return k});a.d(g,"e",function(){return n});a.d(g,"f",function(){return p});a.d(g,"g",function(){return q});a.d(g,"c",function(){return x});a.d(g,"b",function(){return w});a.d(g,"a",function(){return t});var v=a(3),y=a(34),u=a(9),B=a(4),A=a(20),z="function"===
typeof Symbol&&"symbol"===typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&"function"===typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a},G="audioSamplingRate codecs codingDependency frameRate height index maxPlayoutRate maximumSAPPeriod mimeType profiles segmentProfiles width".split(" "),C=0,H=["audio","video","text","image"],D=15},function(e,g,a){var l=a(19),k=a(24),h=function(a,c){for(var d=a.timeline,b=0,f=d.length;b<f;){var h=b+f>>>1;d[h].ts<
c?b=h+1:f=h}return 0<b?b-1:b};g.a={getSegments:function(f,c,d,b){b=a.i(k.b)(c,d,b);d=b.up;b=b.to;var m=c.timeline,e=c.timescale,g=[],r=m.length;c=h(c,d)-1;var q=m.length&&m[0].d||0;a:for(;!(++c>=r);){var x=m[c],t=x.d,w=x.ts,v=x.range,q=Math.max(q,t);if(0>t){w+q<b&&g.push(new l.a({id:""+f+"_"+w,time:w,init:!1,range:v,duration:void 0,indexRange:null,timescale:e}));break}var y=m[c+1],u=x.r||0;0>u&&(u=Math.ceil(((y?y.t:Infinity)-x.ts)/x.d)-1);x=u;y=d-w;y=0<y?Math.floor(y/t):0;for(;(u=w+y*t)<b;)if(y++<=
x)g.push(new l.a({id:""+f+"_"+u,time:u,init:!1,range:v,duration:t,indexRange:null,timescale:e}));else continue a;break}return g},shouldRefresh:function(f,c,d,b){f=f.timeline;f=f[f.length-1];if(!f)return!0;0>f.d&&(f={ts:f.ts,d:0,r:f.r});return!(b<=a.i(k.a)(f))},getEndTime:function(a){return this.getLiveEdge(a)},getBeginningTime:function(a){return a.timeline[0].ts},getLiveEdge:function(f){var c=f.timeline[f.timeline.length-1];return a.i(k.a)(c)/f.timescale},checkDiscontinuity:function(f,c){var d=f.timeline;
if(0>=c)return-1;var b=h(c);if(0>b||b>=d.length-1)return-1;var m=d[b];if(-1===m.d)return-1;var e=m.ts,m=a.i(k.a)(m),d=d[b+1],b=f.timescale||1;return m!==d.ts&&c>=e&&c<=m&&m-c<b?d.ts:-1}}},function(e,g,a){function l(){this.__listeners={}}var k=a(1);l.prototype.addEventListener=function(h,f){a.i(k.a)("function"==typeof f,"eventemitter: second argument should be a function");this.__listeners[h]||(this.__listeners[h]=[]);this.__listeners[h].push(f)};l.prototype.removeEventListener=function(a,f){if(0===
arguments.length)this.__listeners={};else if(this.__listeners.hasOwnProperty(a))if(1===arguments.length)delete this.__listeners[a];else{var c=this.__listeners[a],d=c.indexOf(f);~d&&c.splice(d,1);c.length||delete this.__listeners[a]}};l.prototype.trigger=function(a,f){this.__listeners.hasOwnProperty(a)&&this.__listeners[a].slice().forEach(function(a){try{a(f)}catch(d){console.error(d,d.stack)}})};l.prototype.on=l.prototype.addEventListener;l.prototype.off=l.prototype.removeEventListener;g.a=l},function(e,
g,a){var l=0;g.a=function(){var a=0;l<Number.MAX_VALUE&&(a=l+1);l=a;return""+a}},function(e,g,a){function l(a,b){var c=0;return function(){c&&clearTimeout(c);c=setTimeout(a,b)}}function k(d,b){var m=b.retryDelay,h=b.totalRetry,k=b.shouldRetry,e=b.resetDelay,g=b.errorSelector,x=b.onRetry,t=0,w=void 0;0<e&&(w=l(function(){return t=0},e));return d["catch"](function(b,d){if(k&&!k(b)||t++>=h){if(g)throw g(b,t);throw b;}x&&x(b,t);var e=a.i(f.a)(m,t);return c(e).mergeMap(function(){w&&w();return d})})}function h(d,
b){var m=b.retryDelay,h=b.totalRetry,k=b.shouldRetry,e=b.resetDelay,g=b.errorSelector,x=b.onRetry,t=0,w=void 0;0<e&&(w=l(function(){return t=0},e));return function y(){for(var b=arguments.length,e=Array(b),n=0;n<b;n++)e[n]=arguments[n];return d.apply(void 0,e)["catch"](function(b){if(k&&!k(b)||t++>=h){if(g)throw g(b,t);throw b;}x&&x(b,t);b=a.i(f.a)(m,t);return c(b).mergeMap(function(){w&&w();return y.apply(void 0,e)})})}}a.d(g,"a",function(){return k});a.d(g,"b",function(){return h});var f=a(128);
e=a(56);a.n(e);var c=e.TimerObservable.create},function(e,g,a){function l(){for(var a=arguments.length,d=Array(a),b=0;b<a;b++)d[b]=arguments[b];a=d.length;if(0===a)return"";for(var b="",m=0;m<a;m++){var k=d[m];"string"===typeof k&&""!==k&&(h.test(k)?b=k:("/"===k[0]&&(k=k.substr(1)),"/"===b[b.length-1]&&(b=b.substr(0,b.length-1)),b=b+"/"+k))}a=b;if(f.test(a)){d=[];a=a.split("/");b=0;for(m=a.length;b<m;b++)".."==a[b]?d.pop():"."!=a[b]&&d.push(a[b]);d=d.join("/")}else d=a;return d}function k(a){var c=
a.lastIndexOf("/");return 0<=c?a.substring(0,c+1):a}a.d(g,"b",function(){return l});a.d(g,"a",function(){return k});var h=/^(?:[a-z]+:)?\/\//i,f=/\/\.{1,2}\//},function(e,g,a){var l=this&&this.__extends||function(a,f){function c(){this.constructor=a}for(var d in f)f.hasOwnProperty(d)&&(a[d]=f[d]);a.prototype=null===f?Object.create(f):(c.prototype=f.prototype,new c)};e=a(8);var k=a(61);a=function(a){function f(c){a.call(this);this._value=c}l(f,a);Object.defineProperty(f.prototype,"value",{get:function(){return this.getValue()},
enumerable:!0,configurable:!0});f.prototype._subscribe=function(c){var d=a.prototype._subscribe.call(this,c);d&&!d.closed&&c.next(this._value);return d};f.prototype.getValue=function(){if(this.hasError)throw this.thrownError;if(this.closed)throw new k.ObjectUnsubscribedError;return this._value};f.prototype.next=function(c){a.prototype.next.call(this,this._value=c)};return f}(e.Subject);g.BehaviorSubject=a},function(e,g,a){var l=this&&this.__extends||function(a,h){function f(){this.constructor=a}for(var c in h)h.hasOwnProperty(c)&&
(a[c]=h[c]);a.prototype=null===h?Object.create(h):(f.prototype=h.prototype,new f)};e=function(a){function h(f,c){a.call(this);this.value=f;this.scheduler=c;this._isScalar=!0;c&&(this._isScalar=!1)}l(h,a);h.create=function(a,c){return new h(a,c)};h.dispatch=function(a){var c=a.value,d=a.subscriber;a.done?d.complete():(d.next(c),d.closed||(a.done=!0,this.schedule(a)))};h.prototype._subscribe=function(a){var c=this.value,d=this.scheduler;if(d)return d.schedule(h.dispatch,0,{done:!1,value:c,subscriber:a});
a.next(c);a.closed||a.complete()};return h}(a(0).Observable);g.ScalarObservable=e},function(e,g,a){var l=this&&this.__extends||function(a,d){function b(){this.constructor=a}for(var c in d)d.hasOwnProperty(c)&&(a[c]=d[c]);a.prototype=null===d?Object.create(d):(b.prototype=d.prototype,new b)};e=a(12);var k=a(15);g.mergeAll=function(a){void 0===a&&(a=Number.POSITIVE_INFINITY);return this.lift(new h(a))};var h=function(){function a(a){this.concurrent=a}a.prototype.call=function(a,b){return b._subscribe(new f(a,
...
a.prototype.call=function(a,c){var d=this.selector,b=new l.ConnectableObservable(c.source,this.subjectFactory),d=d(b).subscribe(a);d.add(b.connect());return d};return a}();g.MulticastOperator=k},function(e,g,a){e=a(7);a=e.root.Symbol;if("function"===typeof a)a.iterator?g.$$iterator=a.iterator:"function"===typeof a["for"]&&(g.$$iterator=a["for"]("iterator"));else if(e.root.Set&&"function"===typeof(new e.root.Set)["@@iterator"])g.$$iterator="@@iterator";else if(e.root.Map){a=Object.getOwnPropertyNames(e.root.Map.prototype);
for(var l=0;l<a.length;++l){var k=a[l];if("entries"!==k&&"size"!==k&&e.root.Map.prototype[k]===e.root.Map.prototype.entries){g.$$iterator=k;break}}}else g.$$iterator="@@iterator"},function(e,g,a){function l(a){var h=a.Symbol;"function"===typeof h?h.observable?a=h.observable:(a=h("observable"),h.observable=a):a="@@observable";return a}e=a(7);g.getSymbolObservable=l;g.$$observable=l(e.root)},function(e,g,a){e=a(7).root.Symbol;g.$$rxSubscriber="function"===typeof e&&"function"===typeof e["for"]?e["for"]("rxSubscriber"):
"@@rxSubscriber"},function(e,g,a){g.isFunction=function(a){return"function"===typeof a}},function(e,g,a){function l(){try{return h.apply(this,arguments)}catch(f){return k.errorObject.e=f,k.errorObject}}var k=a(27),h;g.tryCatch=function(a){h=a;return l}},function(e,g,a){function l(a,b){if(!a)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!b||"object"!==typeof b&&"function"!==typeof b?a:b}function k(a,b){if("function"!==typeof b&&null!==b)throw new TypeError("Super expression must either be null or a function, not "+
typeof b);a.prototype=Object.create(b&&b.prototype,{constructor:{value:a,enumerable:!1,writable:!0,configurable:!0}});b&&(Object.setPrototypeOf?Object.setPrototypeOf(a,b):a.__proto__=b)}function h(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function");}function f(a){if("number"==typeof a)return a;for(var b=0,c,d=0;d<a.length;d++)c=a[d],b=(b<<5)-b+c,b&=b;return b}function c(a,b,c){return{type:"eme",value:Object.assign({name:a,session:b},c)}}function d(b){if(!X||!J||a.i(D.g)())return null;
var c=O;return(b=b.filter(function(a){return a.type!==X.type||a.persistentLicense&&"required"!=c.persistentState||a.distinctiveIdentifierRequired&&"required"!=c.distinctiveIdentifier?!1:!0})[0])?{keySystem:b,keySystemAccess:new D.h(X,J,O)}:null}function b(a){var b=["temporary"],c="optional",d="optional";a.persistentLicense&&(c="required",b.push("persistent-license"));a.persistentStateRequired&&(c="required");a.distinctiveIdentifierRequired&&(d="required");var f=[],m=[];R.forEach(function(a){f.push({contentType:'video/mp4;codecs="avc1.4d401e"',
robustness:a});m.push({contentType:'audio/mp4;codecs="mp4a.40.2"',robustness:a})});return{initDataTypes:["cenc"],videoCapabilities:f,audioCapabilities:m,distinctiveIdentifier:d,persistentState:c,sessionTypes:b}}function m(c){var f=d(c);if(f)return u.a.debug("eme: found compatible keySystem quickly",f),G.Observable.of(f);var m=c.reduce(function(a,b){return a.concat((I[b.type]||[]).map(function(a){return{keyType:a,keySystem:b}}))},[]);return G.Observable.create(function(c){function d(e){if(!f)if(e>=
m.length)c.error(new E.c("INCOMPATIBLE_KEYSYSTEMS",null,!0));else{var k=m[e],n=k.keyType,g=k.keySystem,p=[b(g)];u.a.debug("eme: request keysystem access "+n+","+(e+1+" of "+m.length),p);h=a.i(D.i)(n,p).subscribe(function(a){u.a.info("eme: found compatible keysystem",n,p);c.next({keySystem:g,keySystemAccess:a});c.complete()},function(){u.a.debug("eme: rejected access to keysystem",n,p);h=null;d(e+1)})}}var f=!1,h=null;d(0);return function(){f=!0;h&&h.unsubscribe()}})}function n(b,c,d){var f=U,m=J;
return a.i(A.b)(d.createMediaKeys()).mergeMap(function(h){J=h;O=d.getConfiguration();X=c;U=b;if(b.mediaKeys===h)return G.Observable.of(h);m&&m!==J&&M.dispose();var e;f&&f!==U?(u.a.debug("eme: unlink old video element and set mediakeys"),e=a.i(D.j)(f,null).concat(a.i(D.j)(U,h))):(u.a.debug("eme: set mediakeys"),e=a.i(D.j)(U,h));return e.mapTo(h)})}function p(a,b,c,d,f){u.a.debug("eme: create a new "+b+" session");var m=a.createSession(b);a=t(m,c,f)["finally"](function(){M.deleteAndClose(m);K["delete"](d)}).publish();
return{session:m,sessionEvents:a}}function r(b,d,f,m,h,e){b=p(b,f,d,h,e);var k=b.session;b=b.sessionEvents;M.add(h,k,b);u.a.debug("eme: generate request",m,h);m=a.i(A.b)(k.generateRequest(m,h))["catch"](function(a){throw new E.c("KEY_GENERATE_REQUEST_ERROR",a,!1);})["do"](function(){"persistent-license"==f&&K.add(h,k)}).mapTo(c("generated-request",k,{initData:h,initDataType:m}));return a.i(H.merge)(b,m)}function q(a,b,c,d,f,m){return r(a,b,c,d,f,m)["catch"](function(h){if(h.code!==E.b.KEY_GENERATE_REQUEST_ERROR)throw h;
var e=M.getFirst();if(!e)throw h;u.a.warn("eme: could not create a new session, retry after closing a currently loaded session",h);return M.deleteAndClose(e).mergeMap(function(){return r(a,b,c,d,f,m)})})}function x(b,d,f,m,h,e){u.a.debug("eme: load persisted session",f);var k=p(b,"persistent-license",d,h,e),n=k.session,g=k.sessionEvents;return a.i(A.b)(n.load(f))["catch"](function(){return G.Observable.of(!1)}).mergeMap(function(a){if(a)return M.add(h,n,g),K.add(h,n),g.startWith(c("loaded-session",
n,{storedSessionId:f}));u.a.warn("eme: no data stored for the loaded session, do fallback",f);M.deleteById(f);K["delete"](h);n.sessionId&&n.remove();return q(b,d,"persistent-license",m,h,e).startWith(c("loaded-session-failed",n,{storedSessionId:f}))})}function t(b,d,f){function m(a,b){return a.type===E.a.ENCRYPTED_MEDIA_ERROR?(a.fatal=b,a):new E.c("KEY_LOAD_ERROR",a,b)}u.a.debug("eme: handle message events",b);var h=void 0,e={totalRetry:2,retryDelay:200,errorSelector:function(a){return m(a,!0)},onRetry:function(a){return f.next(m(a,
!1))}},k=S(b).map(function(a){throw new E.c("KEY_ERROR",a,!0);}),n=V(b).mergeMap(function(c){h=c.sessionId;u.a.debug("eme: keystatuseschange event",h,b,c);b.keyStatuses.forEach(function(a,b){if(N[b]||N[a])throw new E.c("KEY_STATUS_CHANGE_ERROR",b,!0);});return d.onKeyStatusesChange?a.i(A.c)(function(){return a.i(A.b)(d.onKeyStatusesChange(c,b))})["catch"](function(a){throw new E.c("KEY_STATUS_CHANGE_ERROR",a,!0);}):(u.a.info("eme: keystatuseschange event not handled"),Y())}),g=T(b).mergeMap(function(c){h=
c.sessionId;var f=new Uint8Array(c.message),m=c.messageType||"license-request";u.a.debug("eme: event message type "+m,b,c);c=F(function(){return a.i(A.b)(d.getLicense(f,m)).timeout(1E4,new E.c("KEY_LOAD_TIMEOUT",null,!1))});return a.i(z.a)(c,e)}),n=a.i(H.merge)(g,n).concatMap(function(d){u.a.debug("eme: update session",h,d);return a.i(A.b)(b.update(d,h))["catch"](function(a){throw new E.c("KEY_UPDATE_ERROR",a,!0);}).mapTo(c("session-update",b,{updatedWith:d}))}),k=a.i(H.merge)(n,k);return b.closed?
k.takeUntil(a.i(A.b)(b.closed)):k}function w(b,d,f){function h(a,d){var m=d.keySystem,h=d.keySystemAccess;m.persistentLicense&&K.setStorage(m.licenseStorage);u.a.info("eme: encrypted event",a);return n(b,m,h).mergeMap(function(b){a:{var d=h.getConfiguration(),e=a.initDataType,k=new Uint8Array(a.initData),n=M.get(k);if(n&&n.sessionId)u.a.debug("eme: reuse loaded session",n.sessionId),b=G.Observable.of(c("reuse-session",n));else{d=(n=(d=d.sessionTypes)&&0<=d.indexOf("persistent-license"))&&m.persistentLicense?
"persistent-license":"temporary";if(n&&m.persistentLicense&&(n=K.get(k))){b=x(b,m,n.sessionId,e,k,f);break a}b=q(b,m,d,e,k,f)}}return b})}return a.i(C.combineLatest)(L(b),m(d)).take(1).mergeMap(function(a){return h(a[0],a[1])})}function v(){return X&&X.type}function y(){U&&a.i(D.j)(U,null).subscribe(function(){});U=X=J=null;M.dispose()}a.d(g,"c",function(){return w});a.d(g,"b",function(){return v});a.d(g,"d",function(){return L});a.d(g,"a",function(){return y});var u=a(3),B=a(1),A=a(11),z=a(33),G=
a(0);a.n(G);e=a(6);a.n(e);g=a(53);a.n(g);var C=a(21);a.n(C);var H=a(14);a.n(H);var D=a(9),E=a(4),L=D.f.onEncrypted,T=D.f.onKeyMessage,S=D.f.onKeyError,V=D.f.onKeyStatusesChange,Y=e.EmptyObservable.create,F=g.DeferObservable.create,I={clearkey:["webkit-org.w3.clearkey","org.w3.clearkey"],widevine:["com.widevine.alpha"],playready:["com.microsoft.playready","com.chromecast.playready","com.youtube.playready"]},R=["HW_SECURE_ALL","HW_SECURE_DECODE","HW_SECURE_CRYPTO","SW_SECURE_DECODE","SW_SECURE_CRYPTO"],
N={expired:!0,"internal-error":!0};e=function(){function a(){h(this,a);this._entries=[]}a.prototype.find=function(a){for(var b=0;b<this._entries.length;b++)if(!0===a(this._entries[b]))return this._entries[b];return null};return a}();g=function(b){function c(){h(this,c);return l(this,b.apply(this,arguments))}k(c,b);c.prototype.getFirst=function(){if(0<this._entries.length)return this._entries[0].session};c.prototype.find=function(a){for(var b=0;b<this._entries.length;b++)if(!0===a(this._entries[b]))return this._entries[b];
...
var m=d.name,h=d.ts,e=d.gap,n=d.paused,g=d.readyState,p=d.playback,l=f.stalled,t=f.name,r=f.ts,q;q=(q=d.range)?d.duration-(e+q.end)<=y:!1;var A=1<=g&&"loadedmetadata"!=m&&!l&&!q;c?(n=A&&(e<=y||Infinity===e||1===g),h=l&&1<g&&Infinity>e&&(e>("seeking"==l.name?y:u)||q)):(n=A&&(!n&&"timeupdate"==m&&"timeupdate"==t&&h===r||"seeking"==m&&Infinity===e),h=l&&("seeking"!=m&&h!==r||"canplay"==m||Infinity>e&&(e>("seeking"==l.name?y:u)||q)));d.stalled=n?{name:m,playback:p}:h?null:l;f=d;b.next(f)}var f=k(a,"init"),
m=setInterval(d,c?t:w);A.forEach(function(b){return a.addEventListener(b,d)});b.next(f);return function(){clearInterval(m);A.forEach(function(b){return a.removeEventListener(b,d)})}}).multicast(function(){return new q.BehaviorSubject({name:"init",stalled:null})}).refCount()}function f(a){return a.filter(function(a){return"seeking"==a.name&&(Infinity===a.gap||a.gap<-B)}).skip(1).startWith(!0)}function c(a,b){return new Date(1E3*(a+b.availabilityStartTime))}function d(a,b){var c=a,d=b.suggestedPresentationDelay,
f=b.presentationLiveGap,m=b.timeShiftBufferDepth;"number"!=typeof c&&(c=c.getTime());var h=Date.now();return Math.max(Math.min(c,h-1E3*(f+d)),h-1E3*m)/1E3-b.availabilityStartTime}function b(a){return n(a)[0]}function m(a){if(!a.isLive)return a.duration;a=a.presentationLiveGap;return Date.now()/1E3-a}function n(a){if(!a.isLive)return[0,a.duration];var b=a.presentationLiveGap;a=a.timeShiftBufferDepth;b=Date.now()/1E3-b;return[Math.min(b,b-a+5),b]}function p(a,b){if(!b.isLive)return Infinity;var c=b.availabilityStartTime,
d=b.presentationLiveGap;return Date.now()/1E3-a-(c+d+v)}a.d(g,"b",function(){return l});a.d(g,"a",function(){return h});a.d(g,"h",function(){return f});a.d(g,"d",function(){return p});a.d(g,"c",function(){return c});a.d(g,"e",function(){return d});a.d(g,"f",function(){return b});a.d(g,"g",function(){return m});a.d(g,"i",function(){return n});var r=a(0);a.n(r);var q=a(35);a.n(q);var x=a(18),t=1E3,w=500,v=10,y=.5,u=5,B=2,A="canplay play progress seeking seeked loadedmetadata".split(" "),z=function(){function a(b,
c,d,f,m,h,e,k,n,g){if(!(this instanceof a))throw new TypeError("Cannot call a class as a function");this.ts=b;this.buffered=c;this.duration=d;this.gap=f;this.name=m;this.playback=h;this.range=e;this.readyState=k;this.stalled=n;this.paused=g}a.prototype.clone=function(){return new a(this.ts,this.buffered,this.duration,this.gap,this.name,this.playback,this.range,this.readyState,this.stalled,this.paused)};return a}()},function(e,g,a){function l(a){if("timeline"===a.indexType){var b=a.timeline[a.timeline.length-
1];return(b.ts+(b.r+1)*b.d)/a.timescale}return Date.now()/1E3}function k(a){return a}function h(a){return"true"==a}function f(a){return"true"==a?!0:"false"==a?!1:parseInt(a)}function c(a){return new Date(Date.parse(a))}function d(b){if(!b)return 0;var c=w.exec(b);a.i(t.a)(c,b+" is not a valid ISO8601 duration");return 31536E3*parseFloat(c[2]||0)+2592E3*parseFloat(c[4]||0)+86400*parseFloat(c[6]||0)+3600*parseFloat(c[8]||0)+60*parseFloat(c[10]||0)+parseFloat(c[12]||0)}function b(a){var b=y.exec(a);
if(!b)return-1;a=parseInt(b[1])||0;b=parseInt(b[2])||0;return 0<b?a/b:a}function m(a){return a}function n(a){return(a=v.exec(a))?[+a[1],+a[2]]:null}function p(a,b,c){for(a=a.firstElementChild;a;)c=b(c,a.nodeName,a),a=a.nextElementSibling;return c}function r(a){return a?"urn:tva:metadata:cs:AudioPurposeCS:2007"===a.schemeIdUri&&1===a.value:!1}function q(a){var b=a.mimeType,b=void 0===b?"":b,c=b.split("/")[0];if(u.includes(c))return c;if("application/bif"===b)return"image";if("application/ttml+xml"===
b)return"text";if("application/mp4"===b)return(a=a.role)&&"urn:mpeg:dash:role:2011"===a.schemeIdUri&&"subtitle"===a.value?"text":"metadata";a=a.representations;a=void 0===a?[]:a;return a.length&&(a=a[0].mimeType.split("/")[0],u.includes(a))?a:"unknown"}function x(a){return a?"urn:tva:metadata:cs:AudioPurposeCS:2007"===a.schemeIdUri&&2===a.value:!1}a.d(g,"g",function(){return k});a.d(g,"h",function(){return b});a.d(g,"f",function(){return n});a.d(g,"i",function(){return h});a.d(g,"m",function(){return c});
a.d(g,"j",function(){return d});a.d(g,"l",function(){return f});a.d(g,"k",function(){return m});a.d(g,"a",function(){return p});a.d(g,"b",function(){return B});a.d(g,"d",function(){return x});a.d(g,"e",function(){return r});a.d(g,"c",function(){return q});var t=a(1),w=/^P(([\d.]*)Y)?(([\d.]*)M)?(([\d.]*)D)?T?(([\d.]*)H)?(([\d.]*)M)?(([\d.]*)S)?/,v=/([0-9]+)-([0-9]+)/,y=/([0-9]+)(\/([0-9]+))?/,u=["audio","video","text","image"],B=function(a){if(a){var b=a.representations||[],c=b.filter(function(a){return a&&
a.index});if(!b.length)return l(a.index);var d=Math.min.apply(Math,c.map(function(a){return l(a.index)}));if(!isNaN(d)){if(b.length===c.length)return d;if(a.index)return a=l(a.index),Math.min(d,a)}}}},function(e,g,a){function l(h){var f=0,c=h.length,d=a.i(k.a)(h.subarray(f,f+8)),f=f+8,b=h[f],f=f+1,m=h[f],f=f+1,e=h[f],f=f+1,g=h[f],f=f+1,b=[b,m,e,g].join("."),m=h[f]+a.i(k.c)(h,f+1),f=f+4,e=a.i(k.c)(h,f),f=f+4,g=a.i(k.a)(h.subarray(f,f+4)),f=f+4,l=a.i(k.d)(h,f),f=f+2,q=a.i(k.d)(h,f),f=f+2,x=[h[f],h[f+
1]].join(":"),t=1===h[f+2],f=64,w=[],v=void 0,y=0;if(!m)throw Error("bif: no images to parse");for(;f<c;){var u=a.i(k.c)(h,f),f=f+4,B=a.i(k.c)(h,f),f=f+4;if(v){var A=v.index,z=e,G=y,v=h.subarray(v.offset,B);w.push({index:A,duration:z,ts:G,data:v});y+=e}if(4294967295===u)break;v={index:u,offset:B}}return{fileFormat:d,version:b,imageCount:m,timescale:e,format:g,width:l,height:q,aspectRatio:x,isVod:t,thumbs:w}}a.d(g,"a",function(){return l});var k=a(10)},function(e,g,a){function l(a,b,c){a="string"==
typeof a?(new DOMParser).parseFromString(a,"text/xml"):a;if(!(a instanceof window.Document||a instanceof window.HTMLElement))throw Error("ttml needs a Document to parse");a=a.querySelector("tt");if(!a)throw Error("ttml could not find <tt> tag");a=k(a.querySelector("body"),0);for(b=0;b<a.length;b++){var d=a[b];d.start+=c;d.end+=c}return a}function k(a,b){var d=0;a=a.firstChild;for(var m=[],e;a;){if(1===a.nodeType)switch(a.tagName.toUpperCase()){case "P":e=a;var n=b,g=d,d=h(e.getAttribute("begin"),
n),p=h(e.getAttribute("end"),n),l=h(e.getAttribute("dur"),0);if("number"==!("undefined"===typeof d||f(d))&&"number"==!("undefined"===typeof p||f(p))&&"number"==!("undefined"===typeof l||f(l)))throw Error("ttml unsupported timestamp format");0<l?(null==d&&(d=g||n),null==p&&(p=d+l)):null==p&&(p=h(e.getAttribute("duration"),0),p=0<=p?p+d:Number.MAX_VALUE);n=e.innerHTML;null==n&&(n=(new XMLSerializer).serializeToString(e),n=(new DOMParser).parseFromString(n,"text/html").body.firstChild.innerHTML);n=window.escape(n.replace(c,
"\r\n"));n=n.replace(/%C3%26nbsp%3B/gm,"%C3%A0");e={id:e.getAttribute("xml:id")||e.getAttribute("id"),text:decodeURIComponent(n),start:d,end:p};d=e.end;m.push(e);break;case "DIV":e=h(a.getAttribute("begin"),0),null==e&&(e=b),m.push.apply(m,k(a,e))}a=a.nextSibling}return m}function h(a,c){if(!a)return null;var f;if(f=a.match(d)){var h=f[3],e=f[4],k=f[6];return 3600*parseInt(f[2]||0,10)+60*parseInt(h,10)+parseInt(e,10)+parseFloat("0."+k)}return(f=a.match(b))?(h=f[4],parseFloat(f[1])*m[h]+c):null}a.d(g,
"a",function(){return l});var f="function"===typeof Symbol&&"symbol"===typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&"function"===typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a},c=/<br.*?>/gm,d=/^(([0-9]+):)?([0-9]+):([0-9]+)(\.([0-9]+))?$/,b=/(([0-9]+)(\.[0-9]+)?)(ms|h|m|s)/,m={h:3600,m:60,s:1,ms:.001}},function(e,g,a){function l(a,b){if(!a)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!b||"object"!==
typeof b&&"function"!==typeof b?a:b}function k(a,b){if("function"!==typeof b&&null!==b)throw new TypeError("Super expression must either be null or a function, not "+typeof b);a.prototype=Object.create(b&&b.prototype,{constructor:{value:a,enumerable:!1,writable:!0,configurable:!0}});b&&(Object.setPrototypeOf?Object.setPrototypeOf(a,b):a.__proto__=b)}function h(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function");}function f(){return new XMLHttpRequest}function c(a){return new n(a)}
e=a(0);a.n(e);var d=a(2);a.n(d);var b=a(4),m=function q(a,b,c,d,f,m,e){h(this,q);this.status=a;this.url=b;this.responseType=c;this.sentTime=d;this.receivedTime=f;this.duration=this.receivedTime-this.sentTime;this.size=m;this.responseData=e},n=function(a){function b(c){h(this,b);var d=l(this,a.call(this)),m={url:"",createXHR:f,headers:null,method:"GET",responseType:"json",timeout:1E4,resultSelector:null,body:null},e;for(e in c)m[e]=c[e];d.request=m;return d}k(b,a);b.prototype._subscribe=function(a){return new p(a,
this.request)};return b}(e.Observable),p=function(a){function c(b,d){h(this,c);var f=l(this,a.call(this,b));f.request=d;f.sentTime=Date.now();f.receivedTime=0;f.xhr=null;f.done=!1;f.resultSelector=d.resultSelector;f.send();return f}k(c,a);c.prototype.next=function(){this.done=!0;var a=this.resultSelector,c=this.xhr,d=this.request,f=this.destination,h=c.status,e=this.responseType,k=this.totalSize,n=this.sentTime,g=this.receivedTime,p=c.responseURL||d.url,l=void 0;if("json"==d.responseType)if("string"!=
typeof c.response)l=c.response;else try{l=JSON.parse(c.responseText)}catch(D){l=null}else l=c.response;null==l?f.error(new b.h(this,d,b.i.PARSE_ERROR)):(c=new m(h,p,e,n,g,k,l),a?f.next(a(c)):f.next(c))};c.prototype.setHeaders=function(a,b){for(var c in b)a.setRequestHeader(c,b[c])};c.prototype.setupEvents=function(a,c){a.ontimeout=function y(){y.subscriber.error(new b.h(this,y.request,b.i.TIMEOUT))};a.ontimeout.request=c;a.ontimeout.subscriber=this;a.onerror=function u(){u.subscriber.error(new b.h(this,
u.request,b.i.ERROR_EVENT))};a.onerror.request=c;a.onerror.subscriber=this;a.onload=function B(a){if(4===this.readyState){var c=B.subscriber,d=B.request;c.receivedTime=Date.now();c.totalSize=a.total;var f=this.status;200<=f&&300>f?(c.next(a),c.complete()):c.error(new b.h(this,d,b.i.ERROR_HTTP_CODE))}};a.onload.subscriber=this;a.onload.request=c};c.prototype.send=function(){var a=this.request,b=this.request,c=b.method,d=b.url,m=b.headers,h=b.body,e=b.responseType,b=b.timeout,k=(a.createXHR||f)(a);
this.xhr=k;k.open(c,d,!0);k.timeout=b;k.responseType=e;"document"==e&&k.overrideMimeType("text/xml");m&&this.setHeaders(k,m);this.setupEvents(k,a);h?k.send(h):k.send()};c.prototype.unsubscribe=function(){var b=this.xhr;!this.done&&b&&4!==b.readyState&&b.abort();b.ontimeout=null;b.onerror=null;b.onload=null;a.prototype.unsubscribe.call(this)};return c}(d.Subscriber);c.RequestObservable=n;c.RequestError=b.h;c.RequestResponse=m;c.RequestErrorTypes=b.i;g.a=c},function(e,g,a){g.empty={closed:!0,next:function(a){},
...
var k=a(17),h=a(13),f=a(37);g.concat=function(){for(var a=[],d=0;d<arguments.length;d++)a[d-0]=arguments[d];return this.lift.call(l.apply(void 0,[this].concat(a)))};g.concatStatic=l},function(e,g,a){var l=this&&this.__extends||function(a,d){function b(){this.constructor=a}for(var c in d)d.hasOwnProperty(c)&&(a[c]=d[c]);a.prototype=null===d?Object.create(d):(b.prototype=d.prototype,new b)},k=a(15);e=a(12);g.mergeMap=function(a,d,b){void 0===b&&(b=Number.POSITIVE_INFINITY);"number"===typeof d&&(b=d,
...
g,a){var l=a(16);g.isNumeric=function(a){return!l.isArray(a)&&0<=a-parseFloat(a)+1}},function(e,g,a){g.isPromise=function(a){return a&&"function"!==typeof a.subscribe&&"function"===typeof a.then}},function(e,g,a){g.noop=function(){}},function(e,g,a){function l(a,b){if(!a)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!b||"object"!==typeof b&&"function"!==typeof b?a:b}function k(a,b){if("function"!==typeof b&&null!==b)throw new TypeError("Super expression must either be null or a function, not "+
...
autoPlay:!1,hideNativeSubtitle:!1,directFile:!1},b),d=c.transport,f=c.url,h=c.keySystems,e=c.timeFragment,m=c.supplementaryTextTracks,k=c.supplementaryImageTracks,g=b,n=g.subtitles,l=g.images,c=g.transportOptions,p=g.manifests,t=g.autoPlay,M=g.directFile,q=g.defaultLanguage,r=g.defaultAudioTrack,w=g.defaultSubtitle,u=g.defaultTextTrack,A=g.hideNativeSubtitle,g=g.startAt,y=r,B=u;null!=q&&null==r&&(console.warn("defaultLanguage is deprecated. Use defaultAudioTrack instead"),y=q);null!=w&&null==u&&(console.warn("defaultSubtitle is deprecated. Use defaultTextTrack instead"),
B=w);void 0!==n&&void 0===m&&(console.warn("the subtitles option is deprecated. Use supplementaryTextTracks instead"),m=n);void 0!==l&&void 0===k&&(console.warn("the images option is deprecated. Use supplementaryImageTracks instead"),k=l);e=a.i(D.a)(e);M&&(d="directfile");a.i(v.a)(!!p^!!f,"player: you have to pass either a url or a list of manifests");p&&(console.warn("the manifests options is deprecated, use url instead"),h=p[0],f=h.url,m=h.subtitles||[],k=h.images||[],h=p.map(function(a){return a.keySystem}).filter(Boolean));
"string"==typeof d&&(d=T.a[d]);"function"==typeof d&&(d=d(Object.assign({},this.defaultTransportOptions,c)));a.i(v.a)(d,"player: transport "+b.transport+" is not supported");return{url:f,keySystems:h,supplementaryTextTracks:m,hideNativeSubtitle:A,supplementaryImageTracks:k,timeFragment:e,autoPlay:t,defaultAudioTrack:y,defaultTextTrack:B,transport:d,startAt:g}};g.prototype.loadVideo=function(){var d=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{},d=this._parseOptions(d);m.a.info("loadvideo",
...
d});return c(f,b)}function b(a,b){var d=2<arguments.length&&void 0!==arguments[2]?arguments[2]:!1,f=a.filter(function(a){return a.closedCaption==d});return c(f,b)}function m(a,b){return a.filter(function(a){return a.type===b})}var n=a(5);a.n(n);var p=a(35);a.n(p);var r=a(21);a.n(r);var q=a(11),x=a(20),t=a(93),w={defaultAudioTrack:{language:"fra",audioDescription:!1},defaultTextTrack:null,defaultBufferSize:30,defaultBufferThreshold:.3,initialVideoBitrate:0,initialAudioBitrate:0,maxVideoBitrate:Infinity,
...
e=b.representations;b=void 0;if(1<e.length){b=M[c];var m=J[c],g=N[c].map(function(a,b){return h(d,a,0===b?0:H)}).distinctUntilChanged().debounceTime(2E3).startWith(h(d,N[c].getValue(),0));"video"==c&&(m=a.i(r.combineLatest)([m,Y,F]).map(function(a){var b=a[0],c=a[1];a=a[2];if(V&&a)return d[0];c=S?f(e,c):d[d.length-1];return Math.min(c,b)}));b=a.i(r.combineLatest)(b,m,g,function(a,b,c){var f=void 0,f=Infinity>a?a:Infinity>b?Math.min(b,c):c;return l(e,function(a){return a.bitrate===h(d,f)})}).distinctUntilChanged(function(a,
b){return a.id===b.id})}else b=a.i(q.e)(e[0]);return{representations:b,bufferSizes:O[c]||new p.BehaviorSubject(C)}},getAdaptationsChoice:function(b,c){return"audio"==b?g(c):"text"==b?v(c):a.i(q.e)(c[0])},unsubscribe:function(){K&&(K.unsubscribe(),K=null)}}}},function(e,g,a){function l(e){function g(a,b){for(var c=a.ts,d=a.buffered,f=d.getRange(c),d=d.getOuterRanges(c),e=[],m=0;m<d.length;m++){var g=d[m];c-b<g.end?e.push(g):c+b>g.start&&e.push(g)}f&&(h.a.debug("buffer: gc removing part of inner range",
e),c-b>f.start&&e.push({start:f.start,end:c-b}),c+b<f.end&&e.push({start:c+b,end:f.end}));return e}function k(){h.a.warn("buffer: running garbage collector");return S.take(1).mergeMap(function(a){var b=g(a,u);0===b.length&&(b=g(a,B));h.a.debug("buffer: gc cleaning",b);return w(b.map(function(a){return K.removeBuffer(a)})).concatAll()})}function l(b){function f(a){if(g.test(a.getId()))return!1;if(a.isInitSegment()||0>a.getTime())return!0;var b=e.scale(a.getTime()),c=e.scale(a.getDuration());return(b=
N.hasRange(b,c))?(a=a.getRepresentation().bitrate,b.bitrate*y<a):!0}h.a.info("bitrate",p,b.bitrate);var e=new q.b(E,b),g=new r.a,w=a.i(m.combineLatest)(S,R).mergeMap(function(a,d){var m=a[0],k=a[1],n=new c.a(A.buffered);if(m.stalled){var l=e.checkDiscontinuity(m.ts);l&&V.next({type:"index-discontinuity",value:l})}l=void 0;try{var q=e,r=null;0===d&&(h.a.debug("add init segment",p),r=q.getInitSegment());if(0===m.readyState)l=r?[r]:[];else{var w=m.ts,v=Math.max(0,Math.min(k,m.liveGap,(m.duration||Infinity)-
w)),m=void 0,u=n.getGap(w),m=u>Y&&Infinity>u?Math.min(u,F):0,y=N.getRange(w);if(y&&y.bitrate===b.bitrate){var B=Math.floor(y.end-w);B>m&&(m=B)}var C=q.getSegments(w,m,v);r&&C.unshift(r);l=C}l=l.filter(f)}catch(aa){if(aa.type===x.a.INDEX_ERROR&&aa.code===x.b.OUT_OF_INDEX_ERROR)return V.next({type:"out-of-index",value:aa}),t();throw aa;}for(n=0;n<l.length;n++)g.add(l[n].getId());return l}).concatMap(function(a){return L({segment:a})}).concatMap(function(a){var c=a.segment,d=a.parsed,f=d.segmentData,
h=d.nextSegments,m=d.currentSegment;(d=d.timescale)&&e.setTimescale(d);var n=h?e.insertNewSegments(h,m):[];g.remove(c.getId());m&&N.insert(b.bitrate,e.scale(m.ts),e.scale(m.ts+m.d));return K.appendBuffer(f)["catch"](function(a){if("QuotaExceededError"!=a.name)throw new x.d("BUFFER_APPEND_ERROR",a,!1);return k().mergeMap(function(){return K.appendBuffer(f)})["catch"](function(a){throw new x.d("BUFFER_FULL_ERROR",a,!0);})}).map(function(){return{type:"pipeline",value:Object.assign({bufferType:p,addedSegments:n},
...
return a.i(m.combineLatest)(I,e,function(a){return a}).switchMap(l)["finally"](function(){return K.dispose()})}function k(a){return d.Observable.of({type:"buffer",value:{bufferType:a,adaptation:null,representation:null}})}a.d(g,"b",function(){return l});a.d(g,"a",function(){return k});var h=a(3),f=a(96),c=a(18),d=a(0);a.n(d);var b=a(8);a.n(b);var m=a(21);a.n(m);var n=a(14);a.n(n);e=a(6);a.n(e);g=a(138);a.n(g);var p=a(56);a.n(p);var r=a(129),q=a(45),x=a(4),t=e.EmptyObservable.create,w=g.FromObservable.create,
...
inBackground:d}}},function(e,g,a){function l(a,e){if("function"!==typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);a.prototype=Object.create(e&&e.prototype,{constructor:{value:a,enumerable:!1,writable:!0,configurable:!0}});e&&(Object.setPrototypeOf?Object.setPrototypeOf(a,e):a.__proto__=e)}e=function(a){function e(){if(!(this instanceof e))throw new TypeError("Cannot call a class as a function");var f=a.apply(this,arguments);if(!this)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
return!f||"object"!==typeof f&&"function"!==typeof f?this:f}l(e,a);e.prototype._append=function(){this.buffered.insert(0,0,Infinity)};return e}(a(46).a);g.a=e},function(e,g,a){function l(a,e){if("function"!==typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);a.prototype=Object.create(e&&e.prototype,{constructor:{value:a,enumerable:!1,writable:!0,configurable:!0}});e&&(Object.setPrototypeOf?Object.setPrototypeOf(a,e):a.__proto__=e)}e=function(a){function e(){if(!(this instanceof
e))throw new TypeError("Cannot call a class as a function");var f=a.apply(this,arguments);if(!this)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!f||"object"!==typeof f&&"function"!==typeof f?this:f}l(e,a);e.getLiveEdge=function(){throw Error("not implemented");};e.prototype.addSegment=function(a){this.index.timeline.push(a);return!0};return e}(a(28).a);g.a=e},function(e,g,a){var l=a(22);e=function(){function a(e,f,c){if(!(this instanceof a))throw new TypeError("Cannot call a class as a function");
this.adaptation=e;this.representation=f;this.index=c}a.getLiveEdge=function(){throw Error("not implemented");};a.prototype.checkDiscontinuity=function(){return-1};a.prototype.checkRange=function(a,f,c){f=this.index;a=f.list;c=Math.floor(c/f.duration);return 0<=c&&c<a.length};a.prototype.createSegment=function(a,f){var c=this.index,d=c.list[a];return l.b.create(this.adaptation,this.representation,a,d.media,f,c.duration,0,d.range,null,!1)};a.prototype.getSegments=function(a,f){for(var c=this.index,
d=c.duration,c=Math.min(c.list.length-1,Math.floor(f/d)),b=[],e=Math.floor(a/d);e<=c;)b.push(this.createSegment(e,e*d)),e++;return b};a.prototype.addSegment=function(){return!1};return a}();g.a=e},function(e,g,a){function l(a,f){if("function"!==typeof f&&null!==f)throw new TypeError("Super expression must either be null or a function, not "+typeof f);a.prototype=Object.create(f&&f.prototype,{constructor:{value:a,enumerable:!1,writable:!0,configurable:!0}});f&&(Object.setPrototypeOf?Object.setPrototypeOf(a,
...
m.h?a.type===m.i.ERROR_HTTP_CODE?500<=a.status||404==a.status:a.type===m.i.TIMEOUT||a.type===m.i.ERROR_EVENT:!1}function h(f,e,h,m){function g(a){throw l("PIPELINE_RESOLVE_ERROR",f,a);}function p(a){throw l("PIPELINE_PARSING_ERROR",f,a);}function r(a){h.next(a)}function q(c){return a.i(d.a)(a.i(b.c)(C,c),T)}function u(c){var d=L?L.get(c):null;return null===d?q(c):a.i(b.b)(d)["catch"](function(){return q(c)})}function B(c){return a.i(b.c)(H,c)["catch"](p)}function A(a,b){var c=Object.assign({response:b},
a);L&&L.add(a,b);n.schedule(r,0,{type:f,value:c});return c}function x(a,b){return Object.assign({parsed:b},a)}var G=e.resolver,C=e.loader,H=e.parser,D=4<arguments.length&&void 0!==arguments[4]?arguments[4]:{};G||(G=c.Observable.of);C||(C=c.Observable.of);H||(H=c.Observable.of);var E=D.maxRetry,L=D.cache,D="number"===typeof E?E:4,T={retryDelay:200,errorSelector:function(a){throw l("PIPELINE_LOAD_ERROR",f,a);},totalRetry:D,shouldRetry:D&&k,onRetry:function(a){n.schedule(r,0,{type:f,value:a.xhr});m.next(l("PIPELINE_LOAD_ERROR",
...
typeof Object.assign&&(Object.assign=e.a);g["default"]=a.a},function(e,g,a){e=a(30);g.a=Object.assign({},e.a,{getLiveEdge:function(){throw Error("not implemented");},addSegment:function(a){console.log(a)}})},function(e,g,a){a.d(g,"a",function(){return d});var l=a(30),k=a(111),h=a(113),f=a(112),c=a(109),d=function(a){switch(a.indexType){case "timeline":return l.a;case "list":return k.a;case "template":return h.a;case "smooth":return f.a;case "base":return c.a;default:return l.a}}},function(e,g,a){var l=
a(19),k=a(24);g.a={getSegments:function(e,f,c,d){var b=a.i(k.b)(f,c,d);c=f.duration;d=f.list;f=f.timescale;for(var h=Math.min(d.length-1,Math.floor(b.to/c)),g=[],b=Math.floor(b.up/c);b<=h;)g.push(new l.a({id:""+e+"_"+b,time:b*c,init:!1,range:d[b].range,duration:c,indexRange:null,timescale:f})),b++;return g},shouldRefresh:function(a,f,c,d){f=a.list;a=Math.floor(d/a.duration);return!(0<=a&&a<f.length)},getLiveEdge:function(){throw Error("not implemented");},addSegment:function(){return!1},checkDiscontinuity:function(){return-1}}},
function(e,g,a){e=a(30);var l=a(24);g.a={getSegments:e.a.getSegments,shouldRefresh:function(e,h){var f=e.timeline,f=f[f.length-1];if(!f)return!1;0>f.d&&(f={ts:f.ts,d:0,r:f.r});return h>=a.i(l.a)(f)}}},function(e,g,a){var l=a(19),k=a(24);g.a={getSegments:function(e,f,c,d){var b=a.i(k.b)(f,c,d);c=b.to;d=f.duration;var h=f.startNumber;f=f.timescale;for(var g=[],b=b.up;b<=c;b+=d){var p=Math.floor(b/d)+(null==h?1:h),b=p*d;g.push(new l.a({id:""+e+"_"+p,number:p,time:b,init:!1,duration:d,range:null,indexRange:null,
timescale:f}))}return g},shouldRefresh:function(){return!1}}},function(e,g,a){a.d(g,"a",function(){return h});var l=a(23),k=a(32),h=function(){function f(){var c=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};if(!(this instanceof f))throw new TypeError("Cannot call a class as a function");var d=a.i(k.a)();this.id=null==c.id?d:""+c.id;this.transport=c.transportType||"";this.adaptations=c.adaptations?Object.keys(c.adaptations).reduce(function(a,d){a[d]=c.adaptations[d].map(function(a){return new l.a(a)});
return a},{}):[];this.periods=[{adaptations:this.adaptations}];this.isLive="dynamic"===c.type;this.uris=c.locations;this._duration=c.duration}f.prototype.getDuration=function(){return this._duration};return f}()},function(e,g,a){var l=a(110);e=function(){function e(h){if(!(this instanceof e))throw new TypeError("Cannot call a class as a function");this._index=h.index;this._rootId=h.rootId;this._indexHelpers=a.i(l.a)(this._index)}e.prototype.getLiveEdge=function(){return this._indexHelpers.getLiveEdge(this._index)};
e.prototype.getSegments=function(a,f){return this._indexHelpers.getSegments(this._rootId,this._index,a,f)};e.prototype.shouldRefresh=function(a,f,c){return this._indexHelpers.shouldRefresh(this._index,a,f,c)};e.prototype.getBeginningTime=function(){return this._indexHelpers.getBeginningTime(this._index)};e.prototype.getEndTime=function(){return this._indexHelpers.getEndTime(this._index)};e.prototype.addSegment=function(a){return this._indexHelpers.addSegment(a,this._index)};e.prototype.checkDiscontinuity=
function(){return this._indexHelpers.checkDiscontinuity(this._index)};return e}();g.a=e},function(e,g,a){function l(a){var b=a[0];return(a=a[1])&&Infinity!==a?"bytes="+ +b+"-"+ +a:"bytes="+ +b+"-"}function k(a){return function(b,c,d){b=d?parseInt(d,10):1;c=""+a;c=c.toString();b=c.length>=b?c:(Array(b+1).join("0")+c).slice(-b);return b}}function h(a,b){if(-1===a.indexOf("$"))return a;var c=b.getRepresentation();return a.replace(/\$\$/g,"$").replace(/\$RepresentationID\$/g,c.id).replace(/\$Bandwidth(|\%0(\d+)d)\$/g,
k(c.bitrate)).replace(/\$Number(|\%0(\d+)d)\$/g,k(b.getNumber())).replace(/\$Time(|\%0(\d+)d)\$/g,k(b.getTime()))}var f=a(0);a.n(f);e=a(6);a.n(e);var c=a(14);a.n(c);a(1);var d=a(34),b=a(121),m=a(10),n=a(23),p=a(25),r=a(19),q=a(51),x=a(119),t=a(50),w=a(49),v=e.EmptyObservable.create;g.a=function(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{},g=e.contentProtectionParser;g||(g=function(){});var k=e.createXHR,A=function(b){var d=b.url;b=b.segment;var f=b.range;b=b.indexRange;if(f&&
b&&f[1]===b[0]-1)return a.i(q.a)({url:d,responseType:"arraybuffer",headers:{Range:l([f[0],b[1]])},createXHR:k});f=f?{Range:l(f)}:null;f=a.i(q.a)({url:d,responseType:"arraybuffer",headers:f,createXHR:k});return b?(d=a.i(q.a)({url:d,responseType:"arraybuffer",headers:{Range:l(b)},createXHR:k}),a.i(c.merge)(f,d)):f},z=function(b){b=b.segment;var c=b.getMedia(),g=b.getRange(),k=b.getIndexRange();if(b.isInitSegment()&&!(c||g||k))return v();var m=e.segmentLoader,c=c?h(c,b):"",c=a.i(d.b)(b.getResolvedURL(),
c),l={adaptation:new n.a(b.getAdaptation()),representation:new p.a(b.getRepresentation()),segment:new r.a(b),transport:"smooth",url:c};return m?f.Observable.create(function(a){var b=!1,c=!1,d=m(l,{reject:function(){var d=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};c||(b=!0,a.error(d))},resolve:function(){var d=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};c||(b=!0,a.next({responseData:d.data,size:d.size||0,duration:d.duration||0}),a.complete())},fallback:function(){c=!0;
A(l).subscribe(a)}});return function(){b||c||"function"!==typeof d||d()}}):A(l)},G={loader:function(a){return z({segment:a.segment})},parser:function(c){var d=c.segment;c=new Uint8Array(c.response.responseData);var e=void 0,h=void 0,g=void 0,k=d.getIndexRange();if(k=a.i(b.a)(c,k?k[0]:0))e=k.segments,h=k.timescale;d.isInitSegment()||(0<=d.getTime()&&0<=d.getDuration()?g={ts:d.getTime(),d:d.getDuration()}:k&&1===k.segments.length&&(g={ts:k.segments[0].ts,d:k.segments[0].d}));k=c;d.isInitSegment()&&
(d=d.getAdaptation(),d.contentProtection&&(k=a.i(b.b)(c,d.contentProtection)));return f.Observable.of({segmentData:k,currentSegment:g,nextSegments:e,timescale:h})}};return{directFile:!1,manifest:{loader:function(b){b=b.url;return a.i(q.a)({url:b,responseType:"document",createXHR:k})},parser:function(b){b=b.response;var c=b.responseData;return f.Observable.of({manifest:a.i(x.a)(c,g),url:b.url})}},audio:G,video:G,text:{loader:function(b){var f=b.segment,e=f.getMedia(),g=f.getRange();b=f.getIndexRange();
var m=0<=("application/mp4"===f.getRepresentation().mimeType)?"arraybuffer":"text";if(f.isInitSegment()&&!(e||g||b))return v();e=e?h(e,f):"";f=a.i(d.b)(f.getResolvedURL(),e);if(g&&b&&g[1]===b[0]-1)return a.i(q.a)({url:f,responseType:m,headers:{Range:l([g[0],b[1]])},createXHR:k});g=a.i(q.a)({url:f,responseType:m,headers:g?{Range:l(g)}:null,createXHR:k});return b?(b=a.i(q.a)({url:f,responseType:m,headers:{Range:l(b)},createXHR:k}),a.i(c.merge)(g,b)):g},parser:function(c){var d=c.segment,e=c.response;
c=d.getAdaptation().lang;var h;"application/mp4"===d.getRepresentation().mimeType?(h=new Uint8Array(e.responseData),e=a.i(m.a)(a.i(b.c)(h))):e=h=e.responseData;var g=void 0,k=void 0,n=void 0,l=d.getIndexRange();if(l=a.i(b.a)(h,l?l[0]:0))g=l.segments,k=l.timescale;h=[];if(!d.isInitSegment())switch(0<=d.getTime()&&0<=d.getDuration()?n={ts:d.getTime(),d:d.getDuration()}:l&&1===l.segments.length&&(n={ts:l.segments[0].ts,d:l.segments[0].d}),d=d.getRepresentation().codecs,(void 0===d?"":d).toLowerCase()){case "stpp":h=
a.i(t.a)(e,c,0);break;default:console.warn("The codec used for the subtitle is not managed yet.")}return f.Observable.of({segmentData:h,currentSegment:n,nextSegments:g,timescale:k})}},image:{loader:function(b){b=b.segment;if(b.init)return v();var c=b.getMedia(),c=c?h(c,b):"";b=a.i(d.b)(b.getResolvedURL(),c);return a.i(q.a)({url:b,responseType:"arraybuffer",createXHR:k})},parser:function(b){var c=new Uint8Array(b.response.responseData),d=b=void 0;c&&(c=a.i(w.a)(c),b=c.thumbs,d=c.timescale);return f.Observable.of({segmentData:b,
currentSegment:{ts:0,d:Infinity},timescale:d})}}}}},function(e,g,a){var l=a(1);e=a(20);var k=a(48),h=[{k:"profiles",fn:k.g},{k:"width",fn:parseInt},{k:"height",fn:parseInt},{k:"frameRate",fn:k.h},{k:"audioSamplingRate",fn:k.g},{k:"mimeType",fn:k.g},{k:"segmentProfiles",fn:k.g},{k:"codecs",fn:k.g},{k:"maximumSAPPeriod",fn:parseFloat},{k:"maxPlayoutRate",fn:parseFloat},{k:"codingDependency",fn:k.i}],f=[{k:"timescale",fn:parseInt,def:1},{k:"timeShiftBufferDepth",fn:k.j},{k:"presentationTimeOffset",fn:parseFloat,
def:0},{k:"indexRange",fn:k.f},{k:"indexRangeExact",fn:k.i,def:!1},{k:"availabilityTimeOffset",fn:parseFloat},{k:"availabilityTimeComplete",fn:k.i,def:!0}],c=f.concat([{k:"duration",fn:parseInt},{k:"startNumber",fn:parseInt}]),d={ContentProtection:[{k:"schemeIdUri",fn:k.g},{k:"value",fn:k.g}],SegmentURL:[{k:"media",fn:k.g},{k:"mediaRange",fn:k.f},{k:"index",fn:k.g},{k:"indexRange",fn:k.f}],S:[{k:"t",fn:parseInt,n:"ts"},{k:"d",fn:parseInt},{k:"r",fn:parseInt}],SegmentTimeline:[],SegmentBase:f,SegmentTemplate:c.concat([{k:"initialization",
fn:function(a){return{media:a,range:void 0}}},{k:"index",fn:k.g},{k:"media",fn:k.g},{k:"bitstreamSwitching",fn:k.g}]),SegmentList:c,ContentComponent:[{k:"id",fn:k.g},{k:"lang",fn:e.c},{k:"contentType",fn:k.g},{k:"par",fn:k.k}],Representation:h.concat([{k:"id",fn:k.g},{k:"bandwidth",fn:parseInt,n:"bitrate"},{k:"qualityRanking",fn:parseInt}]),AdaptationSet:h.concat([{k:"id",fn:k.g},{k:"group",fn:parseInt},{k:"lang",fn:e.c},{k:"contentType",fn:k.g},{k:"par",fn:k.k},{k:"minBandwidth",fn:parseInt,n:"minBitrate"},
{k:"maxBandwidth",fn:parseInt,n:"maxBitrate"},{k:"minWidth",fn:parseInt},{k:"maxWidth",fn:parseInt},{k:"minHeight",fn:parseInt},{k:"maxHeight",fn:parseInt},{k:"minFrameRate",fn:k.h},{k:"maxFrameRate",fn:k.h},{k:"segmentAlignment",fn:k.l},{k:"subsegmentAlignment",fn:k.l},{k:"bitstreamSwitching",fn:k.i}]),Period:[{k:"id",fn:k.g},{k:"start",fn:k.j},{k:"duration",fn:k.j},{k:"bitstreamSwitching",fn:k.i}],MPD:[{k:"id",fn:k.g},{k:"profiles",fn:k.g},{k:"type",fn:k.g,def:"static"},{k:"availabilityStartTime",
fn:k.m},{k:"availabilityEndTime",fn:k.m},{k:"publishTime",fn:k.m},{k:"mediaPresentationDuration",fn:k.j,n:"duration"},{k:"minimumUpdatePeriod",fn:k.j},{k:"minBufferTime",fn:k.j},{k:"timeShiftBufferDepth",fn:k.j},{k:"suggestedPresentationDelay",fn:k.j},{k:"maxSegmentDuration",fn:k.j},{k:"maxSubsegmentDuration",fn:k.j}],Role:[{k:"schemeIdUri",fn:k.g},{k:"value",fn:k.g}],Accessibility:[{k:"schemeIdUri",fn:k.g},{k:"value",fn:parseInt}]};g.a=function(b,c){var f=d[b.nodeName];a.i(l.a)(f,"no attributes for "+
b.nodeName);for(var e=c||{},h=0;h<f.length;h++){var g=f[h],k=g.k,m=g.fn,w=g.n,g=g.def;b.hasAttribute(k)?e[w||k]=m(b.getAttribute(k)):null!=g&&(e[w||k]=g)}return e}},function(e,g,a){a.d(g,"a",function(){return l});a.d(g,"b",function(){return k});a.d(g,"c",function(){return h});a.d(g,"d",function(){return f});e=function(a){return function(c){return a.reduce(function(a,d){c.hasOwnProperty(d)&&(a[d]=c[d]);return a},{})}};var l=e("availabilityStartTime baseURL duration id locations periods presentationLiveGap suggestedPresentationDelay timeShiftBufferDepth transportType type".split(" ")),
k=e(["adaptations","baseURL","duration","id","start"]),h=e("accessibility baseURL id lang representations type".split(" ")),f=e("bitrate baseURL codecs height id index mimeType width".split(" "))},function(e,g,a){function l(a,c){return"string"==typeof a?l.parseFromString(a,c):l.parseFromDocument(a,c)}var k=a(1),h=a(120);l.parseFromString=function(a,c){return l.parseFromDocument((new DOMParser).parseFromString(a,"application/xml"),c)};l.parseFromDocument=function(f,c){var d=f.documentElement;k.a.equal(d.nodeName,
"MPD","document root should be MPD");return a.i(h.a)(d,c)};g.a=l},function(e,g,a){function l(b,c){var d=a.i(p.a)(b,function(a,b,d){switch(b){case "BaseURL":a.baseURL=d.textContent;break;case "Location":a.locations.push(d.textContent);break;case "Period":a.periods.push(k(d,c))}return a},{transportType:"dash",periods:[],locations:[]}),d=a.i(q.a)(b,d);if(/dynamic/.test(d.type)){var f=d.periods[0].adaptations.filter(function(a){return"video"==a.type})[0],f=a.i(p.b)(f);f||(console.warn("Live edge not deduced from manifest, setting a default one"),
f=Date.now()/1E3-60);d.availabilityStartTime=d.availabilityStartTime.getTime()/1E3;d.presentationLiveGap=Date.now()/1E3-(f+d.availabilityStartTime)}return a.i(r.a)(d)}function k(b,c){var d=a.i(q.a)(b,a.i(p.a)(b,function(a,b,d){switch(b){case "BaseURL":a.baseURL=d.textContent;break;case "AdaptationSet":b=h(d,c),null==b.id&&(b.id=a.adaptations.length),a.adaptations.push(b)}return a},{adaptations:[]}));return a.i(r.b)(d)}function h(e,h){var g=void 0,k=a.i(p.a)(e,function(e,k,m){switch(k){case "Accessibility":g=
a.i(q.a)(m);break;case "BaseURL":e.baseURL=m.textContent;break;case "ContentComponent":k=a.i(q.a)(m);e.contentComponent=k;break;case "ContentProtection":k=h(a.i(q.a)(m),m);e.contentProtection=k;break;case "Representation":k=f(m);null==k.id&&(k.id=e.representations.length);e.representations.push(k);break;case "Role":k=a.i(q.a)(m);e.role=k;break;case "SegmentBase":e.index=b(m);break;case "SegmentList":e.index=d(m);break;case "SegmentTemplate":e.index=c(m)}return e},{representations:[]}),m=a.i(q.a)(e,
k);m.type=a.i(p.c)(m);m.accessibility=[];a.i(p.d)(g)&&m.accessibility.push("hardOfHearing");a.i(p.e)(g)&&m.accessibility.push("visuallyImpaired");m.representations=m.representations.map(function(a){x.forEach(function(b){!a.hasOwnProperty(b)&&m.hasOwnProperty(b)&&(a[b]=m[b])});return a});return a.i(r.c)(m)}function f(f){var e=a.i(p.a)(f,function(a,f,e){switch(f){case "BaseURL":a.baseURL=e.textContent;break;case "SegmentBase":a.index=b(e);break;case "SegmentList":a.index=d(e);break;case "SegmentTemplate":a.index=
c(e)}return a},{});f=a.i(q.a)(f,e);return a.i(r.d)(f)}function c(a){a=m(a);a.indexType||(a.indexType="template");return a}function d(b){var c=m(b);c.list=[];c.indexType="list";return a.i(p.a)(b,function(b,c,d){"SegmentURL"==c&&b.list.push(a.i(q.a)(d));return b},c)}function b(b){var c=a.i(p.a)(b,function(b,c,d){if("Initialization"==c){var f=c=void 0;d.hasAttribute("range")&&(c=a.i(p.f)(d.getAttribute("range")));d.hasAttribute("sourceURL")&&(f=d.getAttribute("sourceURL"));b.initialization={range:c,
media:f}}return b},a.i(q.a)(b));"SegmentBase"==b.nodeName&&(c.indexType="base",c.timeline=[]);return c}function m(c){return a.i(p.a)(c,function(a,b,c){"SegmentTimeline"==b&&(a.indexType="timeline",a.timeline=n(c));return a},b(c))}function n(b){return a.i(p.a)(b,function(b,c,d){c=b.length;d=a.i(q.a)(d);null==d.ts&&(c=0<c&&b[c-1],d.ts=c?c.ts+c.d*(c.r+1):0);null==d.r&&(d.r=0);b.push(d);return b},[])}a.d(g,"a",function(){return l});a(1);var p=a(48),r=a(118),q=a(117),x=["codecs","height","index","mimeType",
"width"]},function(e,g,a){function l(c,f){for(var e=c.length,h=0,g,k=void 0;h+8<e&&(k=a.i(b.e)(c,h),g=a.i(b.e)(c,h+4),a.i(d.a)(0<k,"dash: out of range size"),g!==f);)h+=k;if(h>=e)return-1;a.i(d.a)(h+k<=e,"dash: atom out of range");return h}function k(c){for(var f=c.length,e=0,h,g=void 0;e+8<f&&(g=a.i(b.e)(c,e),h=a.i(b.e)(c,e+4),a.i(d.a)(0<g,"dash: out of range size"),1835295092!==h);)e+=g;c=e<f?c.subarray(e+8,e+g):null;return c}function h(c,d){var f=l(c,1936286840);if(-1==f)return null;var e=a.i(b.e)(c,
f),f=f+4+4,h=c[f],f=f+8,g=a.i(b.e)(c,f),f=f+4;if(0===h)h=a.i(b.e)(c,f),f+=4,d+=a.i(b.e)(c,f)+e,f+=4;else if(1===h)h=a.i(b.f)(c,f),f+=8,d+=a.i(b.f)(c,f)+e,f+=8;else return null;for(var e=[],f=f+2,k=a.i(b.g)(c,f),f=f+2;0<=--k;){var m=a.i(b.e)(c,f),f=f+4,n=m&2147483647;if(1==(m&2147483648)>>>31)throw Error("not implemented");m=a.i(b.e)(c,f);f+=4;f+=4;e.push({ts:h,d:m,r:0,range:[d,d+n-1]});h+=m;d+=n}return{segments:e,timescale:g}}function f(c){var f=c.systemId;c=c.privateData;f=f.replace(/-/g,"");a.i(d.a)(32===
f.length);f=a.i(b.h)(4,a.i(b.j)(f),a.i(b.i)(c.length),c);c=f.length+8;return a.i(b.h)(a.i(b.i)(c),a.i(b.b)("pssh"),f)}function c(c,d){if(!d||!d.length)return c;var e=l(c,1836019574);if(-1==e)return c;for(var h=a.i(b.e)(c,e),g=[c.subarray(e,e+h)],k=0;k<d.length;k++)g.push(f(d[k]));g=b.h.apply(null,g);g.set(a.i(b.i)(g.length),0);return a.i(b.h)(c.subarray(0,e),g,c.subarray(e+h))}a.d(g,"a",function(){return h});a.d(g,"b",function(){return c});a.d(g,"c",function(){return k});var d=a(1),b=a(10)},function(e,
g,a){var l=a(0);a.n(l);g.a={directFile:!0,manifest:{parser:function(a){a=a.url;return l.Observable.of({manifest:{transportType:"directfile",locations:[a],periods:[],isLive:!1,duration:Infinity,adaptations:null},url:a})}}}},function(e,g,a){e=a(125);var l=a(116);a=a(122);g.a={smooth:e.a,dash:l.a,directfile:a.a}},function(e,g,a){function l(a){return a.replace(c,"\n").replace(f,function(a,b){return String.fromCharCode(b)})}function k(c,f){var e=/<sync[ >]/ig,g=/<sync[ >]|<\/body>/ig,k=[],n=c.match(d)[1],
p,v;g.exec(c);p=/\.(\S+)\s*{([^}]*)}/gi;v={};for(var y;y=p.exec(n);){var u=y[1];y=y[2].match(/\s*lang:\s*(\S+);/i)[1];u&&y&&(v[y]=u)}n=v[f];for(a.i(h.a)(n,"sami: could not find lang "+f+" in CSS");;){p=e.exec(c);v=g.exec(c);if(!p&&!v)break;if(!p||!v||p.index>=v.index)throw Error("parse error");v=c.slice(p.index,v.index);p=v.match(m);if(!p)throw Error("parse error (sync time attribute)");u=+p[1];if(isNaN(u))throw Error("parse error (sync time attribute NaN)");p=k;v=v.split("\n");u/=1E3;y=v.length;
for(var B;0<=--y;)if(B=v[y].match(b)){var A=B[2];n===B[1]&&("&nbsp;"===A?p[p.length-1].end=u:p.push({text:l(A),start:u}))}}return k}a.d(g,"a",function(){return k});var h=a(1),f=/&#([0-9]+);/g,c=/<br>/gi,d=/<style[^>]*>([\s\S]*?)<\/style[^>]*>/i,b=/\s*<p class=([^>]+)>(.*)/i,m=/<sync[^>]+?start="?([0-9]*)"?[^0-9]/i},function(e,g,a){function l(a){return a.responseData.getElementsByTagName("media")[0].getAttribute("src")}function k(a){return(a=a.match(S))&&a[1]||""}function h(a,b){return b?a.replace(S,
"?token="+b):a.replace(S,"")}function f(a){return a.getResolvedURL().replace(/\{bitrate\}/g,a.getRepresentation().bitrate).replace(/\{start time\}/g,a.getTime())}var c=a(0);a.n(c);e=a(6);a.n(e);var d=a(10),b=a(3),m=a(23),n=a(25),p=a(19),r=a(51),q=a(127),x=a(126),t=a(49),w=a(124),v=a(50),y=x.a.patchSegment,u=x.a.createVideoInitSegment,B=x.a.createAudioInitSegment,A=x.a.getMdat,z=x.a.getTraf,G=x.a.parseTfrf,C=x.a.parseTfxd,H={"application/x-sami":w.a,"application/smil":w.a,"application/ttml+xml":v.a,
"application/ttml+xml+mp4":v.a,"text/vtt":function(a){return a}},D=r.a.RequestResponse,E=e.EmptyObservable.create,L=/\.(isml?)(\?token=\S+)?$/,T=/\.wsx?(\?token=\S+)?/,S=/\?token=(\S+)/;g.a=function(){function e(a,c){var d=void 0,f=void 0;if(c.getAdaptation().isLive){var e=z(a);e?(d=G(e),f=C(e)):b.a.warn("smooth: could not find traf atom")}else d=null;f||(f={d:c.getDuration(),ts:c.getTime()});return{nextSegments:d,currentSegment:f}}var g=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{},w=
a.i(q.a)(g),v=g.createXHR,x=function(a){var b=a.segment;if(b.isInitSegment()){a=b.getAdaptation();var b=b.getRepresentation(),d={},e=a.smoothProtection||{};switch(a.type){case "video":d=u(b.index.timescale,b.width,b.height,72,72,4,b.codecPrivateData,e.keyId,e.keySystems);break;case "audio":d=B(b.index.timescale,b.channels,b.bitsPerSample,b.packetSize,b.samplingRate,b.codecPrivateData,e.keyId,e.keySystems)}return c.Observable.of(new D(200,"","arraybuffer",Date.now()-100,Date.now(),d.length,d))}var h=
g.segmentLoader;a=f(b);var k={adaptation:new m.a(b.getAdaptation()),representation:new n.a(b.getRepresentation()),segment:new p.a(b),transport:"smooth",url:a};return h?c.Observable.create(function(a){var b=!1,c=!1,d=h(k,{reject:function(){var d=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};c||(b=!0,a.error(d))},resolve:function(){var d=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};c||(b=!0,a.next({responseData:d.data,size:d.size||0,duration:d.duration||0}),a.complete())},fallback:function(){c=
!0;N(k).subscribe(a)}});return function(){b||c||"function"!==typeof d||d()}}):N(k)},N=function(b){var c=b.url,d=void 0;if(b=b.segment.range)d=b[0],d=(b=b[1])&&Infinity!==b?"bytes="+ +d+"-"+ +b:"bytes="+ +d+"-",d={Range:d};return a.i(r.a)({url:c,responseType:"arraybuffer",headers:d,createXHR:v})},K={loader:function(a){return x({segment:a.segment})},parser:function(a){var b=a.segment;a=a.response.responseData;if(b.isInitSegment())return c.Observable.of({segmentData:a,timings:null});a=new Uint8Array(a);
var d=e(a,b),b=d.nextSegments,d=d.currentSegment;a=y(a,d.ts);return c.Observable.of({segmentData:a,nextSegments:b,currentSegment:d})}};return{directFile:!1,manifest:{resolver:function(b){b=b.url;var d=void 0,f=k(b),d=T.test(b)?a.i(r.a)({url:h(b,""),responseType:"document",resultSelector:l,createXHR:v}):c.Observable.of(b);return d.map(function(a){var b=a.match(L);a=b?a.replace(b[1],b[1]+"/manifest"):a;return{url:h(a,f)}})},loader:function(b){b=b.url;return a.i(r.a)({url:b,responseType:"document",createXHR:v})},
parser:function(a){a=a.response;return c.Observable.of({manifest:w(a.responseData),url:a.url})}},audio:K,video:K,text:{loader:function(b){var c=b.segment;if(c.isInitSegment())return E();b=c.getRepresentation().mimeType;c=f(c);return 0<=b.indexOf("mp4")?a.i(r.a)({url:c,responseType:"arraybuffer",createXHR:v}):a.i(r.a)({url:c,responseType:"text",createXHR:v})},parser:function(b){var f=b.response;b=b.segment;var h=b.getAdaptation().lang,g=b.getRepresentation(),k=g.mimeType,g=g.index,m=H[k];if(!m)throw Error("could not find a text-track parser for the type "+
k);var l=f.responseData;0<=k.indexOf("mp4")?(l=new Uint8Array(l),f=a.i(d.a)(A(l))):f=l;l=e(l,b);k=l.nextSegments;l=l.currentSegment;b=m(f,h,b.getTime()/g.timescale);return c.Observable.of({segmentData:b,currentSegment:l,nextSegments:k})}},image:{loader:function(b){b=b.segment;if(b.init)return E();b=f(b);return a.i(r.a)({url:b,responseType:"arraybuffer",createXHR:v})},parser:function(b){var d=new Uint8Array(b.response.responseData),f=b=void 0;d&&(d=a.i(t.a)(d),b=d.thumbs,f=d.timescale);return c.Observable.of({segmentData:b,
...
g,"smooth: out of range size"),h!==d);)e+=g;return e<f?c.subarray(e+8,e+g):null}function f(a,b,c,d){var f=[a,b,c];d.forEach(function(a){a=q.pssh(a.systemId,a.privateData,a.keyIds);f.push(a)});return f}function c(b,c,d,f){var e=b.length,h=c.length;d=d.length;b=b.subarray(d,e);e=new Uint8Array(h+(e-d));e.set(c,0);e.set(b,h);c=c.length+8;e.set(a.i(n.i)(c),f+16);return e}function d(b,c,d,e,h,g,k){d=q.mult("stbl",[d,l("stts",new Uint8Array(8)),l("stsc",new Uint8Array(8)),l("stsz",new Uint8Array(12)),l("stco",
new Uint8Array(8))]);var m=l("url ",new Uint8Array([0,0,0,1])),m=q.dref(m),m=q.mult("dinf",[m]);e=q.mult("minf",[e,m,d]);c=q.hdlr(c);d=q.mdhd(b);c=q.mult("mdia",[d,c,e]);h=q.tkhd(h,g,1);h=q.mult("trak",[h,c]);g=q.trex(1);g=q.mult("mvex",[g]);b=q.mvhd(b,1);k=q.mult("moov",f(b,g,h,k));b=q.ftyp("isom",["isom","iso2","iso6","avc1","dash"]);return a.i(n.h)(b,k)}var b=a(1),m=a(9),n=a(10),p=[96E3,88200,64E3,48E3,44100,32E3,24E3,22050,16E3,12E3,11025,8E3,7350],r={},q={mult:function(a,b){return l(a,n.h.apply(null,
b))},avc1encv:function(b,c,d,f,e,h,g,k,m,p){return l(b,a.i(n.h)(6,a.i(n.m)(c),16,a.i(n.m)(d),a.i(n.m)(f),a.i(n.m)(e),2,a.i(n.m)(h),6,[0,1,g.length],a.i(n.b)(g),31-g.length,a.i(n.m)(k),[255,255],m,"encv"===b?p:[]))},avcc:function(b,c,d){d=2===d?1:4===d?3:0;var f=b[1],e=b[2],h=b[3];return l("avcC",a.i(n.h)([1,f,e,h,252|d,225],a.i(n.m)(b.length),b,[1],a.i(n.m)(c.length),c))},dref:function(b){return l("dref",a.i(n.h)(7,[1],b))},esds:function(b,c){return l("esds",a.i(n.h)(4,[3,25],a.i(n.m)(b),[0,4,17,
64,21],11,[5,2],a.i(n.j)(c),[6,1,2]))},frma:function(b){return l("frma",a.i(n.b)(b))},free:function(a){return l("free",new Uint8Array(a-8))},ftyp:function(b,c){return l("ftyp",n.h.apply(null,[a.i(n.b)(b),[0,0,0,1]].concat(c.map(n.b))))},hdlr:function(b){var c;switch(b){case "video":b="vide";c="VideoHandler";break;case "audio":b="soun";c="SoundHandler";break;default:b="hint",c=""}return l("hdlr",a.i(n.h)(8,a.i(n.b)(b),12,a.i(n.b)(c),1))},mdhd:function(b){return l("mdhd",a.i(n.h)(12,a.i(n.i)(b),8))},
moof:function(a,b){return q.mult("moof",[a,b])},mp4aenca:function(b,c,d,f,e,h,g,k){return l(b,a.i(n.h)(6,a.i(n.m)(c),8,a.i(n.m)(d),a.i(n.m)(f),2,a.i(n.m)(e),a.i(n.m)(h),2,g,"enca"===b?k:[]))},mvhd:function(b,c){return l("mvhd",a.i(n.h)(12,a.i(n.i)(b),4,[0,1],2,[1,0],10,[0,1],14,[0,1],14,[64,0,0,0],26,a.i(n.m)(c+1)))},pssh:function(c){var d=1<arguments.length&&void 0!==arguments[1]?arguments[1]:[],f=2<arguments.length&&void 0!==arguments[2]?arguments[2]:[];c=c.replace(/-/g,"");a.i(b.a)(32===c.length,
"wrong system id length");var e,h=f.length;0<h?(e=1,f=n.h.apply(null,[a.i(n.i)(h)].concat(f))):(e=0,f=[]);return l("pssh",a.i(n.h)([e,0,0,0],a.i(n.j)(c),f,a.i(n.i)(d.length),d))},saio:function(b,c,d,f){return l("saio",a.i(n.h)(4,[0,0,0,1],a.i(n.i)(b.length+c.length+d.length+f.length+8+8+8+8)))},saiz:function(b){if(0===b.length)return l("saiz",new Uint8Array);var c=a.i(n.e)(b,0),d=a.i(n.e)(b,4),f=new Uint8Array(9+d);f.set(a.i(n.i)(d),5);for(var d=9,e=8,h,g;e<b.length;)e+=8,2===(c&2)?(g=2,h=a.i(n.g)(b,
e),e+=2+6*h):g=h=0,f[d]=6*h+8+g,d++;return l("saiz",f)},schm:function(b,c){return l("schm",a.i(n.h)(4,a.i(n.b)(b),a.i(n.i)(c)))},senc:function(a){return l("senc",a)},smhd:function(){return l("smhd",new Uint8Array(8))},stsd:function(a){return l("stsd",n.h.apply(null,[7,[a.length]].concat(a)))},tkhd:function(b,c,d){return l("tkhd",a.i(n.h)(a.i(n.i)(7),8,a.i(n.i)(d),20,[1,0,0,0],[0,1,0,0],12,[0,1,0,0],12,[64,0,0,0],a.i(n.m)(b),2,a.i(n.m)(c),2))},trex:function(b){return l("trex",a.i(n.h)(4,a.i(n.i)(b),
[0,0,0,1],12))},tfdt:function(b){return l("tfdt",a.i(n.h)([1,0,0,0],a.i(n.n)(b)))},tenc:function(b,c,d){return l("tenc",a.i(n.h)(6,[b,c],a.i(n.j)(d)))},traf:function(a,b,c,d,f){var e=[a,b,c];d&&e.push(q.senc(d),q.saiz(d),q.saio(f,a,b,c));return q.mult("traf",e)},trun:function(b){if(b[11]&1)return b;var c=new Uint8Array(b.length+4);c.set(a.i(n.i)(b.length+4),0);c.set(b.subarray(4,16),4);c[11]|=1;c.set([0,0,0,0],16);c.set(b.subarray(16,b.length),20);return c},vmhd:function(){var a=new Uint8Array(12);
a[3]=1;return l("vmhd",a)}},x={traf:function(a){return(a=h(a,1836019558))?h(a,1953653094):null},senc:function(a){return k(a,2721664850,1520127764,2722393154,2086964724)},tfxd:function(a){return k(a,1830656773,1121273062,2162299933,2952222642)},tfrf:function(a){return k(a,3565190898,3392751253,2387879627,2655430559)},mdat:function(a){return h(a,1835295092)}};g.a={getMdat:x.mdat,getTraf:x.traf,parseTfrf:function(b){b=x.tfrf(b);if(!b)return[];for(var c=[],d=b[0],f=b[4],e=0;e<f;e++){var h,g;1==d?(g=a.i(n.f)(b,
16*e+5),h=a.i(n.f)(b,16*e+13)):(g=a.i(n.e)(b,8*e+5),h=a.i(n.e)(b,8*e+9));c.push({ts:g,d:h})}return c},parseTfxd:function(b){if(b=x.tfxd(b))return{d:a.i(n.f)(b,12),ts:a.i(n.f)(b,4)}},createVideoInitSegment:function(b,c,f,e,h,g,k,m,l){l||(l=[]);var p=k.split("00000001");k=p[1];p=p[2];k=a.i(n.j)(k);p=a.i(n.j)(p);g=q.avcc(k,p,g);l.length?(m=q.tenc(1,8,m),m=q.mult("schi",[m]),k=q.schm("cenc",65536),p=q.frma("avc1"),m=q.mult("sinf",[p,k,m]),e=q.avc1encv("encv",1,c,f,e,h,"AVC Coding",24,g,m)):e=q.avc1encv("avc1",
1,c,f,e,h,"AVC Coding",24,g);e=q.stsd([e]);return d(b,"video",e,q.vmhd(),c,f,l)},createAudioInitSegment:function(b,c,f,e,h,g,k,m){m||(m=[]);g||(g=(32|p.indexOf(h)&31)<<4,g=(g|c&31)<<3,g=a.i(n.o)(a.i(n.m)(g)));g=q.esds(1,g);if(m.length){k=q.tenc(1,8,k);k=q.mult("schi",[k]);var l=q.schm("cenc",65536),r=q.frma("mp4a");k=q.mult("sinf",[r,l,k]);c=q.mp4aenca("enca",1,c,f,e,h,g,k)}else c=q.mp4aenca("mp4a",1,c,f,e,h,g);c=q.stsd([c]);return d(b,"audio",c,q.smhd(),0,0,m)},patchSegment:function(b,d){var f=b.subarray(0,
a.i(n.e)(b,0)),e=q.tfdt(d),h=e.length,g=a.i(n.e)(f,8),k=a.i(n.e)(f,8+g),l=a.i(n.e)(f,8+g+8),p=a.i(n.e)(f,8+g+8+l),r=f.subarray(8,8+g),t=f.subarray(8+g+8,8+g+8+k-8),k=t.subarray(0,l),p=t.subarray(l,l+p);k.set([0,0,0,1],12);t=x.senc(t);p=q.trun(p);e=q.traf(k,e,p,t,r);r=q.moof(r,e);h=8+g+8+l+h;return m.t?c(b,r,f,h):8<=f.length-r.length?(f=f.length-r.length,b.set(r,0),b.set(q.free(f),r.length),f=r.length+8+f,b.set(a.i(n.i)(f),h+16),b):c(b,r,f,h)}}},function(e,g,a){function l(a){return"boolean"==typeof a?
a:"string"==typeof a?"TRUE"===a.toUpperCase():!1}function k(a){if(!a)return Infinity;a=a.index;var b=a.timeline[a.timeline.length-1];return(b.ts+(b.r+1)*b.d)/a.timescale}function h(b){return[{systemId:"edef8ba9-79d6-4ace-a3c8-27dcd51d21ed",privateData:a.i(f.h)([8,1,18,16],b)}]}var f=a(10),c=a(1),d=a(20),b={audio:"audio/mp4",video:"video/mp4",text:"application/ttml+xml"},m={audio:"mp4a.40.2",video:"avc1.4D401E"};e={AACL:"audio/mp4",AVC1:"video/mp4",H264:"video/mp4",TTML:"application/ttml+xml+mp4"};
var n={audio:[["Bitrate","bitrate",parseInt],["AudioTag","audiotag",parseInt],["FourCC","mimeType",e],["Channels","channels",parseInt],["SamplingRate","samplingRate",parseInt],["BitsPerSample","bitsPerSample",parseInt],["PacketSize","packetSize",parseInt],["CodecPrivateData","codecPrivateData",String]],video:[["Bitrate","bitrate",parseInt],["FourCC","mimeType",e],["CodecPrivateData","codecs",function(a){return(a=(/00000001\d7([0-9a-fA-F]{6})/.exec(a)||[])[1])?"avc1."+a:""}],["MaxWidth","width",parseInt],
["MaxHeight","height",parseInt],["CodecPrivateData","codecPrivateData",String]],text:[["Bitrate","bitrate",parseInt],["FourCC","mimeType",e]]};g.a=function(){function e(a,b,c){for(a=a.firstElementChild;a;)c=b(c,a.nodeName,a),a=a.nextElementSibling;return c}function g(f,g){f.hasAttribute("Timescale")&&(g=+f.getAttribute("Timescale"));var h=f.getAttribute("Type"),k=f.getAttribute("Subtype"),l=f.getAttribute("Name"),p=a.i(d.c)(f.getAttribute("Language")),r=f.getAttribute("Url"),q=n[h],t=[];a.i(c.a)(q,
"unrecognized QualityLevel type "+h);var x=0,w=e(f,function(a,b,c){switch(b){case "QualityLevel":b={};for(var d=0;d<q.length;d++){var f=q[d],e=f[0],g=f[2];b[f[1]]="function"==typeof g?g(c.getAttribute(e)):g[c.getAttribute(e)]}"audio"==h&&(c=c.getAttribute("FourCC")||"",d=b.codecPrivateData,c="AACH"==c?5:d?(parseInt(d.substr(0,2),16)&248)>>3:2,b.codecs=c?"mp4a.40."+c:"");if("video"!=h||b.bitrate>u)b.id=x++,a.representations.push(b);break;case "c":b=a.index;var d=a.index.timeline,f=d.length,e=0<f?d[f-
1]:{d:0,ts:0,r:0},g=+c.getAttribute("d"),k=c.getAttribute("t");(c=+c.getAttribute("r"))&&c--;0<f&&!e.d&&(e.d=k-e.ts,d[f-1]=e);0<f&&g==e.d&&null==k?e.r+=(c||0)+1:d.push({d:g,ts:null==k?e.ts+e.d*(e.r+1):+k,r:c});b.timeline=d}return a},{representations:[],index:{timeline:[],indexType:"smooth",timescale:g,initialization:{}}}),v=w.representations,w=w.index;a.i(c.a)(v.length,"adaptation should have at least one representation");v.forEach(function(a){return a.codecs=a.codecs||m[h]});v.forEach(function(a){return a.mimeType=
a.mimeType||b[h]});if("ADVT"==k)return null;"text"===h&&"DESC"===k&&t.push("hardOfHearing");return{type:h,accessibility:t,index:w,representations:v,name:l,lang:p,baseURL:r}}function q(a){return x((new DOMParser).parseFromString(a,"application/xml"))}function x(b){b=b.documentElement;c.a.equal(b.nodeName,"SmoothStreamingMedia","document root should be SmoothStreamingMedia");a.i(c.a)(/^[2]-[0-2]$/.test(b.getAttribute("MajorVersion")+"-"+b.getAttribute("MinorVersion")),"Version should be 2.0, 2.1 or 2.2");
var d=+b.getAttribute("Timescale")||1E7,h=0,m=e(b,function(b,e,k){switch(e){case "Protection":k=k.firstElementChild;c.a.equal(k.nodeName,"ProtectionHeader","Protection should have ProtectionHeader child");e=a.i(f.b)(atob(k.textContent));var m;m=a.i(f.d)(e,8);m=a.i(f.k)(e.subarray(10,10+m));m=(new DOMParser).parseFromString(m,"application/xml").querySelector("KID").textContent;m=a.i(f.l)(atob(m)).toLowerCase();var l=a.i(f.j)(m);k=k.getAttribute("SystemID").toLowerCase().replace(/\{|\}/g,"");e={keyId:m,
keySystems:[{systemId:k,privateData:e}].concat(B(l))};b.protection=e;break;case "StreamIndex":if(e=g(k,d))e.id=h++,b.adaptations.push(e)}return b},{protection:null,adaptations:[]}),n=m.protection,m=m.adaptations;m.forEach(function(a){return a.smoothProtection=n});var p=void 0,r=void 0,q=void 0,t=void 0,w=l(b.getAttribute("IsLive"));if(w)var p=v,q=+b.getAttribute("DVRWindowLength")/d,t=y,r=m.filter(function(a){return"video"==a.type})[0],x=m.filter(function(a){return"audio"==a.type})[0],r=Math.min(k(r),
k(x)),r=Date.now()/1E3-(r+t);return{transportType:"smoothstreaming",profiles:"",type:w?"dynamic":"static",suggestedPresentationDelay:p,timeShiftBufferDepth:q,presentationLiveGap:r,availabilityStartTime:t,periods:[{duration:(+b.getAttribute("Duration")||Infinity)/d,adaptations:m,laFragCount:+b.getAttribute("LookAheadFragmentCount")}]}}function t(a){return"string"==typeof a?q(a):x(a)}var w=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{},v=w.suggestedPresentationDelay||20,y=w.referenceDateTime||
Date.UTC(1970,0,1,0,0,0,0)/1E3,u=w.minRepresentationBitrate||19E4,B=w.keySystems||h;t.parseFromString=q;t.parseFromDocument=x;return t}},function(e,g,a){function l(a){return a*Math.pow(2,(1<arguments.length&&void 0!==arguments[1]?arguments[1]:1)-1)*(1+(2*Math.random()-1)*k)}a.d(g,"a",function(){return l});var k=.3},function(e,g,a){a.d(g,"a",function(){return l});var l=function(){function a(){if(!(this instanceof a))throw new TypeError("Cannot call a class as a function");this.hash={}}a.prototype.add=
function(a){this.hash[a]=!0};a.prototype.remove=function(a){delete this.hash[a]};a.prototype.test=function(a){return!0===this.hash[a]};return a}()},function(e,g,a){function l(a){return null==a?"":String(a).replace(n,function(a){return p[a]})}function k(b){var c=b.getAverageBitrates(),f=void 0,e=void 0;c.video.take(1).subscribe(function(a){return e=a|0});c.audio.take(1).subscribe(function(a){return f=a|0});return{manifest:b.man,version:b.version,timeFragment:b.frag,currentTime:b.getCurrentTime(),state:b.getPlayerState(),
buffer:a.i(d.b)(b.video.buffered),volume:b.getVolume(),video:{adaptation:b.adas.video,representation:b.reps.video,maxBitrate:b.getVideoMaxBitrate(),bufferSize:b.getVideoBufferSize(),avrBitrate:e},audio:{adaptation:b.adas.audio,representation:b.reps.audio,maxBitrate:b.getAudioMaxBitrate(),bufferSize:b.getAudioBufferSize(),avrBitrate:f}}}function h(a,b){var c=b.parentNode.querySelector("#cp--debug-infos-content");if(c){var d=void 0;try{d=k(a)}catch(u){return}var f=d,e=f.video,g=f.audio,f=f.manifest,
d="<b>Player v"+d.version+"</b> ("+d.state+")<br>";f&&e&&g&&(d+=["Container: "+l(f.transportType),"Live: "+l(""+f.isLive),"Downloading bitrate (Kbit/s):\n          "+(e.representation.bitrate/1E3).toFixed(3)+"/"+(g.representation.bitrate/1E3).toFixed(3),"Estimated bandwidth (Kbit/s):\n          "+(e.avrBitrate/1E3).toFixed(3)+"/"+(g.avrBitrate/1E3).toFixed(3),"Location: "+f.locations[0]].join("<br>"));c.innerHTML=d}}function f(a,d){var f="<style>\n#cp--debug-infos {\n  position: absolute;\n  top: "+
l(d.offsetTop+10)+"px;\n  left: "+l(d.offsetLeft+10)+'px;\n  width: 500px;\n  height: 300px;\n  background-color: rgba(10, 10, 10, 0.83);\n  overflow: hidden;\n  color: white;\n  text-align: left;\n  padding: 2em;\n  box-sizing: border-box;\n}\n#cp--debug-hide-infos {\n  float: right;\n  cursor: pointer;\n}\n</style>\n<div id="cp--debug-infos">\n  <a id="cp--debug-hide-infos">[x]</a>\n  <p id="cp--debug-infos-content"></p>\n</div>',e=d.parentNode,g=e.querySelector("#cp--debug-infos-container");g||
(g=document.createElement("div"),g.setAttribute("id","cp--debug-infos-container"),e.appendChild(g));g.innerHTML=f;m||(m=e.querySelector("#cp--debug-hide-infos"),m.addEventListener("click",function(){return c(d)}));b&&clearInterval(b);b=setInterval(function(){return h(a,d)},1E3);h(a,d)}function c(a){(a=a.parentNode.querySelector("#cp--debug-infos-container"))&&a.parentNode.removeChild(a);b&&(clearInterval(b),b=null);m&&(m.removeEventListener("click",c),m=null)}var d=a(18),b=void 0,m=void 0,n=/[&<>"']/g,
p={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};g.a={getDebug:k,showDebug:f,hideDebug:c,toggleDebug:function(a,b){b.parentNode.querySelector("#cp--debug-infos-container")?c(b):f(a,b)}}},function(e,g,a){var l=this&&this.__extends||function(a,e){function f(){this.constructor=a}for(var c in e)e.hasOwnProperty(c)&&(a[c]=e[c]);a.prototype=null===e?Object.create(e):(f.prototype=e.prototype,new f)};e=function(a){function e(f,c,d){a.call(this);this.parent=f;this.outerValue=c;this.outerIndex=
d;this.index=0}l(e,a);e.prototype._next=function(a){this.parent.notifyNext(this.outerValue,a,this.outerIndex,this.index++,this)};e.prototype._error=function(a){this.parent.notifyError(a,this);this.unsubscribe()};e.prototype._complete=function(){this.parent.notifyComplete(this);this.unsubscribe()};return e}(a(2).Subscriber);g.InnerSubscriber=e},function(e,g,a){var l=a(0);e=function(){function a(a,f,c){this.kind=a;this.value=f;this.exception=c;this.hasValue="N"===a}a.prototype.observe=function(a){switch(this.kind){case "N":return a.next&&
...
case "C":return l.Observable.empty()}throw Error("unexpected notification kind value");};a.createNext=function(e){return"undefined"!==typeof e?new a("N",e):this.undefinedValueNotification};a.createError=function(e){return new a("E",void 0,e)};a.createComplete=function(){return this.completeNotification};a.completeNotification=new a("C");a.undefinedValueNotification=new a("N",void 0);return a}();g.Notification=e},function(e,g,a){e=function(){function a(e,g){void 0===g&&(g=a.now);this.SchedulerAction=
e;this.now=g}a.prototype.schedule=function(a,e,f){void 0===e&&(e=0);return(new this.SchedulerAction(this,a)).schedule(f,e)};a.now=Date.now?Date.now:function(){return+new Date};return a}();g.Scheduler=e},function(e,g,a){var l=this&&this.__extends||function(a,e){function f(){this.constructor=a}for(var c in e)e.hasOwnProperty(c)&&(a[c]=e[c]);a.prototype=null===e?Object.create(e):(f.prototype=e.prototype,new f)};e=function(a){function e(e,c){a.call(this);this.subject=e;this.subscriber=c;this.closed=!1}
l(e,a);e.prototype.unsubscribe=function(){if(!this.closed){this.closed=!0;var a=this.subject,c=a.observers;this.subject=null;!c||0===c.length||a.isStopped||a.closed||(a=c.indexOf(this.subscriber),-1!==a&&c.splice(a,1))}};return e}(a(5).Subscription);g.SubjectSubscription=e},function(e,g,a){var l=this&&this.__extends||function(a,c){function d(){this.constructor=a}for(var b in c)c.hasOwnProperty(b)&&(a[b]=c[b]);a.prototype=null===c?Object.create(c):(d.prototype=c.prototype,new d)};e=a(0);var k=a(36),
h=a(6);a=function(a){function c(c,b){a.call(this);this.arrayLike=c;this.scheduler=b;b||1!==c.length||(this._isScalar=!0,this.value=c[0])}l(c,a);c.create=function(a,b){var d=a.length;return 0===d?new h.EmptyObservable:1===d?new k.ScalarObservable(a[0],b):new c(a,b)};c.dispatch=function(a){var b=a.arrayLike,c=a.index,d=a.subscriber;d.closed||(c>=a.length?d.complete():(d.next(b[c]),a.index=c+1,this.schedule(a)))};c.prototype._subscribe=function(a){var b=this.arrayLike,d=this.scheduler,e=b.length;if(d)return d.schedule(c.dispatch,
0,{arrayLike:b,index:0,length:e,subscriber:a});for(d=0;d<e&&!a.closed;d++)a.next(b[d]);a.complete()};return c}(e.Observable);g.ArrayLikeObservable=a},function(e,g,a){var l=this&&this.__extends||function(a,b){function c(){this.constructor=a}for(var d in b)b.hasOwnProperty(d)&&(a[d]=b[d]);a.prototype=null===b?Object.create(b):(c.prototype=b.prototype,new c)};e=a(8);var k=a(0),h=a(2),f=a(5);a=function(a){function b(b,c){a.call(this);this.source=b;this.subjectFactory=c;this._refCount=0}l(b,a);b.prototype._subscribe=
function(a){return this.getSubject().subscribe(a)};b.prototype.getSubject=function(){var a=this._subject;if(!a||a.isStopped)this._subject=this.subjectFactory();return this._subject};b.prototype.connect=function(){var a=this._connection;a||(a=this._connection=new f.Subscription,a.add(this.source.subscribe(new c(this.getSubject(),this))),a.closed?(this._connection=null,a=f.Subscription.EMPTY):this._connection=a);return a};b.prototype.refCount=function(){return this.lift(new d(this))};return b}(k.Observable);
g.ConnectableObservable=a;g.connectableObservableDescriptor={operator:{value:null},_refCount:{value:0,writable:!0},_subscribe:{value:a.prototype._subscribe},getSubject:{value:a.prototype.getSubject},connect:{value:a.prototype.connect},refCount:{value:a.prototype.refCount}};var c=function(a){function b(b,c){a.call(this,b);this.connectable=c}l(b,a);b.prototype._error=function(b){this._unsubscribe();a.prototype._error.call(this,b)};b.prototype._complete=function(){this._unsubscribe();a.prototype._complete.call(this)};
b.prototype._unsubscribe=function(){var a=this.connectable;if(a){this.connectable=null;var b=a._connection;a._refCount=0;a._subject=null;a._connection=null;b&&b.unsubscribe()}};return b}(e.SubjectSubscriber),d=function(){function a(a){this.connectable=a}a.prototype.call=function(a,c){var d=this.connectable;d._refCount++;var e=new b(a,d),f=c._subscribe(e);e.closed||(e.connection=d.connect());return f};return a}(),b=function(a){function b(b,c){a.call(this,b);this.connectable=c}l(b,a);b.prototype._unsubscribe=
function(){var a=this.connectable;if(a){this.connectable=null;var b=a._refCount;0>=b?this.connection=null:(a._refCount=b-1,1<b?this.connection=null:(b=this.connection,a=a._connection,this.connection=null,!a||b&&a!==b||a.unsubscribe()))}else this.connection=null};return b}(h.Subscriber)},function(e,g,a){var l=this&&this.__extends||function(a,e){function f(){this.constructor=a}for(var c in e)e.hasOwnProperty(c)&&(a[c]=e[c]);a.prototype=null===e?Object.create(e):(f.prototype=e.prototype,new f)};e=function(a){function e(e,
c){a.call(this);this.error=e;this.scheduler=c}l(e,a);e.create=function(a,c){return new e(a,c)};e.dispatch=function(a){a.subscriber.error(a.error)};e.prototype._subscribe=function(a){var c=this.error,d=this.scheduler;if(d)return d.schedule(e.dispatch,0,{error:c,subscriber:a});a.error(c)};return e}(a(0).Observable);g.ErrorObservable=e},function(e,g,a){var l=this&&this.__extends||function(a,b){function c(){this.constructor=a}for(var d in b)b.hasOwnProperty(d)&&(a[d]=b[d]);a.prototype=null===b?Object.create(b):
(c.prototype=b.prototype,new c)},k=a(16),h=a(64),f=a(55),c=a(140),d=a(13),b=a(135),m=a(39),n=a(0),p=a(157),r=a(40);e=function(a){function e(b,c){a.call(this,null);this.ish=b;this.scheduler=c}l(e,a);e.create=function(a,g){if(null!=a){if("function"===typeof a[r.$$observable])return a instanceof n.Observable&&!g?a:new e(a,g);if(k.isArray(a))return new d.ArrayObservable(a,g);if(h.isPromise(a))return new f.PromiseObservable(a,g);if("function"===typeof a[m.$$iterator]||"string"===typeof a)return new c.IteratorObservable(a,
g);if(a&&"number"===typeof a.length)return new b.ArrayLikeObservable(a,g)}throw new TypeError((null!==a&&typeof a||a)+" is not observable");};e.prototype._subscribe=function(a){var b=this.ish,c=this.scheduler;return null==c?b[r.$$observable]().subscribe(a):b[r.$$observable]().subscribe(new p.ObserveOnSubscriber(a,c,0))};return e}(n.Observable);g.FromObservable=e},function(e,g,a){var l=this&&this.__extends||function(a,c){function d(){this.constructor=a}for(var b in c)c.hasOwnProperty(b)&&(a[b]=c[b]);
...
(a[c]=d[c]);a.prototype=null===d?Object.create(d):(b.prototype=d.prototype,new b)};e=a(2);var k=a(65);g.ignoreElements=function(){return this.lift(new h)};var h=function(){function a(){}a.prototype.call=function(a,b){return b._subscribe(new f(a))};return a}(),f=function(a){function c(){a.apply(this,arguments)}l(c,a);c.prototype._next=function(a){k.noop()};return c}(e.Subscriber)},function(e,g,a){var l=this&&this.__extends||function(a,c){function d(){this.constructor=a}for(var b in c)c.hasOwnProperty(b)&&
(a[b]=c[b]);a.prototype=null===c?Object.create(c):(d.prototype=c.prototype,new d)};e=a(2);g.map=function(a,c){if("function"!==typeof a)throw new TypeError("argument is not a function. Are you looking for `mapTo()`?");return this.lift(new k(a,c))};var k=function(){function a(a,d){this.project=a;this.thisArg=d}a.prototype.call=function(a,d){return d._subscribe(new h(a,this.project,this.thisArg))};return a}();g.MapOperator=k;var h=function(a){function c(c,b,e){a.call(this,c);this.project=b;this.count=
0;this.thisArg=e||this}l(c,a);c.prototype._next=function(a){var b;try{b=this.project.call(this.thisArg,a,this.count++)}catch(m){this.destination.error(m);return}this.destination.next(b)};return c}(e.Subscriber)},function(e,g,a){var l=this&&this.__extends||function(a,c){function d(){this.constructor=a}for(var b in c)c.hasOwnProperty(b)&&(a[b]=c[b]);a.prototype=null===c?Object.create(c):(d.prototype=c.prototype,new d)};e=a(2);g.mapTo=function(a){return this.lift(new k(a))};var k=function(){function a(a){this.value=
a}a.prototype.call=function(a,d){return d._subscribe(new h(a,this.value))};return a}(),h=function(a){function c(c,b){a.call(this,c);this.value=b}l(c,a);c.prototype._next=function(a){this.destination.next(this.value)};return c}(e.Subscriber)},function(e,g,a){function l(){for(var a=[],d=0;d<arguments.length;d++)a[d-0]=arguments[d];var d=Number.POSITIVE_INFINITY,b=null,e=a[a.length-1];f.isScheduler(e)?(b=a.pop(),1<a.length&&"number"===typeof a[a.length-1]&&(d=a.pop())):"number"===typeof e&&(d=a.pop());
return null===b&&1===a.length?a[0]:(new k.ArrayObservable(a,b)).lift(new h.MergeAllOperator(d))}var k=a(13),h=a(37),f=a(17);g.merge=function(){for(var a=[],d=0;d<arguments.length;d++)a[d-0]=arguments[d];return this.lift.call(l.apply(void 0,[this].concat(a)))};g.mergeStatic=l},function(e,g,a){var l=this&&this.__extends||function(a,b){function c(){this.constructor=a}for(var d in b)b.hasOwnProperty(d)&&(a[d]=b[d]);a.prototype=null===b?Object.create(b):(c.prototype=b.prototype,new c)};e=a(2);var k=a(132);
g.observeOn=function(a,b){void 0===b&&(b=0);return this.lift(new h(a,b))};var h=function(){function a(a,c){void 0===c&&(c=0);this.scheduler=a;this.delay=c}a.prototype.call=function(a,c){return c._subscribe(new f(a,this.scheduler,this.delay))};return a}();g.ObserveOnOperator=h;var f=function(a){function b(b,c,d){void 0===d&&(d=0);a.call(this,b);this.scheduler=c;this.delay=d}l(b,a);b.dispatch=function(a){a.notification.observe(a.destination)};b.prototype.scheduleMessage=function(a){this.add(this.scheduler.schedule(b.dispatch,
this.delay,new c(a,this.destination)))};b.prototype._next=function(a){this.scheduleMessage(k.Notification.createNext(a))};b.prototype._error=function(a){this.scheduleMessage(k.Notification.createError(a))};b.prototype._complete=function(){this.scheduleMessage(k.Notification.createComplete())};return b}(e.Subscriber);g.ObserveOnSubscriber=f;var c=function(){return function(a,b){this.notification=a;this.destination=b}}();g.ObserveOnMessage=c},function(e,g,a){var l=a(8),k=a(38);g.publish=function(a){return a?
k.multicast.call(this,function(){return new l.Subject},a):k.multicast.call(this,new l.Subject)}},function(e,g,a){var l=this&&this.__extends||function(a,c){function d(){this.constructor=a}for(var b in c)c.hasOwnProperty(b)&&(a[b]=c[b]);a.prototype=null===c?Object.create(c):(d.prototype=c.prototype,new d)};e=a(2);g.scan=function(a,c){return this.lift(new k(a,c))};var k=function(){function a(a,d){this.accumulator=a;this.seed=d}a.prototype.call=function(a,d){return d._subscribe(new h(a,this.accumulator,
this.seed))};return a}(),h=function(a){function c(c,b,e){a.call(this,c);this.accumulator=b;this.index=0;this.accumulatorSet=!1;this.seed=e;this.accumulatorSet="undefined"!==typeof e}l(c,a);Object.defineProperty(c.prototype,"seed",{get:function(){return this._seed},set:function(a){this.accumulatorSet=!0;this._seed=a},enumerable:!0,configurable:!0});c.prototype._next=function(a){if(this.accumulatorSet)return this._tryNext(a);this.seed=a;this.destination.next(a)};c.prototype._tryNext=function(a){var b=
this.index++,c;try{c=this.accumulator(this.seed,a,b)}catch(n){this.destination.error(n)}this.seed=c;this.destination.next(c)};return c}(e.Subscriber)},function(e,g,a){function l(){return new h.Subject}var k=a(38),h=a(8);g.share=function(){return k.multicast.call(this,l).refCount()}},function(e,g,a){var l=this&&this.__extends||function(a,c){function d(){this.constructor=a}for(var b in c)c.hasOwnProperty(b)&&(a[b]=c[b]);a.prototype=null===c?Object.create(c):(d.prototype=c.prototype,new d)};e=a(2);g.skip=
function(a){return this.lift(new k(a))};var k=function(){function a(a){this.total=a}a.prototype.call=function(a,d){return d._subscribe(new h(a,this.total))};return a}(),h=function(a){function c(c,b){a.call(this,c);this.total=b;this.count=0}l(c,a);c.prototype._next=function(a){++this.count>this.total&&this.destination.next(a)};return c}(e.Subscriber)},function(e,g,a){var l=a(13),k=a(36),h=a(6),f=a(57),c=a(17);g.startWith=function(){for(var a=[],b=0;b<arguments.length;b++)a[b-0]=arguments[b];b=a[a.length-
1];c.isScheduler(b)?a.pop():b=null;var e=a.length;return 1===e?f.concatStatic(new k.ScalarObservable(a[0],b),this):1<e?f.concatStatic(new l.ArrayObservable(a,b),this):f.concatStatic(new h.EmptyObservable(b),this)}},function(e,g,a){var l=this&&this.__extends||function(a,d){function b(){this.constructor=a}for(var c in d)d.hasOwnProperty(c)&&(a[c]=d[c]);a.prototype=null===d?Object.create(d):(b.prototype=d.prototype,new b)};e=a(12);var k=a(15);g.switchMap=function(a,d){return this.lift(new h(a,d))};var h=
...
function(e,g,a){var l=this&&this.__extends||function(a,c){function b(){this.constructor=a}for(var d in c)c.hasOwnProperty(d)&&(a[d]=c[d]);a.prototype=null===c?Object.create(c):(b.prototype=c.prototype,new b)},k=a(26),h=a(62);e=a(2);var f=a(173);g.timeout=function(a,d,e){void 0===d&&(d=null);void 0===e&&(e=k.async);var b=h.isDate(a);a=b?+a-e.now():Math.abs(a);return this.lift(new c(a,b,d,e))};var c=function(){function a(a,b,c,d){this.waitFor=a;this.absoluteTimeout=b;this.errorToSend=c;this.scheduler=
d}a.prototype.call=function(a,b){return b._subscribe(new d(a,this.absoluteTimeout,this.waitFor,this.errorToSend,this.scheduler))};return a}(),d=function(a){function b(b,c,d,e,f){a.call(this,b);this.absoluteTimeout=c;this.waitFor=d;this.errorToSend=e;this.scheduler=f;this._previousIndex=this.index=0;this._hasCompleted=!1;this.scheduleTimeout()}l(b,a);Object.defineProperty(b.prototype,"previousIndex",{get:function(){return this._previousIndex},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,
...
this._hasCompleted=!0};b.prototype._complete=function(){this.destination.complete();this._hasCompleted=!0};b.prototype.notifyTimeout=function(){this.error(this.errorToSend||new f.TimeoutError)};return b}(e.Subscriber)},function(e,g,a){var l=this&&this.__extends||function(a,e){function f(){this.constructor=a}for(var c in e)e.hasOwnProperty(c)&&(a[c]=e[c]);a.prototype=null===e?Object.create(e):(f.prototype=e.prototype,new f)};e=function(a){function e(e,c){a.call(this)}l(e,a);e.prototype.schedule=function(a,
c){return this};return e}(a(5).Subscription);g.Action=e},function(e,g,a){var l=this&&this.__extends||function(a,e){function c(){this.constructor=a}for(var d in e)e.hasOwnProperty(d)&&(a[d]=e[d]);a.prototype=null===e?Object.create(e):(c.prototype=e.prototype,new c)},k=a(172);e=function(a){function e(c,d){a.call(this,c,d);this.scheduler=c;this.work=d}l(e,a);e.prototype.requestAsyncId=function(c,d,b){void 0===b&&(b=0);if(null!==b&&0<b)return a.prototype.requestAsyncId.call(this,c,d,b);c.actions.push(this);
return c.scheduled||(c.scheduled=k.Immediate.setImmediate(c.flush.bind(c,null)))};e.prototype.recycleAsyncId=function(c,d,b){void 0===b&&(b=0);if(null!==b&&0<b||null===b&&0<this.delay)return a.prototype.recycleAsyncId.call(this,c,d,b);0===c.actions.length&&(k.Immediate.clearImmediate(d),c.scheduled=void 0)};return e}(a(59).AsyncAction);g.AsapAction=e},function(e,g,a){var l=this&&this.__extends||function(a,e){function f(){this.constructor=a}for(var c in e)e.hasOwnProperty(c)&&(a[c]=e[c]);a.prototype=
null===e?Object.create(e):(f.prototype=e.prototype,new f)};e=function(a){function e(){a.apply(this,arguments)}l(e,a);e.prototype.flush=function(a){this.active=!0;this.scheduled=void 0;var c=this.actions,d,b=-1,e=c.length;a=a||c.shift();do if(d=a.execute(a.state,a.delay))break;while(++b<e&&(a=c.shift()));this.active=!1;if(d){for(;++b<e&&(a=c.shift());)a.unsubscribe();throw d;}};return e}(a(60).AsyncScheduler);g.AsapScheduler=e},function(e,g,a){e=a(168);a=a(169);g.asap=new a.AsapScheduler(e.AsapAction)},
function(e,g,a){var l=this&&this.__extends||function(a,e){function f(){this.constructor=a}for(var c in e)e.hasOwnProperty(c)&&(a[c]=e[c]);a.prototype=null===e?Object.create(e):(f.prototype=e.prototype,new f)};e=function(a){function e(){var e=a.call(this,"argument out of range");this.name=e.name="ArgumentOutOfRangeError";this.stack=e.stack;this.message=e.message}l(e,a);return e}(Error);g.ArgumentOutOfRangeError=e},function(e,g,a){e=a(7);a=function(){function a(a){this.root=a;a.setImmediate&&"function"===
...
a.createElement("script"))};a.prototype.canUsePostMessage=function(){var a=this.root;if(a.postMessage&&!a.importScripts){var e=!0,f=a.onmessage;a.onmessage=function(){e=!1};a.postMessage("","*");a.onmessage=f;return e}return!1};a.prototype.partiallyApplied=function(a){for(var e=[],f=1;f<arguments.length;f++)e[f-1]=arguments[f];f=function d(){var a=d.handler,e=d.args;"function"===typeof a?a.apply(void 0,e):(new Function(""+a))()};f.handler=a;f.args=e;return f};a.prototype.addFromSetImmediateArguments=
function(a){this.tasksByHandle[this.nextHandle]=this.partiallyApplied.apply(void 0,a);return this.nextHandle++};a.prototype.createProcessNextTickSetImmediate=function(){var a=function f(){var a=f.instance,d=a.addFromSetImmediateArguments(arguments);a.root.process.nextTick(a.partiallyApplied(a.runIfPresent,d));return d};a.instance=this;return a};a.prototype.createPostMessageSetImmediate=function(){var a=this.root,e="setImmediate$"+a.Math.random()+"$",f=function d(b){var f=d.instance;b.source===a&&
"string"===typeof b.data&&0===b.data.indexOf(e)&&f.runIfPresent(+b.data.slice(e.length))};f.instance=this;a.addEventListener("message",f,!1);f=function b(){var a=b,e=a.messagePrefix,a=a.instance,f=a.addFromSetImmediateArguments(arguments);a.root.postMessage(e+f,"*");return f};f.instance=this;f.messagePrefix=e;return f};a.prototype.runIfPresent=function(a){if(this.currentlyRunningATask)this.root.setTimeout(this.partiallyApplied(this.runIfPresent,a),0);else{var e=this.tasksByHandle[a];if(e){this.currentlyRunningATask=
!0;try{e()}finally{this.clearImmediate(a),this.currentlyRunningATask=!1}}}};a.prototype.createMessageChannelSetImmediate=function(){var a=this,e=new this.root.MessageChannel;e.port1.onmessage=function(c){a.runIfPresent(c.data)};var f=function d(){var a=d,e=a.channel,a=a.instance.addFromSetImmediateArguments(arguments);e.port2.postMessage(a);return a};f.channel=e;f.instance=this;return f};a.prototype.createReadyStateChangeSetImmediate=function(){var a=function f(){var a=f.instance,d=a.root.document,
b=d.documentElement,e=a.addFromSetImmediateArguments(arguments),g=d.createElement("script");g.onreadystatechange=function(){a.runIfPresent(e);g.onreadystatechange=null;b.removeChild(g);g=null};b.appendChild(g);return e};a.instance=this;return a};a.prototype.createSetTimeoutSetImmediate=function(){var a=function f(){var a=f.instance,d=a.addFromSetImmediateArguments(arguments);a.root.setTimeout(a.partiallyApplied(a.runIfPresent,d),0);return d};a.instance=this;return a};return a}();g.ImmediateDefinition=
a;g.Immediate=new a(e.root)},function(e,g,a){var l=this&&this.__extends||function(a,e){function f(){this.constructor=a}for(var c in e)e.hasOwnProperty(c)&&(a[c]=e[c]);a.prototype=null===e?Object.create(e):(f.prototype=e.prototype,new f)};e=function(a){function e(){var e=a.call(this,"Timeout has occurred");this.name=e.name="TimeoutError";this.stack=e.stack;this.message=e.message}l(e,a);return e}(Error);g.TimeoutError=e},function(e,g,a){var l=this&&this.__extends||function(a,e){function f(){this.constructor=
a}for(var c in e)e.hasOwnProperty(c)&&(a[c]=e[c]);a.prototype=null===e?Object.create(e):(f.prototype=e.prototype,new f)};e=function(a){function e(e){a.call(this);this.errors=e;e=Error.call(this,e?e.length+" errors occurred during unsubscription:\n  "+e.map(function(a,d){return d+1+") "+a.toString()}).join("\n  "):"");this.name=e.name="UnsubscriptionError";this.stack=e.stack;this.message=e.message}l(e,a);return e}(Error);g.UnsubscriptionError=e},function(e,g,a){g.isObject=function(a){return null!=
a&&"object"===typeof a}},function(e,g,a){var l=a(2),k=a(41),h=a(52);g.toSubscriber=function(a,c,d){if(a){if(a instanceof l.Subscriber)return a;if(a[k.$$rxSubscriber])return a[k.$$rxSubscriber]()}return a||c||d?new l.Subscriber(a,c,d):new l.Subscriber(h.empty)}},function(e,g){var a;a=function(){return this}();try{a=a||Function("return this")()||(0,eval)("this")}catch(l){"object"===typeof window&&(a=window)}e.exports=a}])});
