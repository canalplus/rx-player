...
(C/1E3));y=y.getEstimate()}y||(y=t*v/(5*u/4));if(u=y)h.resetEstimate(),r=Math.min(u,v,g)}}null==r&&(r=h.estimator.getEstimate(),r=null!=r&&k.bufferGap<=l?.95*r:r,r=Math.min(null==r?d:r,g));1<k.speed&&(r/=k.speed);k=f;b.hasOwnProperty("bitrate")&&(k=a.i(e.a)(k,b.bitrate));b.hasOwnProperty("width")&&(k=a.i(c.a)(k,b.width));return a.i(m.a)(k,r)||f[0]})["do"](function(a){a&&(d=a.bitrate)})}).distinctUntilChanged(function(a,c){return(a&&a.bitrate)===(c&&c.bitrate)&&(a&&a.id)===(c&&c.id)})};b.prototype.addEstimate=
...
y=m.maxBufferBehind,w=m.maxVideoBitrate,C=m.throttleWhenHidden,A=m.transport,Q=m.transportOptions,B=m.videoElement,m=m.wantedBufferAhead;a.i(p.a)(B instanceof r.a,"videoElement needs to be an HTMLVideoElement");B.preload="auto";h.version="3.0.0-alpha10";h.log=e.a;h.state=void 0;h.defaultTransport=A;h.defaultTransportOptions=Q;h.videoElement=B;h._priv=a.i(D.a)(h);h._priv.destroy$=new f.Subject;h._priv.fullScreenSubscription=a.i(u.a)(B).takeUntil(h._priv.destroy$).subscribe(function(){return h.trigger("fullscreenChange",
