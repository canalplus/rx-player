...
"SW_SECURE_DECODE","SW_SECURE_CRYPTO"],EME_KEY_SYSTEMS:{clearkey:["webkit-org.w3.clearkey","org.w3.clearkey"],widevine:["com.widevine.alpha"],playready:["com.microsoft.playready","com.chromecast.playready","com.youtube.playready"]},FORCED_ENDED_THRESHOLD:.001}},function(e,b,a){function g(a,k){if(!a)throw new l.default(k||"invalid assertion");}Object.defineProperty(b,"__esModule",{value:!0});var l=a(252);b.default=g;b.assertInterface=function(a,k,c){void 0===c&&(c="object");g(null!=a,c+" should be an object");
for(var d in k)k.hasOwnProperty(d)&&g(typeof a[d]===k[d],c+" should have property "+d+" as a "+k[d])}},function(e,b,a){var g=Object.getOwnPropertySymbols,l=Object.prototype.hasOwnProperty,f=Object.prototype.propertyIsEnumerable;e.exports=function(){try{if(!Object.assign)return!1;var a=new String("abc");a[5]="de";if("5"===Object.getOwnPropertyNames(a)[0])return!1;var c={};for(a=0;10>a;a++)c["_"+String.fromCharCode(a)]=a;if("0123456789"!==Object.getOwnPropertyNames(c).map(function(a){return c[a]}).join(""))return!1;
...
b.ErrorTypes=g.ErrorTypes;b.RequestErrorTypes=g.RequestErrorTypes;e=a(87);b.EncryptedMediaError=e.default;e=a(256);b.IndexError=e.default;e=a(31);b.MediaError=e.default;e=a(257);b.OtherError=e.default;e=a(258);b.NetworkError=e.default;a=a(259);b.RequestError=a.default;b.isKnownError=function(a){return!!a&&!!a.type&&0<=Object.keys(g.ErrorTypes).indexOf(a.type)}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(4),l=/^P(([\d.]*)Y)?(([\d.]*)M)?(([\d.]*)D)?T?(([\d.]*)H)?(([\d.]*)M)?(([\d.]*)S)?/,
...
c,d,h,f){this.destination.next(c)};f.prototype.notifyError=function(a,c){this.destination.error(a)};f.prototype.notifyComplete=function(a){this.destination.complete()};return f}(a(2).Subscriber);b.OuterSubscriber=e},function(e,b,a){var g=a(15),l=a(68),f=a(69),k=a(66),c=a(0),d=a(48),h=a(124),n=a(45);b.subscribeToResult=function(a,b,e,q){var m=new h.InnerSubscriber(a,e,q);if(m.closed)return null;if(b instanceof c.Observable)if(b._isScalar)m.next(b.value),m.complete();else return m.syncErrorThrowable=
...
b,a){var g=a(204);b.multicast=function(a,k){return function(c){var d="function"===typeof a?a:function(){return a};if("function"===typeof k)return c.lift(new l(d,k));var h=Object.create(c,g.connectableObservableDescriptor);h.source=c;h.subjectFactory=d;return h}};var l=function(){function a(a,c){this.subjectFactory=a;this.selector=c}a.prototype.call=function(a,c){var d=this.selector,h=this.subjectFactory();a=d(h).subscribe(a);a.add(c.subscribe(h));return a};return a}();b.MulticastOperator=l},function(e,
...
c}a(c,d);c.prototype=null===d?Object.create(d):(h.prototype=d.prototype,new h)}}();Object.defineProperty(b,"__esModule",{value:!0});var l=a(4),f=a(13);e=a(30);var k=a(59),c=a(327);a=function(a){function d(){var d=a.call(this)||this;d.updating=!1;d.readyState="opened";d.buffered=new c.default;return d}g(d,a);d.prototype.appendBuffer=function(a){var c=this;this._lock(function(){return c._append(a)})};d.prototype.remove=function(a,c){var d=this;this._lock(function(){return d._remove(a,c)})};d.prototype.abort=
...
e},function(e,b,a){b.isObject=function(a){return null!=a&&"object"===typeof a}},function(e,b,a){b.empty={closed:!0,next:function(a){},error:function(a){throw a;},complete:function(){}}},function(e,b,a){b.isArrayLike=function(a){return a&&"number"===typeof a.length}},function(e,b,a){b.isPromise=function(a){return a&&"function"!==typeof a.subscribe&&"function"===typeof a.then}},function(e,b,a){e=a(131);b.from=e.FromObservable.create},function(e,b,a){function g(a){var c=a.value;a=a.subscriber;a.closed||
...
d.prototype._complete=function(){this.scheduleMessage(l.Notification.createComplete())};return d}(e.Subscriber);b.ObserveOnSubscriber=k;var c=function(){return function(a,c){this.notification=a;this.destination=c}}();b.ObserveOnMessage=c},function(e,b,a){e=a(0);a=a(138);e.Observable.fromPromise=a.fromPromise},function(e,b,a){var g=a(28);b.isNumeric=function(a){return!g.isArray(a)&&0<=a-parseFloat(a)+1}},function(e,b,a){var g=this&&this.__extends||function(a,b){function c(){this.constructor=a}for(var d in b)b.hasOwnProperty(d)&&
...
f?Object.create(f):(b.prototype=f.prototype,new b)};e=function(a){function f(){a.apply(this,arguments);this.actions=[];this.active=!1;this.scheduled=void 0}g(f,a);f.prototype.flush=function(a){var c=this.actions;if(this.active)c.push(a);else{var d;this.active=!0;do if(d=a.execute(a.state,a.delay))break;while(a=c.shift());this.active=!1;if(d){for(;a=c.shift();)a.unsubscribe();throw d;}}};return f}(a(143).Scheduler);b.AsyncScheduler=e},function(e,b,a){var g=a(49),l=a(145);b.mergeAll=function(a){void 0===
...
0}}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(5),l=a(40),f=a(283);b.default=function(a){var c=l.default(a),d=[];a=a.childNodes;for(var h=0;h<a.length;h++){var b=a[h];"SegmentURL"===b.nodeName&&(b=f.default(b),d.push(b))}a=c.duration;if(null==a)throw Error("Invalid SegmentList: no duration");return g(c,{list:d,duration:a})}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(5),l=a(9),f=a(40),k=a(284);b.default=function(a){for(var c=f.default(a),
h,b,m,e,u=0;u<a.childNodes.length;u++){var q=a.childNodes[u];"SegmentTimeline"===q.nodeName&&(e=k.default(q))}for(u=0;u<a.attributes.length;u++)switch(q=a.attributes[u],q.nodeName){case "initialization":null==c.initialization&&(c.initialization={media:q.value});break;case "index":h=q.value;break;case "media":b=q.value;break;case "bitstreamSwitching":m=l.parseBoolean(q.value)}if(null!=e)c=g({},c,{indexType:"timeline",timeline:e});else{a=c.duration;if(null==a)throw Error("Invalid SegmentTemplate: no duration");
c=g({},c,{indexType:"template",duration:a})}null!=h&&(c.index=h);null!=b&&(c.media=b);null!=m&&(c.bitstreamSwitching=m);return c}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});e=function(){function a(){this._entries=[]}a.prototype.find=function(a){for(var f=0;f<this._entries.length;f++)if(a(this._entries[f]))return this._entries[f];return null};return a}();b.default=e},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});b.default=function(a){if("number"===typeof a)return a;
...
value:{size:c.value.size,duration:c.value.duration}}):f.Observable.empty()).concat(u(d).map(function(a){return{type:"data",value:l({parsed:a},d)}}));default:return f.Observable.of(c)}})}).finally(function(){A.complete()});var c=A.map(function(a){return{type:"error",value:a}});return f.Observable.merge(a,c)}}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});b.default=function(a){var b=a.getAttribute("ttp:frameRate"),f=a.getAttribute("ttp:subFramRate"),k=a.getAttribute("ttp:tickRate"),
c=a.getAttribute("ttp:frameRateMultiplier"),d=a.getAttribute("xml:space");if(d&&"default"!==d&&"preserve"!==d)throw Error("Invalid spacing style");a=Number(b)||30;f=Number(f)||1;var h=Number(k)||0;k=h;var n=a,m=null!=f?f:1;d=d||"default";0===h&&(k=b?a*f:1);c&&(b=/^(\d+) (\d+)$/g.exec(c))&&(n=Number(b[1])/Number(b[2])*a);return{tickRate:k,frameRate:n,subFrameRate:m,spaceStyle:d}}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});b.getBodyNode=function(a){return a.getElementsByTagName("body")[0]};
b.getStyleNodes=function(a){return a.getElementsByTagName("style")};b.getRegionNodes=function(a){return a.getElementsByTagName("region")};b.getTextNodes=function(a){return a.getElementsByTagName("p")}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(338);b.default=function(a,b){var f=a.getAttribute("begin"),c=a.getAttribute("dur");a=a.getAttribute("end");f=f?g.default(f,b):null;c=c?g.default(c,b):null;b=a?g.default(a,b):null;if(null==f||null==b&&null==c)throw Error("Invalid text cue");
return{start:f,end:null==b?f+c:b}}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});b.default=function(a){var b=a.split(":");if(b[2]){a=parseInt(b[0],10);var f=parseInt(b[1],10);b=parseFloat(b[2].replace(",","."));return isNaN(a)||isNaN(f)||isNaN(b)?void 0:3600*a+60*f+b}}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(31),l=a(1),f=a(52);b.default=function(a){return f.default(a,"error").mergeMap(function(){switch(a.error.code){case 1:var c="MEDIA_ERR_ABORTED";
break;case 2:c="MEDIA_ERR_NETWORK";break;case 3:c="MEDIA_ERR_DECODE";break;case 4:c="MEDIA_ERR_SRC_NOT_SUPPORTED";break;default:c="MEDIA_ERR_UNKNOWN"}l.default.error("stream: video element MEDIA_ERR("+c+")");throw new g.default(c,null,!0);})}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(0),l=a(1);b.default=function(a,b,c,d){d=d.pauseWhenStalled;return(void 0===d||d?c.pairwise().map(function(a){var c=a[1].stalled;a=a[0].stalled;if(!a!==!c||a&&c&&a.reason!==c.reason)return!a}).filter(function(a){return null!=
a}).startWith(!1):g.Observable.of(!1)).switchMap(function(c){return c?g.Observable.defer(function(){l.default.info("pause playback to build buffer");a.playbackRate=0;return g.Observable.of(0)}):b.do(function(c){l.default.info("resume playback speed",c);a.playbackRate=c})})}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(7);e=a(3);var l=a(1),f=a(17),k=e.default.DISCONTINUITY_THRESHOLD;b.default=function(a,d){return d.do(function(c){if(c.stalled){var d=c.currentTime,b=f.getNextRangeGap(c.buffered,
d);g.isPlaybackStuck(c.currentTime,c.currentRange,c.state,!!c.stalled)?(l.default.warn("after freeze seek",d,c.currentRange),a.currentTime=d):b<k&&(c=d+b+1/60,l.default.warn("discontinuity seek",d,b,c),a.currentTime=c)}}).share().map(function(a){return a.stalled}).distinctUntilChanged(function(a,c){return!a&&!c||!!a&&!!c&&a.reason===c.reason})}},function(e,b,a){function g(a,b){return k.hasLoadedMetadata(a).do(function(){c.default.info("set initial time",b);a.playbackRate=1;a.currentTime="function"===
typeof b?b():b}).share()}function l(a,b){return k.canPlay(a).do(function(){c.default.info("canplay event");b&&a.play()}).share()}Object.defineProperty(b,"__esModule",{value:!0});var f=a(0),k=a(7),c=a(1);b.default=function(a,c,b){c=g(a,c);a=l(a,b);a=f.Observable.combineLatest(c,a).take(1).mapTo(void 0);return{initialSeek$:c,loadAndPlay$:a}}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});b.PLAYER_STATES={STOPPED:"STOPPED",LOADED:"LOADED",LOADING:"LOADING",PLAYING:"PLAYING",PAUSED:"PAUSED",
...
b,a){e=a(0);a=a(122);e.Observable.combineLatest=a.combineLatest},function(e,b){b=function(){return this}();try{b=b||Function("return this")()||(0,eval)("this")}catch(a){"object"===typeof window&&(b=window)}e.exports=b},function(e,b,a){var g=a(2),l=a(44),f=a(67);b.toSubscriber=function(a,c,d){if(a){if(a instanceof g.Subscriber)return a;if(a[l.rxSubscriber])return a[l.rxSubscriber]()}return a||c||d?new g.Subscriber(a,c,d):new g.Subscriber(f.empty)}},function(e,b,a){var g=this&&this.__extends||function(a,
b){function f(){this.constructor=a}for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c]);a.prototype=null===b?Object.create(b):(f.prototype=b.prototype,new f)};e=function(a){function b(b){a.call(this);this.errors=b;b=Error.call(this,b?b.length+" errors occurred during unsubscription:\n  "+b.map(function(a,d){return d+1+") "+a.toString()}).join("\n  "):"");this.name=b.name="UnsubscriptionError";this.stack=b.stack;this.message=b.message}g(b,a);return b}(Error);b.UnsubscriptionError=e},function(e,b,a){function g(a){return a?
1===a.length?a[0]:function(b){return a.reduce(function(a,d){return d(a)},b)}:l.noop}var l=a(46);b.pipe=function(){for(var a=[],b=0;b<arguments.length;b++)a[b-0]=arguments[b];return g(a)};b.pipeFromArray=g},function(e,b,a){var g=a(21),l=a(28),f=a(22),k=a(123);b.combineLatest=function(){for(var a=[],d=0;d<arguments.length;d++)a[d-0]=arguments[d];var b=d=null;g.isScheduler(a[a.length-1])&&(b=a.pop());"function"===typeof a[a.length-1]&&(d=a.pop());1===a.length&&l.isArray(a[0])&&(a=a[0]);return(new f.ArrayObservable(a,
b)).lift(new k.CombineLatestOperator(d))}},function(e,b,a){var g=this&&this.__extends||function(a,c){function d(){this.constructor=a}for(var b in c)c.hasOwnProperty(b)&&(a[b]=c[b]);a.prototype=null===c?Object.create(c):(d.prototype=c.prototype,new d)},l=a(22),f=a(28);e=a(10);var k=a(11),c={};b.combineLatest=function(){for(var a=[],c=0;c<arguments.length;c++)a[c-0]=arguments[c];var b=null;"function"===typeof a[a.length-1]&&(b=a.pop());1===a.length&&f.isArray(a[0])&&(a=a[0].slice());return function(c){return c.lift.call(new l.ArrayObservable([c].concat(a)),
...
function(a){this.parent.notifyError(a,this);this.unsubscribe()};b.prototype._complete=function(){this.parent.notifyComplete(this);this.unsubscribe()};return b}(a(2).Subscriber);b.InnerSubscriber=e},function(e,b,a){e=a(0);a=a(126);e.Observable.defer=a.defer},function(e,b,a){e=a(127);b.defer=e.DeferObservable.create},function(e,b,a){var g=this&&this.__extends||function(a,c){function d(){this.constructor=a}for(var b in c)c.hasOwnProperty(b)&&(a[b]=c[b]);a.prototype=null===c?Object.create(c):(d.prototype=
...
a&&this.add(l.subscribeToResult(this,a))};return c}(a.OuterSubscriber)},function(e,b,a){e=a(0);a=a(129);e.Observable.empty=a.empty},function(e,b,a){e=a(29);b.empty=e.EmptyObservable.create},function(e,b,a){e=a(0);a=a(70);e.Observable.from=a.from},function(e,b,a){var g=this&&this.__extends||function(a,c){function d(){this.constructor=a}for(var b in c)c.hasOwnProperty(b)&&(a[b]=c[b]);a.prototype=null===c?Object.create(c):(d.prototype=c.prototype,new d)},l=a(28),f=a(68),k=a(69),c=a(71),d=a(132),h=a(22),
n=a(133),m=a(48),p=a(0),u=a(72),q=a(45);e=function(a){function b(c,d){a.call(this,null);this.ish=c;this.scheduler=d}g(b,a);b.create=function(a,e){if(null!=a){if("function"===typeof a[q.observable])return a instanceof p.Observable&&!e?a:new b(a,e);if(l.isArray(a))return new h.ArrayObservable(a,e);if(k.isPromise(a))return new c.PromiseObservable(a,e);if("function"===typeof a[m.iterator]||"string"===typeof a)return new d.IteratorObservable(a,e);if(f.isArrayLike(a))return new n.ArrayLikeObservable(a,
e)}throw new TypeError((null!==a&&typeof a||a)+" is not observable");};b.prototype._subscribe=function(a){var c=this.ish,d=this.scheduler;return null==d?c[q.observable]().subscribe(a):c[q.observable]().subscribe(new u.ObserveOnSubscriber(a,d,0))};return b}(p.Observable);b.FromObservable=e},function(e,b,a){var g=this&&this.__extends||function(a,c){function d(){this.constructor=a}for(var b in c)c.hasOwnProperty(b)&&(a[b]=c[b]);a.prototype=null===c?Object.create(c):(d.prototype=c.prototype,new d)},l=
...
function(){return this};a.prototype.next=function(){return this.idx<this.len?{done:!1,value:this.arr[this.idx++]}:{done:!0,value:void 0}};return a}(),d=Math.pow(2,53)-1},function(e,b,a){var g=this&&this.__extends||function(a,c){function d(){this.constructor=a}for(var b in c)c.hasOwnProperty(b)&&(a[b]=c[b]);a.prototype=null===c?Object.create(c):(d.prototype=c.prototype,new d)};e=a(0);var l=a(47),f=a(29);a=function(a){function c(c,b){a.call(this);this.arrayLike=c;this.scheduler=b;b||1!==c.length||(this._isScalar=
...
function(){return a.completeNotification};a.completeNotification=new a("C");a.undefinedValueNotification=new a("N",void 0);return a}();b.Notification=e},function(e,b,a){e=a(0);a=a(136);e.Observable.fromEvent=a.fromEvent},function(e,b,a){e=a(137);b.fromEvent=e.FromEventObservable.create},function(e,b,a){var g=this&&this.__extends||function(a,c){function d(){this.constructor=a}for(var b in c)c.hasOwnProperty(b)&&(a[b]=c[b]);a.prototype=null===c?Object.create(c):(d.prototype=c.prototype,new d)};e=a(0);
var l=a(43),f=a(42),k=a(35),c=a(16),d=Object.prototype.toString;a=function(a){function b(c,d,b,f){a.call(this);this.sourceObj=c;this.eventName=d;this.selector=b;this.options=f}g(b,a);b.create=function(a,c,d,h){f.isFunction(d)&&(h=d,d=void 0);return new b(a,c,h,d)};b.setupSubscription=function(a,f,h,k,e){if(a&&"[object NodeList]"===d.call(a)||a&&"[object HTMLCollection]"===d.call(a))for(var m=0,n=a.length;m<n;m++)b.setupSubscription(a[m],f,h,k,e);else if(a&&"function"===typeof a.addEventListener&&
"function"===typeof a.removeEventListener){a.addEventListener(f,h,e);var l=function(){return a.removeEventListener(f,h)}}else if(a&&"function"===typeof a.on&&"function"===typeof a.off)a.on(f,h),l=function(){return a.off(f,h)};else if(a&&"function"===typeof a.addListener&&"function"===typeof a.removeListener)a.addListener(f,h),l=function(){return a.removeListener(f,h)};else throw new TypeError("Invalid event target");k.add(new c.Subscription(l))};b.prototype._subscribe=function(a){var c=this.selector;
b.setupSubscription(this.sourceObj,this.eventName,c?function(){for(var d=[],b=0;b<arguments.length;b++)d[b-0]=arguments[b];d=l.tryCatch(c).apply(void 0,d);d===k.errorObject?a.error(k.errorObject.e):a.next(d)}:function(c){return a.next(c)},a,this.options)};return b}(e.Observable);b.FromEventObservable=a},function(e,b,a){e=a(71);b.fromPromise=e.PromiseObservable.create},function(e,b,a){e=a(0);a=a(140);e.Observable.interval=a.interval},function(e,b,a){e=a(141);b.interval=e.IntervalObservable.create},
function(e,b,a){var g=this&&this.__extends||function(a,c){function d(){this.constructor=a}for(var b in c)c.hasOwnProperty(b)&&(a[b]=c[b]);a.prototype=null===c?Object.create(c):(d.prototype=c.prototype,new d)},l=a(74);e=a(0);var f=a(23);a=function(a){function c(c,b){void 0===c&&(c=0);void 0===b&&(b=f.async);a.call(this);this.period=c;this.scheduler=b;if(!l.isNumeric(c)||0>c)this.period=0;b&&"function"===typeof b.schedule||(this.scheduler=f.async)}g(c,a);c.create=function(a,b){void 0===a&&(a=0);void 0===
b&&(b=f.async);return new c(a,b)};c.dispatch=function(a){var c=a.subscriber,d=a.period;c.next(a.index);c.closed||(a.index+=1,this.schedule(a,d))};c.prototype._subscribe=function(a){var d=this.period;a.add(this.scheduler.schedule(c.dispatch,d,{index:0,subscriber:a,period:d}))};return c}(e.Observable);b.IntervalObservable=a},function(e,b,a){var g=this&&this.__extends||function(a,b){function f(){this.constructor=a}for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c]);a.prototype=null===b?Object.create(b):
(f.prototype=b.prototype,new f)};e=function(a){function b(b,c){a.call(this)}g(b,a);b.prototype.schedule=function(a,c){return this};return b}(a(16).Subscription);b.Action=e},function(e,b,a){e=function(){function a(b,f){void 0===f&&(f=a.now);this.SchedulerAction=b;this.now=f}a.prototype.schedule=function(a,b,k){void 0===b&&(b=0);return(new this.SchedulerAction(this,a)).schedule(k,b)};a.now=Date.now?Date.now:function(){return+new Date};return a}();b.Scheduler=e},function(e,b,a){e=a(0);a=a(36);e.Observable.merge=
...
a.concatMap},function(e,b,a){var g=a(166);b.concatMap=function(a,b){return g.concatMap(a,b)(this)}},function(e,b,a){var g=a(49);b.concatMap=function(a,b){return g.mergeMap(a,b,1)}},function(e,b,a){e=a(0);a=a(168);e.Observable.prototype.debounceTime=a.debounceTime},function(e,b,a){var g=a(23),l=a(169);b.debounceTime=function(a,b){void 0===b&&(b=g.async);return l.debounceTime(a,b)(this)}},function(e,b,a){function g(a){a.debouncedNext()}var l=this&&this.__extends||function(a,c){function d(){this.constructor=
...
[b].concat(a)))}}},function(e,b,a){e=a(0);a=a(198);e.Observable.prototype.mergeMap=a.mergeMap;e.Observable.prototype.flatMap=a.mergeMap},function(e,b,a){var g=a(49);b.mergeMap=function(a,b,k){void 0===k&&(k=Number.POSITIVE_INFINITY);return g.mergeMap(a,b,k)(this)}},function(e,b,a){e=a(0);a=a(200);e.Observable.prototype.flatMapTo=a.mergeMapTo;e.Observable.prototype.mergeMapTo=a.mergeMapTo},function(e,b,a){var g=a(201);b.mergeMapTo=function(a,b,k){void 0===k&&(k=Number.POSITIVE_INFINITY);return g.mergeMapTo(a,
b,k)(this)}},function(e,b,a){var g=this&&this.__extends||function(a,b){function c(){this.constructor=a}for(var d in b)b.hasOwnProperty(d)&&(a[d]=b[d]);a.prototype=null===b?Object.create(b):(c.prototype=b.prototype,new c)};e=a(10);var l=a(11);b.mergeMapTo=function(a,b,h){void 0===h&&(h=Number.POSITIVE_INFINITY);"number"===typeof b&&(h=b,b=null);return function(c){return c.lift(new f(a,b,h))}};var f=function(){function a(a,c,b){void 0===b&&(b=Number.POSITIVE_INFINITY);this.ish=a;this.resultSelector=
...
this.hasPrev=!0;this.prev=a};return c}(e.Subscriber)},function(e,b,a){e=a(0);a=a(209);e.Observable.prototype.publish=a.publish},function(e,b,a){var g=a(210);b.publish=function(a){return g.publish(a)(this)}},function(e,b,a){var g=a(6),l=a(50);b.publish=function(a){return a?l.multicast(function(){return new g.Subject},a):l.multicast(new g.Subject)}},function(e,b,a){e=a(0);a=a(212);e.Observable.prototype.scan=a.scan},function(e,b,a){var g=a(213);b.scan=function(a,b){return 2<=arguments.length?g.scan(a,
...
a.timeout},function(e,b,a){var g=a(23),l=a(244);b.timeout=function(a,b){void 0===b&&(b=g.async);return l.timeout(a,b)(this)}},function(e,b,a){var g=this&&this.__extends||function(a,c){function b(){this.constructor=a}for(var d in c)c.hasOwnProperty(d)&&(a[d]=c[d]);a.prototype=null===c?Object.create(c):(b.prototype=c.prototype,new b)},l=a(23),f=a(79);e=a(2);var k=a(83);b.timeout=function(a,b){void 0===b&&(b=l.async);var d=f.isDate(a),h=d?+a-b.now():Math.abs(a);return function(a){return a.lift(new c(h,
d,b,new k.TimeoutError))}};var c=function(){function a(a,c,b,d){this.waitFor=a;this.absoluteTimeout=c;this.scheduler=b;this.errorInstance=d}a.prototype.call=function(a,c){return c.subscribe(new d(a,this.absoluteTimeout,this.waitFor,this.scheduler,this.errorInstance))};return a}(),d=function(a){function c(c,b,d,f,h){a.call(this,c);this.absoluteTimeout=b;this.waitFor=d;this.scheduler=f;this.errorInstance=h;this.action=null;this.scheduleTimeout()}g(c,a);c.dispatchTimeout=function(a){a.error(a.errorInstance)};
...
Array&&function(a,c){a.__proto__=c}||function(a,c){for(var b in c)c.hasOwnProperty(b)&&(a[b]=c[b])};return function(c,b){function d(){this.constructor=c}a(c,b);c.prototype=null===b?Object.create(b):(d.prototype=b.prototype,new d)}}();Object.defineProperty(b,"__esModule",{value:!0});var l=a(246),f=a(84),k=a(0),c=a(38),d=a(6);e=a(3);a(4);var h=a(30),n=a(1),m=a(24),p=a(17),u=a(7),q=a(18),r=a(8),t=a(54),x=a(260),v=a(57),w=a(296),y=a(364),z=a(365),B=a(114),A=a(366),C=a(367),D=a(368),H=e.default.DEFAULT_UNMUTED_VOLUME;
a=function(a){function b(b){void 0===b&&(b={});var h=a.call(this)||this,e=D.parseConstructorOptions(b);b=e.initialAudioBitrate;var k=e.initialVideoBitrate,l=e.limitVideoWidth,m=e.maxAudioBitrate,g=e.maxBufferAhead,p=e.maxBufferBehind,u=e.maxVideoBitrate,t=e.throttleWhenHidden,r=e.videoElement,x=e.wantedBufferAhead;e=e.stopAtEnd;r.preload="auto";h.version="3.3.2";h.log=n.default;h.state="STOPPED";h.videoElement=r;h._priv_destroy$=new d.Subject;q.onFullscreenChange$(r).takeUntil(h._priv_destroy$).subscribe(function(){return h.trigger("fullscreenChange",
h.isFullscreen())});q.onTextTrackChanges$(r.textTracks).takeUntil(h._priv_destroy$).map(function(a){a=a.target;for(var c=[],b=0;b<a.length;b++)c.push(a[b]);return c}).distinctUntilChanged(function(a,c){if(a.length!==c.length)return!1;for(var b=0;b<a.length;b++)if(a[b]!==c[b])return!1;return!0}).subscribe(function(a){return h._priv_onNativeTextTracksNext(a)});h._priv_playing$=new c.ReplaySubject(1);h._priv_speed$=new f.BehaviorSubject(r.playbackRate);h._priv_stopCurrentContent$=new d.Subject;h._priv_streamLock$=
new f.BehaviorSubject(!1);h._priv_wantedBufferAhead$=new f.BehaviorSubject(x);h._priv_maxBufferAhead$=new f.BehaviorSubject(g);h._priv_maxBufferBehind$=new f.BehaviorSubject(p);h._priv_lastBitrates={audio:b,video:k};h._priv_initialMaxAutoBitrates={audio:m,video:u};h._priv_manualBitrates={audio:-1,video:-1};h._priv_throttleWhenHidden=t;h._priv_limitVideoWidth=l;h._priv_mutedMemory=H;h._priv_initialAudioTrack=void 0;h._priv_initialTextTrack=void 0;h._priv_languageManager=null;h._priv_abrManager=null;
h._priv_contentURL=void 0;h._priv_isDirectFile=null;h._priv_currentManifest=null;h._priv_activeRepresentations=null;h._priv_activeAdaptations=null;h._priv_currentPeriod=null;h._priv_contentEventsMemory={period:null,audioTrack:null,textTrack:null,videoBitrate:null,audioBitrate:null,bitrateEstimation:void 0};h._priv_fatalError=null;h._priv_currentImagePlaylist=null;h._priv_stopAtEnd=e;h._priv_setPlayerState(B.PLAYER_STATES.STOPPED);return h}g(b,a);Object.defineProperty(b,"ErrorTypes",{get:function(){return r.ErrorTypes},
...
b.textTrackMode?{textTrackMode:"native",hideNativeSubtitle:b.hideNativeSubtitle}:{textTrackMode:"html",textTrackElement:b.textTrackElement},transport:t,url:v,videoElement:C}).takeUntil(F).publish()}b=H.filter(function(a){return"stalled"===a.type}).map(function(a){return a.value});d=H.filter(function(a){return"loaded"===a.type}).take(1).share();e=q.onEnded$(C);l=q.onSeeking$(C);b=d.mapTo(B.PLAYER_STATES.LOADED).concat(k.Observable.combineLatest(this._priv_playing$,b.startWith(null),e.startWith(null),
...
null;var c=function(){a._priv_streamLock$.next(!1)};v.clearEMESession().catch(function(){return k.Observable.empty()}).subscribe(m.default,c,c)};b.prototype._priv_triggerContentEvent=function(a,c){l(this._priv_contentEventsMemory[a],c)||(this._priv_contentEventsMemory[a]=c,this.trigger(a+"Change",c))};b.prototype._priv_onStreamNext=function(a){switch(a.type){case "activePeriodChanged":this._priv_onActivePeriodChanged(a.value);break;case "periodBufferReady":this._priv_onPeriodBufferReady(a.value);
...
b,a),this._priv_languageManager.setPreferredAudioTrack(b)):(n.default.error("LanguageManager not instanciated for a new "+c+" period"),a.next(null));break;case "text":this._priv_languageManager?(this._priv_languageManager.addPeriod(c,b,a),this._priv_languageManager.setPreferredTextTrack(b)):(n.default.error("LanguageManager not instanciated for a new "+c+" period"),a.next(null));break;default:(c=b.adaptations[c])&&c.length?a.next(c[0]):a.next(null)}};b.prototype._priv_onPeriodBufferCleared=function(a){var c=
...
a){var c={position:a.currentTime,duration:a.duration,playbackRate:a.playbackRate,bufferGap:isFinite(a.bufferGap)?a.bufferGap:0};this._priv_currentManifest&&this._priv_currentManifest.isLive&&0<a.currentTime&&(c.wallClockTime=t.toWallClockTime(a.currentTime,this._priv_currentManifest).getTime()/1E3,c.liveGap=t.getMaximumBufferPosition(this._priv_currentManifest)-a.currentTime);this.trigger("positionUpdate",c)}};return b}(h.default);b.default=a},function(e,b,a){function g(a){return!a||"object"!==typeof a||
"number"!==typeof a.length||"function"!==typeof a.copy||"function"!==typeof a.slice||0<a.length&&"number"!==typeof a[0]?!1:!0}function l(a,b,e){var h;if(null===a||void 0===a||null===b||void 0===b||a.prototype!==b.prototype)return!1;if(c(a)){if(!c(b))return!1;a=f.call(a);b=f.call(b);return d(a,b,e)}if(g(a)){if(!g(b)||a.length!==b.length)return!1;for(h=0;h<a.length;h++)if(a[h]!==b[h])return!1;return!0}try{var l=k(a);var m=k(b)}catch(r){return!1}if(l.length!=m.length)return!1;l.sort();m.sort();for(h=
l.length-1;0<=h;h--)if(l[h]!=m[h])return!1;for(h=l.length-1;0<=h;h--)if(m=l[h],!d(a[m],b[m],e))return!1;return typeof a===typeof b}var f=Array.prototype.slice,k=a(247),c=a(248),d=e.exports=function(a,c,b){b||(b={});return a===c?!0:a instanceof Date&&c instanceof Date?a.getTime()===c.getTime():!a||!c||"object"!=typeof a&&"object"!=typeof c?b.strict?a===c:a==c:l(a,c,b)}},function(e,b){function a(a){var b=[],f;for(f in a)b.push(f);return b}b=e.exports="function"===typeof Object.keys?Object.keys:a;b.shim=
...
e.default;e=a(86);b.requestMediaKeySystemAccess=e.requestMediaKeySystemAccess;a=a(255);b.setMediaKeys=a.default},function(e,b,a){function g(a,b){if(b instanceof k.MockMediaKeys)return b._setVideo(a);if(a.setMediaKeys)return a.setMediaKeys(b);if(null!==b){if(a.WebkitSetMediaKeys)return a.WebkitSetMediaKeys(b);if(a.mozSetMediaKeys)return a.mozSetMediaKeys(b);if(a.msSetMediaKeys)return a.msSetMediaKeys(b)}}Object.defineProperty(b,"__esModule",{value:!0});var l=a(0),f=a(13),k=a(86);b.default=function(a,
b){return l.Observable.defer(function(){return f.default(g(a,b))})}},function(e,b,a){var g=this&&this.__extends||function(){var a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(a,b){a.__proto__=b}||function(a,b){for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c])};return function(c,b){function d(){this.constructor=c}a(c,b);c.prototype=null===b?Object.create(b):(d.prototype=b.prototype,new d)}}();Object.defineProperty(b,"__esModule",{value:!0});var l=a(25),f=a(32);e=function(a){function c(b,
h){var d=a.call(this)||this;Object.setPrototypeOf(d,c.prototype);d.name="IndexError";d.type=l.ErrorTypes.INDEX_ERROR;d.reason=null;d.code=l.ErrorCodes.hasOwnProperty(b)?l.ErrorCodes[b]:"";d.fatal=!!h;d.message=f.default(d.name,d.code,null);return d}g(c,a);return c}(Error);b.default=e},function(e,b,a){var g=this&&this.__extends||function(){var a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(a,b){a.__proto__=b}||function(a,b){for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c])};return function(c,
...
parser:function(a){var c=a.response;a=a.url;var d="string"===typeof c.responseData?(new DOMParser).parseFromString(c.responseData,"text/xml"):c.responseData;a=b(d,a);return l.Observable.of({manifest:a,url:c.url})}},audio:a,video:a,text:{loader:function(a){var c=a.segment,b=a.representation;if(c.isInit)return l.Observable.empty();a=b.mimeType;var f=d.resolveURL(b.baseURL);c=u.buildSegmentURL(f,b,c);return k.default({url:c,responseType:a&&0<=a.indexOf("mp4")?"arraybuffer":"text"})},parser:function(a){var b=
a.segment,d=a.representation,f=a.adaptation,h=a.manifest,e=f.language,k=d.mimeType;k=void 0===k?"":k;d=d.codec;d=void 0===d?"":d;var m=a.response.responseData;a=null;var p=0<=k.indexOf("mp4");if(p){var q=new Uint8Array(m);b=n.default(q,b,h.isLive);var u=b.nextSegments;a=b.segmentInfos;h=a.time;var t=null!=a.duration?a.time+a.duration:void 0;b=a.timescale}else q=m,h=t=b.time||0,t=null!=b.duration?t+b.duration:void 0,b=b.timescale;if(p){var x=d.toLowerCase();if("application/ttml+xml+mp4"===k||"stpp"===
x)x="ttml";else if("wvtt"===x)x="vtt";else throw Error("could not find a text-track parser for the type "+k);k=r(q);k=c.stringFromUTF8(k)}else{switch(k){case "application/x-sami":case "application/smil":x="sami";break;case "application/ttml+xml":x="ttml";break;case "text/vtt":x="vtt"}if(!x)if(x=d.toLowerCase(),"srt"===x)x="srt";else throw Error("could not find a text-track parser for the type "+k);k=m}null!=a&&u&&g(f,u,a);return l.Observable.of({segmentData:{type:x,data:k,language:e,timescale:b,start:h,
end:t,timeOffset:h/b},segmentInfos:a})}},image:{loader:function(a){var c=a.segment;a=a.representation;if(c.isInit)return l.Observable.empty();var b=d.resolveURL(a.baseURL);c=u.buildSegmentURL(b,a,c);return k.default({url:c,responseType:"arraybuffer"})},parser:function(a){a=new Uint8Array(a.response.responseData);a=f.default(a);return l.Observable.of({segmentData:{data:a.thumbs,start:0,end:Number.MAX_VALUE,timescale:1,timeOffset:0,type:"bif"},segmentInfos:{time:0,duration:Number.MAX_VALUE,timescale:a.timescale}})}}}}},
function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(1),l=a(33);e=a(55);var f=e.default.getTraf,k=e.default.parseTfrf,c=e.default.parseTfxd;b.default=function(a,b,e){var d=[];if(e)if(e=f(a)){var h=k(e);var n=c(e)}else g.default.warn("smooth: could not find traf atom");n?a={time:n.time,duration:n.duration,timescale:b.timescale}:(n=Math.min(.9*b.timescale,null!=b.duration?b.duration/4:.25),a=l.getDurationFromTrun(a),a=0<=a&&(null==b.duration||Math.abs(a-b.duration)<=n)?{time:b.time,
duration:a,timescale:b.timescale}:{time:b.time,duration:b.duration,timescale:b.timescale});if(h)for(n=0;n<h.length;n++)d.push({time:h[n].time,duration:h[n].duration,timescale:b.timescale});return{nextSegments:d,segmentInfos:a}}},function(e,b,a){function g(a,c){for(var b=a.length,h=0,e,k=0;h+8<b&&(k=f.be4toi(a,h),e=f.be4toi(a,h+4),l.default(0<k,"out of range size"),e!==c);)h+=k;return h<b?a.subarray(h+8,h+k):null}Object.defineProperty(b,"__esModule",{value:!0});var l=a(4),f=a(26);b.getTRAF=function(a){return(a=
g(a,1836019558))?g(a,1953653094):null};b.getMDAT=function(a){return g(a,1835295092)};b.getMDIA=function(a){a=g(a,1836019574);return a?(a=g(a,1953653099))?g(a,1835297121):null:null}},function(e,b,a){function g(a){a=(/00000001\d7([0-9a-fA-F]{6})/.exec(a)||[])[1];return(a=void 0===a?"":a)&&"avc1."+a}function l(a){return"boolean"===typeof a?a:"string"===typeof a?"TRUE"===a.toUpperCase():!1}function f(a){return[{systemId:"edef8ba9-79d6-4ace-a3c8-27dcd51d21ed",privateData:n.concat([8,1,18,16],a)}]}function k(a){a.periods.forEach(function(c){var b=
[];c.adaptations.forEach(function(c){var f=c.id;d.default(b,f)&&(u.default.warn("Smooth: Two adaptations with the same ID found. Updating.",f),f+="-",c.id=f,k(a));b.push(f);var h=[];c.representations.forEach(function(c){var b=c.id;d.default(h,b)&&(u.default.warn("Smooth: Two representations with the same ID found. Updating.",b),b+="-",c.id=b,k(a));h.push(b)})})})}Object.defineProperty(b,"__esModule",{value:!0});var c=a(3),d=a(14),h=a(4),n=a(26),m=a(20),p=a(34),u=a(1),q=a(19),r=a(267),t={audio:"audio/mp4",
video:"video/mp4",text:"application/ttml+xml"},x={audio:"mp4a.40.2",video:"avc1.4D401E"},v={AACL:"audio/mp4",AVC1:"video/mp4",H264:"video/mp4",TTML:"application/ttml+xml+mp4"};b.default=function(a){function b(a,c,b){for(a=a.firstElementChild;a;)b=c(b,a.nodeName,a),a=a.nextElementSibling;return b}function d(a,c){function b(c){c=a.getAttribute(c);return null==c?void 0:c}switch(c){case "audio":var d=b("AudioTag");var f=b("Bitrate");var h=b("BitsPerSample"),e=b("Channels");var k=b("CodecPrivateData");
c=b("FourCC");var l=b("PacketSize"),m=b("SamplingRate");return{audiotag:void 0!==d?parseInt(d,10):d,bitrate:f?parseInt(f,10)||0:0,bitsPerSample:void 0!==h?parseInt(h,10):h,channels:void 0!==e?parseInt(e,10):e,codecPrivateData:k||"",mimeType:void 0!==c?v[c]:c,packetSize:void 0!==l?parseInt(l,10):l,samplingRate:void 0!==m?parseInt(m,10):m};case "video":return f=b("Bitrate"),k=b("CodecPrivateData"),c=b("FourCC"),d=b("MaxWidth"),h=b("MaxHeight"),{bitrate:f?parseInt(f,10)||0:0,mimeType:void 0!==c?v[c]:
c,codecPrivateData:k||"",codecs:g(k||""),width:void 0!==d?parseInt(d,10):void 0,height:void 0!==h?parseInt(h,10):void 0};case "text":return f=b("Bitrate"),k=b("CodecPrivateData"),c=b("FourCC"),{bitrate:f?parseInt(f,10)||0:0,mimeType:void 0!==c?v[c]:c,codecPrivateData:k||""};default:throw Error("Unrecognized StreamIndex type: "+c);}}function e(a,c,f,e){var k=a.hasAttribute("Timescale")?+(a.getAttribute("Timescale")||0):f,l=a.getAttribute("Type");if(null==l)throw Error("StreamIndex without type.");
f=a.getAttribute("Subtype");var m=a.getAttribute("Name"),g=a.getAttribute("Language"),n=null==g?g:p.normalize(g),u=a.getAttribute("Url")||"";a=b(a,function(a,c,b){switch(c){case "QualityLevel":c=d(b,l);if("audio"===l){var f=b.getAttribute("FourCC")||"",h=c.codecPrivateData;f="AACH"===f?5:h?(parseInt(h.substr(0,2),16)&248)>>3:2;c.codecs=f?"mp4a.40."+f:""}("video"!==l||c.bitrate>D)&&a.representations.push(c);break;case "c":c=a.index;f=a.index.timeline;h=f.length;var e=0<h?f[h-1]:{d:0,ts:0,r:0},k=b.getAttribute("d"),
m=b.getAttribute("t");b=(b=b.getAttribute("r"))?+b-1:0;m=m?+m:void 0;k=k?+k:void 0;0<h&&!e.d&&(e.d=null!=m?m-e.ts:0,f[h-1]=e);0<h&&k===e.d&&null==m?e.r+=(b||0)+1:f.push({d:k,ts:null==m?e.ts+(e.d||0)*(e.r+1):m,r:b});c.timeline=f}return a},{representations:[],index:{timeline:[],timescale:k,initialization:{}}});k=a.representations;var v=a.index;h.default(0!==k.length,"adaptation should have at least one representation");var w=l+(g?"_"+g:"");k.forEach(function(a){a.baseURL=q.resolveURL(c,u);a.mimeType=
a.mimeType||t[l];a.codecs=a.codecs||x[l];a.id=w+"_"+l+"-"+a.mimeType+"-"+a.codecs+"-"+a.bitrate;a.index=new r.default(v,{bitsPerSample:a.bitsPerSample,channels:a.channels,codecPrivateData:a.codecPrivateData,packetSize:a.packetSize,samplingRate:a.samplingRate,protection:e})});if("ADVT"===f)return null;m={id:w,type:l,representations:k,name:null==m?void 0:m,language:null==g?void 0:g,normalizedLanguage:null==n?void 0:n};"text"===l&&"DESC"===f&&(m.closedCaption=!0);return m}void 0===a&&(a={});var u=null==
a.suggestedPresentationDelay?c.default.DEFAULT_SUGGESTED_PRESENTATION_DELAY.SMOOTH:a.suggestedPresentationDelay,w=a.referenceDateTime||Date.UTC(1970,0,1,0,0,0,0)/1E3,D=a.minRepresentationBitrate||19E4,H=a.keySystems||f;return function(a,c){var d=q.normalizeBaseURL(c);var f=a.documentElement;h.default("SmoothStreamingMedia"===f.nodeName,"document root should be SmoothStreamingMedia");h.default(/^[2]-[0-2]$/.test(f.getAttribute("MajorVersion")+"-"+f.getAttribute("MinorVersion")),"Version should be 2.0, 2.1 or 2.2");
var g=+(f.getAttribute("Timescale")||1E7);a=b(f,function(a,c,b){switch(c){case "Protection":b=b.firstElementChild;h.default("ProtectionHeader"===b.nodeName,"Protection should have ProtectionHeader child");c=n.strToBytes(atob(b.textContent||""));var d=n.le2toi(c,8);d=n.bytesToUTF16Str(c.subarray(10,d+10));d=(new DOMParser).parseFromString(d,"application/xml").querySelector("KID");if(!d)throw Error("invalid XML");d=n.guidToUuid(atob(d.textContent||"")).toLowerCase();var f=n.hexToBytes(d);b=(b.getAttribute("SystemID")||
"").toLowerCase().replace(/\{|\}/g,"");c={keyId:d,keySystems:[{systemId:b,privateData:c}].concat(H(f))};a.protection=c;break;case "StreamIndex":a.adaptationNodes.push(b)}return a},{adaptationNodes:[]});var p=a.protection;a=a.adaptationNodes.map(function(a){return e(a,d,g,p)}).filter(function(a){return!!a});var t,r=a.filter(function(a){return"video"===a.type})[0],x=a.filter(function(a){return"audio"===a.type})[0],v;if(r||x){var y=[],B=[];if(r){var A=r.representations[0];A&&(r=A.index.getFirstPosition(),
A=A.index.getLastPosition(),null!=r&&y.push(r),null!=A&&B.push(A))}x&&(r=x.representations[0])&&(x=r.index.getFirstPosition(),r=r.index.getLastPosition(),null!=x&&y.push(x),null!=r&&B.push(r));y.length&&(v=Math.max.apply(Math,y));B.length&&(t=Math.max.apply(Math,B))}if(y=l(f.getAttribute("IsLive"))){var C=u;var z=+(f.getAttribute("DVRWindowLength")||0)/g;var D=w;var F=Date.now()/1E3-(null!=t?t+D:10);f=f.getAttribute("Duration");t=null!=f&&0!==+f?+f/g:Infinity}else f=f.getAttribute("Duration"),t=null!=
f&&0!==+f?null==t?(+f+(v||0))/g:t:Infinity;v=null!=v?v/g:void 0;c={id:"gen-smooth-manifest-"+m.default(),availabilityStartTime:D||0,duration:t,presentationLiveGap:F,suggestedPresentationDelay:C,timeShiftBufferDepth:z,transportType:"smooth",type:y?"dynamic":"static",uris:[c],minimumTime:v,periods:[{id:"gen-smooth-period-0",duration:t,adaptations:a,start:0}]};k(c);return c}}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});b.default={aa:"aar",ab:"abk",ae:"ave",af:"afr",ak:"aka",am:"amh",
an:"arg",ar:"ara",as:"asm",av:"ava",ay:"aym",az:"aze",ba:"bak",be:"bel",bg:"bul",bi:"bis",bm:"bam",bn:"ben",bo:"bod",br:"bre",bs:"bos",ca:"cat",ce:"che",ch:"cha",co:"cos",cr:"cre",cs:"ces",cu:"chu",cv:"chv",cy:"cym",da:"dan",de:"deu",dv:"div",dz:"dzo",ee:"ewe",el:"ell",en:"eng",eo:"epo",es:"spa",et:"est",eu:"eus",fa:"fas",ff:"ful",fi:"fin",fj:"fij",fo:"fao",fr:"fra",fy:"fry",ga:"gle",gd:"gla",gl:"glg",gn:"grn",gu:"guj",gv:"glv",ha:"hau",he:"heb",hi:"hin",ho:"hmo",hr:"hrv",ht:"hat",hu:"hun",hy:"hye",
hz:"her",ia:"ina",id:"ind",ie:"ile",ig:"ibo",ii:"iii",ik:"ipk",io:"ido",is:"isl",it:"ita",iu:"iku",ja:"jpn",jv:"jav",ka:"kat",kg:"kon",ki:"kik",kj:"kua",kk:"kaz",kl:"kal",km:"khm",kn:"kan",ko:"kor",kr:"kau",ks:"kas",ku:"kur",kv:"kom",kw:"cor",ky:"kir",la:"lat",lb:"ltz",lg:"lug",li:"lim",ln:"lin",lo:"lao",lt:"lit",lu:"lub",lv:"lav",mg:"mlg",mh:"mah",mi:"mri",mk:"mkd",ml:"mal",mn:"mon",mr:"mar",ms:"msa",mt:"mlt",my:"mya",na:"nau",nb:"nob",nd:"nde",ne:"nep",ng:"ndo",nl:"nld",nn:"nno",no:"nor",nr:"nbl",
nv:"nav",ny:"nya",oc:"oci",oj:"oji",om:"orm",or:"ori",os:"oss",pa:"pan",pi:"pli",pl:"pol",ps:"pus",pt:"por",qu:"que",rm:"roh",rn:"run",ro:"ron",ru:"rus",rw:"kin",sa:"san",sc:"srd",sd:"snd",se:"sme",sg:"sag",si:"sin",sk:"slk",sl:"slv",sm:"smo",sn:"sna",so:"som",sq:"sqi",sr:"srp",ss:"ssw",st:"sot",su:"sun",sv:"swe",sw:"swa",ta:"tam",te:"tel",tg:"tgk",th:"tha",ti:"tir",tk:"tuk",tl:"tgl",tn:"tsn",to:"ton",tr:"tur",ts:"tso",tt:"tat",tw:"twi",ty:"tah",ug:"uig",uk:"ukr",ur:"urd",uz:"uzb",ve:"ven",vi:"vie",
vo:"vol",wa:"wln",wo:"wol",xh:"xho",yi:"yid",yo:"yor",za:"zha",zh:"zho",zu:"zul"}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});b.default={alb:"sqi",arm:"hye",baq:"eus",bur:"mya",chi:"zho",cze:"ces",dut:"nld",fre:"fra",geo:"kat",ger:"deu",gre:"ell",ice:"isl",mac:"mkd",mao:"mri",may:"msa",per:"fas",slo:"slk",rum:"ron",tib:"bod",wel:"cym"}},function(e,b,a){function g(a){var b=a.ts,e=a.d;a=a.r;return null==e||-1===e?b:b+(a+1)*e}Object.defineProperty(b,"__esModule",{value:!0});e=function(){function a(a,
b){this._index=a;this._bitsPerSample=b.bitsPerSample;this._channels=b.channels;this._codecPrivateData=b.codecPrivateData;this._packetSize=b.packetSize;this._samplingRate=b.samplingRate;this._protection=b.protection}a.prototype.getInitSegment=function(){return{id:"init",isInit:!0,time:0,timescale:this._index.timescale,privateInfos:{type:"smooth-init",bitsPerSample:this._bitsPerSample,channels:this._channels,codecPrivateData:this._codecPrivateData,packetSize:this._packetSize,samplingRate:this._samplingRate,
protection:this._protection}}};a.prototype.getSegments=function(a,b){var c=this._index,d=c.presentationTimeOffset||0,f=c.timescale||1;var e=a*f-d;a=(a+b)*f-d;b=c.timeline;c=c.timescale;var k;d=[];for(var l=(f=b.length)&&b[0].d||0,g=0;g<f;g++){var q=b[g],r=q.d,t=q.ts;l=Math.max(l,r||0);if(null!=r&&0>r){if(t+l<a){var x={id:""+t,time:t,isInit:!1,timescale:c,number:null!=k?k:void 0};d.push(x)}break}var v=b[g+1];x=q.r||0;null!=q.d&&0>x&&(x=Math.ceil(((v?v.ts:Infinity)-q.ts)/q.d)-1);q=x;r?(v=e-t,v=0<v?
Math.floor(v/r):0):v=0;for(x=t+v*(null==r?0:r);x<a&&v<=q;)x={id:""+x,time:x,isInit:!1,duration:r,timescale:c,number:null!=k?k+v:void 0},d.push(x),v++,x=t+v*r;if(x>=a)break;null!=k&&(k+=q+1)}return d};a.prototype.shouldRefresh=function(a,b,c){var d=this._index,f=d.timeline;d=d.timescale;f=f[f.length-1];if(!f)return!1;var e=f.r||0,k=f.ts+e*f.d;if(c*d<k)return!1;if(b*d>=k)return!0;a=a[a.length-1];return!a||f.ts+e*f.d>a.time?!1:!0};a.prototype.getFirstPosition=function(){var a=this._index;if(a.timeline.length)return a.timeline[0].ts/
a.timescale};a.prototype.getLastPosition=function(){var a=this._index;if(a.timeline.length)return g(a.timeline[a.timeline.length-1])/a.timescale};a.prototype.checkDiscontinuity=function(a){var b=this._index,c=b.timeline,d=b.timescale;d=void 0===d?1:d;a*=d;if(0>=a)return-1;b=b.timeline;var f=0;for(var e=b.length;f<e;){var l=f+e>>>1;b[l].ts<a?f=l+1:e=l}f=0<f?f-1:f;if(0>f||f>=c.length-1)return-1;e=c[f];if(-1===e.d)return-1;b=e.ts;e=g(e);c=c[f+1];return e!==c.ts&&a>=b&&a<=e&&e-a<d?c.ts/d:-1};a.prototype._update=
function(a){this._index=a._index};a.prototype._addSegments=function(a,b){for(var c=0;c<a.length;c++){var d=void 0,f=this._index,e=a[c],k=f.timeline,l=f.timescale,u=k.length,q=k[u-1];e=e.timescale===l?{time:e.time,duration:e.duration}:{time:e.time/e.timescale*l,duration:e.duration/e.timescale*l};b&&b.timescale&&(d=b.timescale===l?b.time:b.time/b.timescale*l);null!=d&&e.time===d?(d=e.time+e.duration,l=d-(q.ts+(q.d||0)*q.r),0>=l||(-1===q.d&&((u=k[u-2])&&u.d===l?(u.r++,k.pop()):q.d=l),f.timeline.push({d:-1,
ts:d,r:0}))):e.time>=g(q)&&(q.d===e.duration?q.r++:f.timeline.push({d:e.duration,ts:e.time,r:0}))}};return a}();b.default=e},function(e,b,a){function g(a){var b=a.url,d;(a=a.segment.range)&&(d={Range:c.byteRange(a)});return f.default({url:b,responseType:"arraybuffer",headers:d})}Object.defineProperty(b,"__esModule",{value:!0});var l=a(0);a(4);var f=a(27),k=a(19);e=a(55);var c=a(91),d=e.default.createVideoInitSegment,h=e.default.createAudioInitSegment;b.default=function(a){return function(b){var f=
b.segment,e=b.representation,m=b.adaptation,n=b.period,t=b.manifest;b=b.init;if(f.isInit){if(!f.privateInfos||"smooth-init"!==f.privateInfos.type)throw Error("Smooth: Invalid segment format");n=void 0;n=f.privateInfos;t=n.protection;switch(m.type){case "video":n=d(f.timescale,e.width||0,e.height||0,72,72,4,n.codecPrivateData,t&&t.keyId,t&&t.keySystems);break;case "audio":n=h(f.timescale,n.channels||0,n.bitsPerSample||0,n.packetSize||0,n.samplingRate||0,n.codecPrivateData,t&&t.keyId,t&&t.keySystems);
break;default:n=new Uint8Array(0)}return l.Observable.of({type:"data",value:{responseData:n}})}var x=c.buildSegmentURL(k.resolveURL(e.baseURL),e,f),v={adaptation:m,init:b,manifest:t,period:n,representation:e,segment:f,transport:"smooth",url:x};return a?l.Observable.create(function(c){var b=!1,d=!1,f=a(v,{reject:function(a){void 0===a&&(a={});d||(b=!0,c.error(a))},resolve:function(a){d||(b=!0,c.next({type:"response",value:{responseData:a.data,size:a.size,duration:a.duration}}),c.complete())},fallback:function(){d=
!0;g(v).subscribe(c)}});return function(){b||d||"function"!==typeof f||f()}}):g(v)}}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(0),l=a(33),f=a(88),k=a(27),c=a(19),d=a(90),h=a(92),n=a(270),m=a(286),p=a(287),u=a(56);b.default=function(a){void 0===a&&(a={});var b=d.default({customManifestLoader:a.manifestLoader}),e=m.default(a.segmentLoader);a={loader:function(a){return e({adaptation:a.adaptation,init:a.init,manifest:a.manifest,period:a.period,representation:a.representation,
segment:a.segment})},parser:function(a){var c=a.segment,b=a.representation,d=a.response;a=a.init;d=d.responseData instanceof Uint8Array?d.responseData:new Uint8Array(d.responseData);var f=null,e=c.indexRange;e=l.parseSidx(d,e?e[0]:0);c.isInit?(e&&u.addNextSegments(b,e),c=l.getMDHDTimescale(d),0<c&&(f={time:-1,duration:0,timescale:c})):f=h.default(c,d,e,a);return g.Observable.of({segmentData:d,segmentInfos:f})}};return{manifest:{loader:function(a){return b(a.url)},parser:function(a){var c=a.response;
a=a.url;var b="string"===typeof c.responseData?(new DOMParser).parseFromString(c.responseData,"text/xml"):c.responseData;return g.Observable.of({manifest:n.default(b,a),url:c.url})}},audio:a,video:a,text:{loader:p.loader,parser:p.parser},image:{loader:function(a){var b=a.segment;a=a.representation;if(b.isInit)return g.Observable.empty();var d=b.media;b=d?u.replaceTokens(d,b,a):"";b=c.resolveURL(a.baseURL,b);return k.default({url:b,responseType:"arraybuffer"})},parser:function(a){a=new Uint8Array(a.response.responseData);
a=f.default(a);return g.Observable.of({segmentData:{data:a.thumbs,start:0,end:Number.MAX_VALUE,timescale:1,timeOffset:0,type:"bif"},segmentInfos:{time:0,duration:Number.MAX_VALUE,timescale:a.timescale}})}}}}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(271);b.default=function(a,b){a=a.documentElement;if(!a||"MPD"!==a.nodeName)throw Error("document root should be MPD");return g.default(a,b)}},function(e,b,a){function g(a,c,b,d,e){function h(a,c){var b=a.split("/")[0];if(f.default(t,
b))return b;if("application/bif"===a)return"image";if("application/ttml+xml"===a)return"text";if("application/mp4"===a)return c&&"urn:mpeg:dash:role:2011"===c.schemeIdUri&&f.default(x,c.value)?"text":"metadata"}function k(a){switch(a.substr(0,3)){case "avc":case "hev":case "hvc":case "vp8":case "vp9":case "av1":return"video";case "vtt":return"text";case "bif":return"image"}switch(a.substr(0,4)){case "mp4a":return"audio";case "wvtt":case "stpp":return"text"}}if(null!=a&&(a=h(a,e),null!=a))return a;
if(null!=b&&(b=k(b),null!=b))return b;for(b=0;b<c.length;b++)if(a=c[b],null!=a&&(a=h(a,e),null!=a))return a;for(b=0;b<d.length;b++)if(c=d[b],null!=c&&(a=k(c),null!=a))return a;return"unknown"}Object.defineProperty(b,"__esModule",{value:!0});var l=a(3),f=a(14),k=a(20),c=a(34),d=a(1),h=a(19),n=a(9),m=a(272),p=a(273),u=a(274),q=a(275),r=a(276),t=["audio","video","text","image"],x=["subtitle","caption"],v=function(a){if(a&&(a=(a.representations||[]).map(function(a){a=a.index.getLastPosition();return null!=
a?a-10:void 0}),!a.some(function(a){return null==a})&&(a=Math.min.apply(Math,a),!isNaN(a))))return a};b.default=function(a,b){a=r.createMPDIntermediateRepresentation(a);var f=a.children,e=a.attributes,t=h.resolveURL(h.normalizeBaseURL(b),f.baseURL),x=[];a=function(a){var b=f.periods[a],l=h.resolveURL(t,b.children.baseURL),r=void 0;null==b.attributes.id?(d.default.warn("DASH: No usable id found in the Period. Generating one."),r="gen-dash-period-"+k.default()):r=b.attributes.id;if(null!=b.attributes.start)var v=
b.attributes.start;else if(0===a)v="static"===e.type||null==e.availabilityStartTime?0:e.availabilityStartTime;else{var w=x[a-1];if(null!=w.duration)v=w.start+w.duration;else throw Error("Not enough informations on the periods: cannot find start.");}w=void 0;if(null!=b.attributes.duration)w=b.attributes.duration;else{var y=x[a+1];y&&null!=y.start?w=y.start-v:0===a&&e.duration&&!y&&(w=e.duration)}a=b.children.adaptations.map(function(a){var b=h.resolveURL(l,a.children.baseURL),f=a.children;if(null!=
f.segmentBase)var e=new m.default(f.segmentBase,v);else if(null!=f.segmentList)e=new p.default(f.segmentList,v);else if(null!=f.segmentTemplate){var k=f.segmentTemplate;k.presentationTimeOffset=v*k.timescale;e="timeline"===k.indexType?new q.default(k,v):new u.default(k,v)}else e=new u.default({duration:Number.MAX_VALUE,timescale:1,startNumber:0},v);k=a.children.representations.map(function(c){var f=h.resolveURL(b,c.children.baseURL);if(null==c.attributes.bitrate){d.default.warn("DASH: No usable bitrate found in the Representation.");
var k=0}else k=c.attributes.bitrate;if(null!=c.children.segmentBase)var l=new m.default(c.children.segmentBase,v);else null!=c.children.segmentList?l=new p.default(c.children.segmentList,v):null!=c.children.segmentTemplate?(l=c.children.segmentTemplate,l="timeline"===l.indexType?new q.default(l,v):new u.default(l,v)):l=e;f={bitrate:k,index:l,id:null!=c.attributes.id?c.attributes.id:c.attributes.bitrate+(null!=c.attributes.height?"-"+c.attributes.height:"")+(null!=c.attributes.width?"-"+c.attributes.width:
"")+(null!=c.attributes.mimeType?"-"+c.attributes.mimeType:"")+(null!=c.attributes.codecs?"-"+c.attributes.codecs:""),baseURL:f};if(null!=c.attributes.codecs)var g=c.attributes.codecs;else null!=a.attributes.codecs&&(g=a.attributes.codecs);null!=g&&(f.codecs="mp4a.40.02"===g?"mp4a.40.2":g);null!=c.attributes.audioSamplingRate?f.audioSamplingRate=c.attributes.audioSamplingRate:null!=a.attributes.audioSamplingRate&&(f.audioSamplingRate=a.attributes.audioSamplingRate);null!=c.attributes.codingDependency?
...
a.attributes.maxPlayoutRate);null!=c.attributes.maximumSAPPeriod?f.maximumSAPPeriod=c.attributes.maximumSAPPeriod:null!=a.attributes.maximumSAPPeriod&&(f.maximumSAPPeriod=a.attributes.maximumSAPPeriod);null!=c.attributes.mimeType?f.mimeType=c.attributes.mimeType:null!=a.attributes.mimeType&&(f.mimeType=a.attributes.mimeType);null!=c.attributes.profiles?f.profiles=c.attributes.profiles:null!=a.attributes.profiles&&(f.profiles=a.attributes.profiles);null!=c.attributes.qualityRanking&&(f.qualityRanking=
c.attributes.qualityRanking);null!=c.attributes.segmentProfiles?f.segmentProfiles=c.attributes.segmentProfiles:null!=a.attributes.segmentProfiles&&(f.segmentProfiles=a.attributes.segmentProfiles);null!=c.attributes.width?f.width=c.attributes.width:null!=a.attributes.width&&(f.width=a.attributes.width);return f});var t=a.attributes.mimeType,r=a.attributes.codecs,x=k.map(function(a){return a.mimeType}).filter(function(a){return null!=a}),w=k.map(function(a){return a.codecs}).filter(function(a){return null!=
a});t=g(t||null,x,r||null,w,f.role||null);var y,A;"text"===t&&f.accessibility&&n.isHardOfHearing(f.accessibility)&&(y=!0);"audio"===t&&f.accessibility&&n.isVisuallyImpaired(f.accessibility)&&(A=!0);null!=a.attributes.id?f=a.attributes.id:(f=t,a.attributes.language&&(f+="-"+a.attributes.language),y&&(f+="-cc"),A&&(f+="-ad"),a.attributes.contentType&&(f+="-"+a.attributes.contentType),a.attributes.codecs&&(f+="-"+a.attributes.codecs),a.attributes.mimeType&&(f+="-"+a.attributes.mimeType),a.attributes.frameRate&&
(f+="-"+a.attributes.frameRate),f.length===t.length&&(f+=k.length?"-"+k[0].id:"-empty"),f="adaptation-"+f);k={id:f,representations:k,type:t};null!=a.attributes.language&&(k.language=a.attributes.language,k.normalizedLanguage=c.normalize(a.attributes.language));null!=y&&(k.closedCaption=y);null!=A&&(k.audioDescription=A);return k});r={id:r,start:v,duration:w,adaptations:a};null!=b.attributes.bitstreamSwitching&&(r.bitstreamSwitching=b.attributes.bitstreamSwitching);x.push(r)};for(var w=0;w<f.periods.length;w++)a(w);
b={availabilityStartTime:"static"===e.type||null==e.availabilityStartTime?0:e.availabilityStartTime,duration:null==e.duration?Infinity:e.duration,id:null!=e.id?e.id:"gen-dash-manifest-"+k.default(),periods:x,transportType:"dash",type:e.type||"static",uris:[b].concat(f.locations),suggestedPresentationDelay:null!=e.suggestedPresentationDelay?e.suggestedPresentationDelay:l.default.DEFAULT_SUGGESTED_PRESENTATION_DELAY.DASH};null!=e.profiles&&(b.profiles=e.profiles);"static"!==e.type&&null!=e.availabilityEndTime&&
(b.availabilityEndTime=e.availabilityEndTime);null!=e.publishTime&&(b.publishTime=e.publishTime);null!=e.duration&&(b.duration=e.duration);null!=e.minimumUpdatePeriod&&(b.minimumUpdatePeriod=e.minimumUpdatePeriod);null!=e.minBufferTime&&(b.minBufferTime=e.minBufferTime);null!=e.timeShiftBufferDepth&&(b.timeShiftBufferDepth=e.timeShiftBufferDepth);null!=e.maxSegmentDuration&&(b.maxSegmentDuration=e.maxSegmentDuration);null!=e.maxSubsegmentDuration&&(b.maxSubsegmentDuration=e.maxSubsegmentDuration);
"dynamic"===b.type&&(a=b.periods[b.periods.length-1].adaptations.filter(function(a){return"video"===a.type})[0],a=v(a),b.presentationLiveGap=null!=a?Date.now()/1E3-(a+b.availabilityStartTime):10);return b}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(39);e=function(){function a(a,b){null==a.presentationTimeOffset&&(a.presentationTimeOffset=b*a.timescale);this._index=a}a.prototype.getInitSegment=function(){return g.getInitSegment(this._index)};a.prototype.getSegments=function(a,
b){return g.getSegmentsFromTimeline(this._index,a,b)};a.prototype.shouldRefresh=function(){return!1};a.prototype.getFirstPosition=function(){var a=this._index;if(a.timeline.length)return a.timeline[0].ts/a.timescale};a.prototype.getLastPosition=function(){var a=this._index;if(a.timeline.length)return g.getTimelineRangeEnd(a.timeline[a.timeline.length-1])/a.timescale};a.prototype.checkDiscontinuity=function(){return-1};a.prototype._addSegments=function(a){for(var b=0;b<a.length;b++){var c=this._index,
d=a[b];if(d.timescale!==c.timescale){var f=c.timescale;c.timeline.push({ts:d.time/d.timescale*f,d:d.duration/d.timescale*f,r:d.count||0,range:d.range})}else c.timeline.push({ts:d.time,d:d.duration,r:d.count||0,range:d.range})}};a.prototype._update=function(a){this._index=a._index};return a}();b.default=e},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});a(1);var g=a(39);e=function(){function a(a,b){null==a.presentationTimeOffset&&(a.presentationTimeOffset=b*a.timescale);this._index=
a}a.prototype.getInitSegment=function(){return g.getInitSegment(this._index)};a.prototype.getSegments=function(a,b){var c=this._index,d=g.normalizeRange(c,a,b);a=c.duration;b=c.list;c=c.timescale;var f=Math.min(b.length-1,Math.floor(d.to/a)),e=[];for(d=Math.floor(d.up/a);d<=f;)e.push({id:""+d,time:d*a,isInit:!1,range:b[d].mediaRange,duration:a,timescale:c,media:b[d].media}),d++;return e};a.prototype.shouldRefresh=function(a,b,c){b=this._index;a=b.list;var d=b.presentationTimeOffset;c=Math.floor((c*
b.timescale-(void 0===d?0:d))/b.duration);return!(0<=c&&c<a.length)};a.prototype.getFirstPosition=function(){return 0};a.prototype.getLastPosition=function(){var a=this._index;return a.list.length*a.duration/a.timescale};a.prototype.checkDiscontinuity=function(){return-1};a.prototype._update=function(a){this._index=a._index};a.prototype._addSegments=function(){};return a}();b.default=e},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});a(1);var g=a(39);e=function(){function a(a,b){null==
a.presentationTimeOffset&&(a.presentationTimeOffset=b*a.timescale);this._index=a}a.prototype.getInitSegment=function(){return g.getInitSegment(this._index)};a.prototype.getSegments=function(a,b){var c=this._index;a=g.normalizeRange(c,a,b);var d=a.up;a=a.to;if(a<=d)return[];b=c.duration;var f=c.startNumber,e=c.timescale,k=c.media;c=c.presentationTimeOffset;for(var l=[];d<=a;d+=b){var u=Math.floor(d/b)+(null==f?1:f);l.push({id:""+u,number:u,time:(u-(null==f?1:f))*b+(c||0),isInit:!1,duration:b,timescale:e,
media:k})}return l};a.prototype.getFirstPosition=function(){};a.prototype.getLastPosition=function(){};a.prototype.shouldRefresh=function(){return!1};a.prototype.checkDiscontinuity=function(){return-1};a.prototype._addSegments=function(){};a.prototype._update=function(a){this._index=a._index};return a}();b.default=e},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(39);e=function(){function a(a,b){null==a.presentationTimeOffset&&(a.presentationTimeOffset=b*a.timescale);this._index=
a}a.prototype.getInitSegment=function(){return g.getInitSegment(this._index)};a.prototype.getSegments=function(a,b){return g.getSegmentsFromTimeline(this._index,a,b)};a.prototype.shouldRefresh=function(a,b,c){b=this._index;a=b.timeline;var d=b.presentationTimeOffset;c=c*b.timescale-(void 0===d?0:d);a=a[a.length-1];if(!a)return!1;0>a.d&&(a={ts:a.ts,d:0,r:a.r});return!(c<=g.getTimelineRangeEnd(a))};a.prototype.getFirstPosition=function(){var a=this._index;if(a.timeline.length)return a.timeline[0].ts/
a.timescale};a.prototype.getLastPosition=function(){var a=this._index;if(a.timeline.length)return g.getTimelineRangeEnd(a.timeline[a.timeline.length-1])/a.timescale};a.prototype.checkDiscontinuity=function(a){var b=this._index,c=b.timeline;b=b.timescale;b=void 0===b?1:b;a*=b;if(0>=a)return-1;var d=this._index.timeline;var f=0;for(var e=d.length;f<e;){var l=f+e>>>1;d[l].ts<a?f=l+1:e=l}f=0<f?f-1:f;if(0>f||f>=c.length-1)return-1;e=c[f];if(-1===e.d)return-1;d=e.ts;e=g.getTimelineRangeEnd(e);c=c[f+1];
return e!==c.ts&&a>=d&&a<=e&&e-a<b?c.ts/b:-1};a.prototype._update=function(a){this._index=a._index};a.prototype._addSegments=function(a,b){for(var c=0;c<a.length;c++){var d=void 0,f=this._index,e=a[c],k=f.timeline,l=f.timescale,u=k.length,q=k[u-1];e=e.timescale===l?{time:e.time,duration:e.duration}:{time:e.time/e.timescale*l,duration:e.duration/e.timescale*l};b&&b.timescale&&(d=b.timescale===l?b.time:b.time/b.timescale*l);null!=d&&e.time===d?(d=e.time+e.duration,l=d-(q.ts+q.d*q.r),0>=l||(-1===q.d&&
((u=k[u-2])&&u.d===l?(u.r++,k.pop()):q.d=l),f.timeline.push({d:-1,ts:d,r:0}))):e.time>=g.getTimelineRangeEnd(q)&&(q.d===e.duration?q.r++:f.timeline.push({d:e.duration,ts:e.time,r:0}))}};return a}();b.default=e},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(9),l=a(277);b.createMPDIntermediateRepresentation=function(a){for(var b=a.childNodes,c="",d=[],f=[],e=0;e<b.length;e++){var m=b[e];switch(m.nodeName){case "BaseURL":c=m.textContent||"";break;case "Location":d.push(m.textContent||
"");break;case "Period":m=l.createPeriodIntermediateRepresentation(m),f.push(m)}}b={baseURL:c,locations:d,periods:f};c={};for(d=0;d<a.attributes.length;d++)switch(f=a.attributes[d],f.name){case "id":c.id=f.value;break;case "profiles":c.profiles=f.value;break;case "type":c.type=f.value;break;case "availabilityStartTime":c.availabilityStartTime=+g.parseDateTime(f.value);break;case "availabilityEndTime":c.availabilityEndTime=+g.parseDateTime(f.value);break;case "publishTime":c.publishTime=+g.parseDateTime(f.value);
break;case "mediaPresentationDuration":c.duration=g.parseDuration(f.value);break;case "minimumUpdatePeriod":c.minimumUpdatePeriod=g.parseDuration(f.value);break;case "minBufferTime":c.minBufferTime=g.parseDuration(f.value);break;case "timeShiftBufferDepth":c.timeShiftBufferDepth=g.parseDuration(f.value);break;case "suggestedPresentationDelay":c.suggestedPresentationDelay=g.parseDuration(f.value);break;case "maxSegmentDuration":c.maxSegmentDuration=g.parseDuration(f.value);break;case "maxSubsegmentDuration":c.maxSubsegmentDuration=
g.parseDuration(f.value)}return{children:b,attributes:c}}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(1),l=a(9),f=a(278);b.createPeriodIntermediateRepresentation=function(a){for(var c=a.childNodes,b="",e=[],k=0;k<c.length;k++){var m=c[k];switch(m.nodeName){case "BaseURL":b=m.textContent||"";break;case "AdaptationSet":m=f.createAdaptationSetIntermediateRepresentation(m),e.push(m)}}c={baseURL:b,adaptations:e};b={};for(e=0;e<a.attributes.length;e++)switch(k=a.attributes[e],
k.name){case "id":b.id=k.value;break;case "start":m=l.parseDuration(k.value);isNaN(m)?g.default.warn("DASH: Unrecognized start in the mpd:",k.value):b.start=m;break;case "duration":m=l.parseDuration(k.value);isNaN(m)?g.default.warn("DASH: Unrecognized duration in the mpd:",k.value):b.duration=m;break;case "bitstreamSwitching":b.bitstreamSwitching=l.parseBoolean(k.value)}return{children:c,attributes:b}}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(1),l=a(9),f=a(279),k=
a(280),c=a(281),d=a(40),h=a(93),n=a(94);b.createAdaptationSetIntermediateRepresentation=function(a){for(var b=a.childNodes,e={baseURL:"",representations:[]},m=0;m<b.length;m++){var r=b[m];switch(r.nodeName){case "Accessibility":e.accessibility=l.parseScheme(r);break;case "BaseURL":e.baseURL=r.textContent||"";break;case "ContentComponent":e.contentComponent=f.default(r);break;case "Representation":r=c.createRepresentationIntermediateRepresentation(r);e.representations.push(r);break;case "Role":e.role=
l.parseScheme(r);break;case "SegmentBase":e.segmentBase=d.default(r);break;case "SegmentList":e.segmentList=h.default(r);break;case "SegmentTemplate":e.segmentTemplate=n.default(r);break;case "ContentProtection":e.contentProtection=k.default(r)}}b={};for(m=0;m<a.attributes.length;m++)switch(r=a.attributes[m],r.name){case "id":b.id=r.value;break;case "group":var t=parseInt(r.value,10);isNaN(t)?g.default.warn('DASH: invalid group ("'+r.value+'")'):b.group=t;break;case "lang":b.language=r.value;break;
case "contentType":b.contentType=r.value;break;case "par":b.par=r.value;break;case "minBandwidth":t=parseInt(r.value,10);isNaN(t)?g.default.warn('DASH: invalid minBandwidth ("'+r.value+'")'):b.minBitrate=t;break;case "maxBandwidth":t=parseInt(r.value,10);isNaN(t)?g.default.warn('DASH: invalid maxBandwidth ("'+r.value+'")'):b.maxBitrate=t;break;case "minWidth":t=parseInt(r.value,10);isNaN(t)?g.default.warn('DASH: invalid minWidth ("'+r.value+'")'):b.minWidth=t;break;case "maxWidth":t=parseInt(r.value,
10);isNaN(t)?g.default.warn('DASH: invalid maxWidth ("'+r.value+'")'):b.maxWidth=t;break;case "minHeight":t=parseInt(r.value,10);isNaN(t)?g.default.warn('DASH: invalid minHeight ("'+r.value+'")'):b.minHeight=t;break;case "maxHeight":t=parseInt(r.value,10);isNaN(t)?g.default.warn('DASH: invalid maxHeight ("'+r.value+'")'):b.maxHeight=t;break;case "minFrameRate":t=l.parseFrameRate(r.value);isNaN(t)?g.default.warn('DASH: invalid minFrameRate ("'+r.value+'")'):b.minFrameRate=t;break;case "maxFrameRate":t=
l.parseFrameRate(r.value);isNaN(t)?g.default.warn('DASH: invalid maxFrameRate ("'+r.value+'")'):b.maxFrameRate=t;break;case "segmentAlignment":t=l.parseIntOrBoolean(r.value);"number"===typeof t&&isNaN(t)?g.default.warn('DASH: invalid segmentAlignment ("'+r.value+'")'):b.segmentAlignment=t;break;case "subsegmentAlignment":t=l.parseIntOrBoolean(r.value);"number"===typeof t&&isNaN(t)?g.default.warn('DASH: invalid subsegmentAlignment ("'+r.value+'")'):b.subsegmentAlignment=t;break;case "bitstreamSwitching":b.bitstreamSwitching=
l.parseBoolean(r.value);break;case "audioSamplingRate":b.audioSamplingRate=r.value;break;case "codecs":b.codecs=r.value;break;case "codingDependency":b.codingDependency=l.parseBoolean(r.value);break;case "frameRate":t=l.parseFrameRate(r.value);isNaN(t)?g.default.warn('DASH: invalid frameRate ("'+r.value+'")'):b.frameRate=t;break;case "height":t=parseInt(r.value,10);isNaN(t)?g.default.warn('DASH: invalid height ("'+r.value+'")'):b.height=t;break;case "maxPlayoutRate":t=parseFloat(r.value);isNaN(t)?
g.default.warn('DASH: invalid maxPlayoutRate ("'+r.value+'")'):b.maxPlayoutRate=t;break;case "maximumSAPPeriod":t=parseFloat(r.value);isNaN(t)?g.default.warn('DASH: invalid maximumSAPPeriod ("'+r.value+'")'):b.maximumSAPPeriod=t;break;case "mimeType":b.mimeType=r.value;break;case "profiles":b.profiles=r.value;break;case "segmentProfiles":b.segmentProfiles=r.value;break;case "width":t=parseInt(r.value,10),isNaN(t)?g.default.warn('DASH: invalid width ("'+r.value+'")'):b.width=t}return{children:e,attributes:b}}},
function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(9);b.default=function(a){for(var b={},e=0;e<a.attributes.length;e++){var c=a.attributes[e];switch(c.name){case "id":b.id=c.value;break;case "lang":b.language=c.value;break;case "contentType":b.contentType=c.value;break;case "par":b.par=g.parseRatio(c.value)}}return b}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(9);b.default=function(a){return g.parseScheme(a)}},function(e,b,a){Object.defineProperty(b,
"__esModule",{value:!0});var g=a(1),l=a(9),f=a(40),k=a(93),c=a(94);b.createRepresentationIntermediateRepresentation=function(a){for(var b=a.childNodes,d={baseURL:""},e=0;e<b.length;e++){var p=b[e];switch(p.nodeName){case "BaseURL":d.baseURL=p.textContent||"";break;case "SegmentBase":d.segmentBase=f.default(p);break;case "SegmentList":d.segmentList=k.default(p);break;case "SegmentTemplate":d.segmentTemplate=c.default(p)}}b={};for(e=0;e<a.attributes.length;e++)switch(p=a.attributes[e],p.name){case "audioSamplingRate":b.audioSamplingRate=
p.value;break;case "bandwidth":var u=parseInt(p.value,10);isNaN(u)?g.default.warn('DASH: invalid bandwidth ("'+p.value+'")'):b.bitrate=u;break;case "codecs":b.codecs=p.value;break;case "codingDependency":b.codingDependency=l.parseBoolean(p.value);break;case "frameRate":u=l.parseFrameRate(p.value);isNaN(u)?g.default.warn('DASH: invalid frameRate ("'+p.value+'")'):b.frameRate=u;break;case "height":u=parseInt(p.value,10);isNaN(u)?g.default.warn('DASH: invalid height ("'+p.value+'")'):b.height=u;break;
case "id":b.id=p.value;break;case "maxPlayoutRate":u=parseFloat(p.value);isNaN(u)?g.default.warn('DASH: invalid maxPlayoutRate ("'+p.value+'")'):b.maxPlayoutRate=u;break;case "maximumSAPPeriod":u=parseFloat(p.value);isNaN(u)?g.default.warn('DASH: invalid maximumSAPPeriod ("'+p.value+'")'):b.maximumSAPPeriod=u;break;case "mimeType":b.mimeType=p.value;break;case "profiles":b.profiles=p.value;break;case "qualityRanking":u=parseInt(p.value,10);isNaN(u)?g.default.warn('DASH: invalid qualityRanking ("'+
p.value+'")'):b.qualityRanking=u;break;case "segmentProfiles":b.segmentProfiles=p.value;break;case "width":u=parseInt(p.value,10),isNaN(u)?g.default.warn('DASH: invalid width ("'+p.value+'")'):b.width=u}return{children:d,attributes:b}}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(1),l=a(9);b.default=function(a){for(var b={},c=0;c<a.attributes.length;c++){var d=a.attributes[c];switch(d.name){case "range":var f=l.parseByteRange(d.value)||void 0;f?b.range=f:g.default.warn('DASH: invalid range ("'+
d.value+'")');break;case "sourceURL":b.media=d.value}}return b}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(1),l=a(9);b.default=function(a){for(var b={},c=0;c<a.attributes.length;c++){var d=a.attributes[c];switch(d.name){case "media":b.media=d.value;break;case "indexRange":var f=l.parseByteRange(d.value)||void 0;f?b.indexRange=f:g.default.warn('DASH: invalid indexRange ("'+d.value+'")');break;case "index":b.index=d.value;break;case "mediaRange":(f=l.parseByteRange(d.value)||
void 0)?b.mediaRange=f:g.default.warn('DASH: invalid mediaRange ("'+d.value+'")')}}return b}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(285);b.default=function(a){var b=[];a=a.childNodes;for(var e=0;e<a.length;e++){var c=a[e];switch(c.nodeName){case "S":(c=g.default(c,b[b.length-1]||null))&&b.push(c)}}return b}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(1);b.default=function(a,b){for(var f,c,d,e=0;e<a.attributes.length;e++){var l=a.attributes[e];
switch(l.name){case "t":f=parseInt(l.value,10);break;case "d":c=parseInt(l.value,10);break;case "r":d=parseInt(l.value,10)}}null==f&&b&&null!=b.d&&(f=b.ts+b.d*(b.r+1));if(null==f||isNaN(f)||null!=c&&isNaN(c)||null!=d&&isNaN(d))g.default.warn('DASH: A "S" Node could not have been parsed.');else return{ts:f,d:c,r:d||0}}},function(e,b,a){function g(a){var b=a.url;a=a.segment;var d=a.range;a=a.indexRange;if(d&&a&&d[1]===a[0]-1)return k.default({url:b,responseType:"arraybuffer",headers:{Range:c.byteRange([d[0],
a[1]])}});d=d?{Range:c.byteRange(d)}:null;d=k.default({url:b,responseType:"arraybuffer",headers:d});return a?(b=k.default({url:b,responseType:"arraybuffer",headers:{Range:c.byteRange(a)}}),l.Observable.merge(d,b)):d}Object.defineProperty(b,"__esModule",{value:!0});var l=a(0),f=a(19),k=a(27),c=a(56);b.default=function(a){return function(b){var d=b.adaptation,e=b.manifest,h=b.period,k=b.representation;b=b.segment;var q=b.media,r=b.range,t=b.indexRange;if(b.isInit&&!(q||r||t))return l.Observable.empty();
q=q?c.replaceTokens(q,b,k):"";q=f.resolveURL(k.baseURL,q);var x={adaptation:d,manifest:e,period:h,representation:k,segment:b,transport:"dash",url:q};return a?l.Observable.create(function(c){var b=!1,d=!1,f=a(x,{reject:function(a){void 0===a&&(a={});d||(b=!0,c.error(a))},resolve:function(a){d||(b=!0,c.next({type:"response",value:{responseData:a.data,size:a.size,duration:a.duration}}),c.complete())},fallback:function(){d=!0;g(x).subscribe(c)}});return function(){b||d||"function"!==typeof f||f()}}):
g(x)}}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(5),l=a(0),f=a(4),k=a(89),c=a(19),d=a(33),h=a(27),n=a(92),m=a(56);b.loader=function(a){var b=a.segment,d=a.representation,f=b.media,e=b.range;a=b.indexRange;var k=b.isInit,g=m.isMP4EmbeddedTrack(d)?"arraybuffer":"text";if(k&&!(f||e||a))return l.Observable.empty();b=f?m.replaceTokens(f,b,d):"";b=c.resolveURL(d.baseURL,b);if(e&&a&&e[1]===a[0]-1)return h.default({url:b,responseType:g,headers:{Range:m.byteRange([e[0],a[1]])}});
e=h.default({url:b,responseType:g,headers:e?{Range:m.byteRange(e)}:null});return a?(a=h.default({url:b,responseType:g,headers:{Range:m.byteRange(a)}}),l.Observable.merge(e,a)):e};b.parser=function(a){var c=a.response,b=a.segment,e=a.representation,h=a.init,p=a.adaptation.language,v=b.isInit,w=b.indexRange,y;(a=m.isMP4EmbeddedTrack(e))?(f.default(c.responseData instanceof ArrayBuffer),c=new Uint8Array(c.responseData),(w=d.parseSidx(c,w?w[0]:0))&&(y=w),b=v?{time:-1,duration:0,timescale:b.timescale}:
n.default(b,c,w,h)):(f.default("string"===typeof c.responseData),c=c.responseData,b=v?{time:-1,duration:0,timescale:b.timescale}:{time:b.time||0,duration:b.duration,timescale:b.timescale});if(v)a&&(c=d.getMDHDTimescale(c),0<c&&(b={time:-1,duration:0,timescale:c})),c=void 0;else if(f.default(null!=b),h={start:b.time,end:b.time+(b.duration||0),language:p,timescale:b.timescale,timeOffset:0},a){p=e.codec;a=void 0;switch((void 0===p?"":p).toLowerCase()){case "stpp":a="ttml";break;case "wvtt":a="vtt"}if(!a)throw Error("The codec used for the subtitle is not managed yet.");
c=g({data:k.stringFromUTF8(d.getMDAT(c)),type:a},{timescale:1},h)}else{a=void 0;p=e.mimeType;p=void 0===p?"":p;switch(e.mimeType){case "application/ttml+xml":a="ttml";break;case "application/x-sami":case "application/smil":a="sami";break;case "text/vtt":a="vtt"}if(!a)if(a=e.codec,"srt"===(void 0===a?"":a).toLowerCase())a="srt";else throw Error("could not find a text-track parser for the type "+p);c=g({data:c,type:a},{timescale:1},h)}y&&m.addNextSegments(e,y,b);return l.Observable.of({segmentData:c,
segmentInfos:b})}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});e=a(289);b.InMemorySessionsSet=e.default;a=a(290);b.PersistedSessionsSet=a.default},function(e,b,a){var g=this&&this.__extends||function(){var a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(a,c){a.__proto__=c}||function(a,c){for(var b in c)c.hasOwnProperty(b)&&(a[b]=c[b])};return function(c,b){function d(){this.constructor=c}a(c,b);c.prototype=null===b?Object.create(b):(d.prototype=b.prototype,new d)}}();
Object.defineProperty(b,"__esModule",{value:!0});var l=a(0),f=a(13),k=a(1);e=a(95);var c=a(96);a=function(a){function b(){return null!==a&&a.apply(this,arguments)||this}g(b,a);b.prototype.getFirst=function(){if(0<this._entries.length)return this._entries[0].session};b.prototype.find=function(a){for(var c=0;c<this._entries.length;c++)if(a(this._entries[c]))return this._entries[c];return null};b.prototype.get=function(a){var b=c.default(a);return(a=this.find(function(a){return a.initData===b}))?a.session:
null};b.prototype.add=function(a,b,d){a=c.default(a);var f=this.get(a);f&&this.deleteAndClose(f);d=d.connect();b={session:b,initData:a,eventSubscription:d};k.default.debug("eme-mem-store: add session",b);this._entries.push(b)};b.prototype.deleteById=function(a){var c=this.find(function(c){return c.session.sessionId===a});return c?this.delete(c.session):null};b.prototype.delete=function(a){var c=this.find(function(c){return c.session===a});if(!c)return null;var b=c.session,d=c.eventSubscription;k.default.debug("eme-mem-store: delete session",
c);c=this._entries.indexOf(c);this._entries.splice(c,1);d.unsubscribe();return b};b.prototype.deleteAndClose=function(a){return(a=this.delete(a))?(k.default.debug("eme-mem-store: close session",a),f.default(a.close()).catch(function(){return l.Observable.of(null)})):l.Observable.of(null)};b.prototype.dispose=function(){var a=this,c=this._entries.map(function(c){return a.deleteAndClose(c.session)});this._entries=[];return l.Observable.merge.apply(l.Observable,c)};return b}(e.default);b.default=a},
function(e,b,a){function g(a){f.default(null!=a,"no licenseStorage given for keySystem with persistentLicense");f.assertInterface(a,{save:"function",load:"function"},"licenseStorage")}var l=this&&this.__extends||function(){var a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(a,c){a.__proto__=c}||function(a,c){for(var b in c)c.hasOwnProperty(b)&&(a[b]=c[b])};return function(c,b){function d(){this.constructor=c}a(c,b);c.prototype=null===b?Object.create(b):(d.prototype=b.prototype,new d)}}();
Object.defineProperty(b,"__esModule",{value:!0});var f=a(4),k=a(1);e=a(95);var c=a(96);a=function(a){function b(c){var b=a.call(this)||this;g(c);b._storage=c;b._loadStorage();return b}l(b,a);b.prototype.setStorage=function(a){this._storage!==a&&(g(a),this._storage=a,this._loadStorage())};b.prototype.get=function(a){var b=c.default(a);return this.find(function(a){return a.initData===b})||null};b.prototype.add=function(a,b){var d=b&&b.sessionId;if(d){a=c.default(a);var f=this.get(a);f&&f.sessionId===
d||(f&&this.delete(a),k.default.info("eme-persitent-store: add new session",d,b),this._entries.push({sessionId:d,initData:a}),this._save())}};b.prototype.delete=function(a){var b=c.default(a);if(a=this.find(function(a){return a.initData===b}))k.default.warn("eme-persitent-store: delete session from store",a),a=this._entries.indexOf(a),this._entries.splice(a,1),this._save()};b.prototype.dispose=function(){this._entries=[];this._save()};b.prototype._save=function(){try{this._storage.save(this._entries)}catch(n){k.default.warn("eme-persitent-store: could not save licenses in localStorage")}};
b.prototype._loadStorage=function(){try{this._entries=this._storage.load(),f.default(Array.isArray(this._entries))}catch(n){k.default.warn("eme-persitent-store: could not get entries from license storage",n),this.dispose()}};return b}(e.default);b.default=a},function(e,b,a){function g(a,c){var b=c.$keySystem,f=c.$mediaKeys,e=c.$mediaKeySystemConfiguration;if(!b||!f||d.shouldRenewMediaKeys())return null;if(e)return(a=a.filter(function(a){return a.type!==b.type||a.persistentLicense&&"required"!==e.persistentState||
a.distinctiveIdentifierRequired&&"required"!==e.distinctiveIdentifier?!1:!0})[0])?{keySystem:a,keySystemAccess:new d.KeySystemAccess(b.type,f,e)}:null}function l(a){for(var c=0,b=Object.keys(u);c<b.length;c++){var d=b[c];if(h.default(u[d],a))return d}}function f(a,c){var b=["temporary"],d="optional",f="optional";c.persistentLicense&&(d="required",b.push("persistent-license"));c.persistentStateRequired&&(d="required");c.distinctiveIdentifierRequired&&(f="required");var e=c.videoRobustnesses||("widevine"===
a?p:[]);a=c.audioRobustnesses||("widevine"===a?p:[]);e.length||e.push(void 0);a.length||a.push(void 0);e=e.map(function(a){return{contentType:'video/mp4;codecs="avc1.4d401e"',robustness:a}});a=a.map(function(a){return{contentType:'audio/mp4;codecs="mp4a.40.2"',robustness:a}});return[{initDataTypes:["cenc"],videoCapabilities:e,audioCapabilities:a,distinctiveIdentifier:f,persistentState:d,sessionTypes:b}]}function k(a,b){if(b=g(a,b))return n.default.debug("eme: found compatible keySystem quickly",b),
c.Observable.of(b);var e=a.reduce(function(a,c){var b=u[c.type]?u[c.type].map(function(a){return{keyName:c.type,keyType:a,keySystem:c}}):[{keyName:l(c.type)||"",keyType:c.type,keySystem:c}];return a.concat(b)},[]);return c.Observable.create(function(a){function c(k){if(!b)if(k>=e.length)a.error(new m.EncryptedMediaError("INCOMPATIBLE_KEYSYSTEMS",null,!0));else{var l=e[k],g=l.keyType,p=l.keySystem,q=f(l.keyName,p);n.default.debug("eme: request keysystem access "+g+","+(k+1+" of "+e.length),q);if(null==
d.requestMediaKeySystemAccess)throw Error("requestMediaKeySystemAccess is not implemented in your browser.");h=d.requestMediaKeySystemAccess(g,q).subscribe(function(c){n.default.info("eme: found compatible keysystem",g,q);a.next({keySystem:p,keySystemAccess:c});a.complete()},function(){n.default.debug("eme: rejected access to keysystem",g,q);h=null;c(k+1)})}}var b=!1,h;c(0);return function(){b=!0;h&&h.unsubscribe()}})}Object.defineProperty(b,"__esModule",{value:!0});var c=a(0),d=a(7);e=a(3);var h=
a(14),n=a(1),m=a(8),p=e.default.EME_DEFAULT_WIDEVINE_ROBUSTNESSES,u=e.default.EME_KEY_SYSTEMS;b.findCompatibleKeySystem=k;b.getKeySystem=function(a){return a.$keySystem&&a.$keySystem.type};b.default=k},function(e,b,a){function g(a,b){return l.Observable.defer(function(){return k.default(a.setServerCertificate(b)).ignoreElements().catch(function(a){throw new f.default("LICENSE_SERVER_CERTIFICATE_ERROR",a,!0);})})}Object.defineProperty(b,"__esModule",{value:!0});var l=a(0),f=a(87),k=a(13);b.setServerCertificate=
g;b.trySettingServerCertificate=function(a,b,f){return g(a,b).catch(function(a){a.fatal=!1;f.next(a);return l.Observable.empty()})};b.default=g},function(e,b,a){function g(a,c,b){return{type:"ISessionEvent",value:h({name:a,session:c},b)}}function l(a,c,b){function d(a,c){return p.isKnownError(a)&&a.type===p.ErrorTypes.ENCRYPTED_MEDIA_ERROR?(a.fatal=c,a):new p.EncryptedMediaError("KEY_LOAD_ERROR",a,c)}r.default.debug("eme: handle message events",a);var f={totalRetry:2,retryDelay:200,errorSelector:function(a){return d(a,
!0)},onRetry:function(a){return b.next(d(a,!1))}},e=w.onKeyError$(a).map(function(a){throw new p.EncryptedMediaError("KEY_ERROR",a,!0);}),h=w.onKeyStatusesChange$(a).mergeMap(function(b){r.default.debug("eme: keystatuseschange event",a,b);a.keyStatuses.forEach(function(a,c){if(y.KEY_STATUS_ERRORS[c])throw new p.EncryptedMediaError("KEY_STATUS_CHANGE_ERROR",c,!0);if(y.KEY_STATUS_ERRORS[a])throw new p.EncryptedMediaError("KEY_STATUS_CHANGE_ERROR",a,!0);});return v.default(function(){return c&&c.onKeyStatusesChange?
q.default(c.onKeyStatusesChange(b,a)):n.Observable.empty()}).catch(function(a){throw new p.EncryptedMediaError("KEY_STATUS_CHANGE_ERROR",a,!0);})}),k=w.onKeyMessage$(a).mergeMap(function(b){var d=new Uint8Array(b.message),e=b.messageType||"license-request";r.default.debug("eme: event message type "+e,a,b);b=n.Observable.defer(function(){var a=c.getLicense(d,e);return q.default(a).timeout(1E4).catch(function(a){if(a instanceof m.TimeoutError)throw new p.EncryptedMediaError("KEY_LOAD_TIMEOUT",null,
!1);throw a;})});return x.retryObsWithBackoff(b,f)});h=n.Observable.merge(k,h).concatMap(function(c){r.default.debug("eme: update session",c);var b=g("session-update",a,{updatedWith:c});return q.default(a.update(c)).catch(function(a){throw new p.EncryptedMediaError("KEY_UPDATE_ERROR",a,!0);}).mapTo(b)});e=n.Observable.merge(h,e);return a.closed?e.takeUntil(q.default(a.closed)):e}function f(a,c,b,d,f){r.default.debug("eme: create a new "+c+" session");if(null==a.createSession)throw Error("Invalid MediaKeys implementation: Missing createSession");
...
k,{initData:e,initDataType:d}));return n.Observable.merge(a,d)}function c(a,c,b,d,f,e){return k(a,c,b,d,f,e).catch(function(h){if(h.code!==p.ErrorCodes.KEY_GENERATE_REQUEST_ERROR)throw h;var l=z.$loadedSessions.getFirst();if(!l)throw h;r.default.warn("eme: could not create a new session, retry after closing a currently loaded session",h);return z.$loadedSessions.deleteAndClose(l).mergeMap(function(){return k(a,c,b,d,f,e)})})}function d(a,b,d,e,h,k){r.default.debug("eme: load persisted session",d);
...
"__esModule",{value:!0});var g=a(0),l=a(6),f=a(3),k=a(1),c=a(297),d=a(298),h=a(18),n=a(8),m=a(299),p=a(101),u=a(57),q=a(315),r=a(60),t=a(353),x=a(356),v=a(357),w=a(358),y=a(359),z=a(360),B=a(361),A=a(110),C=a(362);b.SegmentBookkeeper=C.default;var D=a(111),H=a(112),F=a(41),E=a(113);b.default=function(a){function b(a,c){v.setDurationToMediaSource(a,c.getDuration());k.default.debug("calculating initial time");var b=z.default(c,Q);k.default.debug("initial time calculated:",b);var d=c.getPeriodForTime(b);
...
function(a){if(!this._choosers[a]){var b=this._choosers;var c=this._chooserInstanceOptions;c=new l.default({limitWidth$:c.limitWidth[a],throttle$:c.throttle[a],initialBitrate:c.initialBitrates[a],manualBitrate:c.manualBitrates[a],maxAutoBitrate:c.maxAutoBitrates[a]});b[a]=c}};return a}();b.default=e},function(e,b,a){function g(a,c){a=u.default(a,c)||a[0];return k.Observable.of({bitrate:void 0,representation:a})}Object.defineProperty(b,"__esModule",{value:!0});var l=a(5),f=a(84),k=a(0),c=a(6);e=a(3);
var d=a(1),h=a(301),n=a(99),m=a(302),p=a(303),u=a(304),q=e.default.ABR_STARVATION_GAP,r=e.default.OUT_OF_STARVATION_GAP,t=e.default.ABR_STARVATION_FACTOR,x=e.default.ABR_REGULAR_FACTOR;a=function(){function a(a){this._dispose$=new c.Subject;this.manualBitrate$=new f.BehaviorSubject(null!=a.manualBitrate?a.manualBitrate:-1);this.maxAutoBitrate$=new f.BehaviorSubject(null!=a.maxAutoBitrate?a.maxAutoBitrate:Infinity);this.estimator=new h.default;this._currentRequests={};this._initialBitrate=a.initialBitrate||
0;this._limitWidth$=a.limitWidth$;this._throttle$=a.throttle$}a.prototype.get$=function(a,c){var b=this;if(2>c.length)return k.Observable.of({bitrate:void 0,representation:c.length?c[0]:null}).takeUntil(this._dispose$);var d=this.manualBitrate$,f=this.maxAutoBitrate$,e=this._initialBitrate,h=[];this._limitWidth$&&h.push(this._limitWidth$.map(function(a){return{width:a}}));this._throttle$&&h.push(this._throttle$.map(function(a){return{bitrate:a}}));var v=h.length?k.Observable.combineLatest.apply(k.Observable,
h).map(function(a){return l.apply(void 0,[{}].concat(a))}):k.Observable.of({}),w;return d.switchMap(function(d){if(0<=d)return g(c,d);var h=!1;return k.Observable.combineLatest(a,f,v).map(function(a){var d=a[0],f=a[1];a=a[2];var k=d.bufferGap;k<=q?h=!0:h&&k>=r&&(h=!1);if(h){var l=d.bitrate;a:{var g=b._currentRequests;k+=d.position;for(var v=Object.keys(g),y=v.length,A=0;A<y-1;A++){var C=g[v[A]];if(Math.abs(k-C.time)<C.duration){k=C;break a}}k=void 0}if(k&&(v=k.duration,g=k.requestTimestamp,g=(Date.now()-
g)/1E3,v&&g>1.2*v+1)){var z=k;if(2<=z.progress.length){var B=new n.default(2);k=z.progress;for(v=1;v<k.length;v++)y=k[v].timestamp-k[v-1].timestamp,B.addSample(y/1E3,8*(k[v].size-k[v-1].size)/(y/1E3));B=B.getEstimate()}!B&&l&&(B=z.duration*l/(5*g/4));z=B;if(null!=z){b.resetEstimate();var D=null!=l?Math.min(z,l,f):Math.min(z,f)}}}null==D&&(z=b.estimator.getEstimate(),D=Math.min(null!=z?h?z*t:z*x:null!=w?h?w*t:w*x:e,f));1<d.speed&&(D/=d.speed);d=c;null!=a.bitrate&&(d=m.default(d,a.bitrate));null!=a.width&&
(d=p.default(d,a.width));return{bitrate:z,representation:u.default(d,D)||c[0]}}).do(function(a){a=a.bitrate;null!=a&&(w=a)}).share()})};a.prototype.addEstimate=function(a,c){null!=a&&null!=c&&this.estimator.addSample(a,c)};a.prototype.resetEstimate=function(){this.estimator.reset()};a.prototype.addPendingRequest=function(a,c){this._currentRequests[a]?d.default.warn("ABR: request already added."):(c=c.value,this._currentRequests[a]={time:c.time,duration:c.duration,requestTimestamp:c.requestTimestamp,
...
c){return(a.width||0)-(c.width||0)});if(f=g(f,function(a){return(a.width||0)>=b})){var c=f.width||0;return a.filter(function(a){return(a.width||0)<=c})}return a}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(100);b.default=function(a,b){var f=g(a,function(a){return a.bitrate>b});return-1===f?a[a.length-1]:a[f-1]}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(0);b.default=function(a,b,e){var c=e.period;return g.Observable.combineLatest(a,b).filter(function(a){var b=
a[0];a=a[1];return null!=c.end&&b.currentTime+a>=c.end}).map(function(){return{type:"full-buffer",value:void 0}})}},function(e,b,a){function g(a,c){var b=a.manifest;a=a.representation;return c.stalled&&b.isLive?a.index.checkDiscontinuity(c.currentTime):-1}function l(a,c,b){a=a.representation;var d=b.start;b=b.end;c=c.inventory.map(function(a){return a.infos.segment});return a.index.shouldRefresh(c,d,b)}Object.defineProperty(b,"__esModule",{value:!0});var f=a(5),k=a(0),c=a(38),d=a(1),h=a(307),n=a(308),
m=a(310),p=a(311),u=a(312),q=a(313),r=a(314);b.default=function(a){var b=a.clock$,e=a.content,t=a.queuedSourceBuffer,y=a.segmentBookkeeper,z=a.segmentFetcher;a=a.wantedBufferAhead$;var B=e.manifest,A=e.period,C=e.adaptation,D=e.representation,H=m.default(C),F=null,E=new c.ReplaySubject(1),G=[],I=null,P=new h.default;a=k.Observable.combineLatest(b,a).map(function(a){var c=a[0],b=a[1];a=t.getBuffered();var d=q.default(A,a,c,b,H);b=g(e,c);var f=l(e,y,d);y.synchronizeBuffered(a);a=u.default(D,d,{addInitSegment:null==
F,ignoreRegularSegments:0===c.readyState}).filter(function(a){return r.default(a,e,y,d,P)}).map(function(a){return{priority:p.default(a,c),segment:a}});return{discontinuity:b,shouldRefreshManifest:f,state:a.length?{type:"need-segments",value:{neededSegments:a}}:null!=A.end&&d.end>=A.end?{type:"full-buffer",value:void 0}:{type:"idle-buffer",value:void 0}}}).mergeMap(function(a){var c=a.discontinuity,b=a.state,f=a.shouldRefreshManifest;a=[];1<c&&a.push({type:"discontinuity-encountered",value:{nextTime:c+
1}});f&&a.push({type:"needs-manifest-refresh",value:void 0});"need-segments"===b.type&&b.value.neededSegments.length?(c=b.value.neededSegments,b=c[0],I?I.segment.id!==b.segment.id?(d.default.debug("canceling old downloading queue and starting a new one",C.type),G=c,E.next(void 0)):I.priority!==b.priority?(d.default.debug("updating pending request priority",C.type),z.updatePriority(I.request$,b.priority)):(d.default.debug("updating downloading queue",C.type),G=c.slice().splice(1,c.length)):(d.default.debug("starting downloading queue",
C.type),G=c,E.next(void 0)),c={type:"active-buffer",value:void 0}):(I&&d.default.debug("interrupting segment request."),G=[],E.next(void 0),c="full-buffer"===b.type?b:{type:"idle-buffer",value:void 0});return"idle-buffer"===c.type?k.Observable.of.apply(k.Observable,a):k.Observable.of.apply(k.Observable,a).concat(k.Observable.of(c))});var U=E.switchMap(function(){var a=k.Observable.defer(function(){var c=G.shift();if(null==c)return I=null,k.Observable.empty();var b=c.segment;c=c.priority;var d=z.createRequest({adaptation:C,
init:F&&F.segmentInfos||void 0,manifest:B,period:A,representation:D,segment:b},c);I={segment:b,priority:c,request$:d};return d.map(function(a){return f({segment:b},a)}).mergeMap(function(c){return k.Observable.of(c).concat(a)})});return a.finally(function(){I=null})}).mergeMap(function(a){return k.Observable.defer(function(){var c=a.segment,d=a.parsed.segmentInfos,f=a.parsed.segmentData;c.isInit&&(F={segmentData:f,segmentInfos:d});var e=n.default(b,t,F&&F.segmentData,c,f);P.add(c.id);return e.mapTo({type:"added-segment",
...
a.prototype.isEmpty=function(){return!Object.keys(this._hashes).length};return a}();b.default=e},function(e,b,a){function g(a,b,f,e){return f.isInit?null==b?l.Observable.of(void 0):a.appendBuffer(b,null):null==e?l.Observable.of(void 0):a.appendBuffer(b,e)}Object.defineProperty(b,"__esModule",{value:!0});var l=a(0),f=a(8),k=a(309);b.default=function(a,b,e,l,m){var c=g(b,e,l,m);return c.catch(function(d){if(!d||"QuotaExceededError"!==d.name)throw new f.MediaError("BUFFER_APPEND_ERROR",d,!0);return k.default(a,
b).mergeMapTo(c).catch(function(a){throw new f.MediaError("BUFFER_FULL_ERROR",a,!0);})})}},function(e,b,a){function g(a,c,b){var d=k.getInnerAndOuterTimeRanges(c,a);c=d.innerRange;d=d.outerRanges;for(var e=[],h=0;h<d.length;h++){var g=d[h];a-b<g.end?e.push(g):a+b>g.start&&e.push(g)}c&&(f.default.debug("buffer: gc removing part of inner range",e),a-b>c.start&&e.push({start:c.start,end:a-b}),a+b<c.end&&e.push({start:a+b,end:c.end}));return e}Object.defineProperty(b,"__esModule",{value:!0});var l=a(0);
...
function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});e=a(316);b.createManifestPipeline=e.default;a=a(322);b.SegmentPipelinesManager=a.default},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(317),l=a(105);b.default=function(a,b,c,d,e){void 0===d&&(d=[]);void 0===e&&(e=[]);return function(f){return l.default(a.manifest,b)({url:f}).do(function(a){"error"===a.type&&c.next(a.value)}).filter(function(a){return"data"===a.type||"cache"===a.type}).map(function(a){return g.default(a.value.parsed.manifest,
...
2===h?p:e;h!==r&&(q=0,r=h);if(++q>m)throw a;u&&u(a,q);a=k.getFuzzedDelay(Math.min(c*Math.pow(2,q-1),d));return g.Observable.timer(a).mergeMap(function(){return b})})}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(323),l=a(324),f=a(325);e=function(){function a(a,b,f,e){this._transport=a;this._metrics$=f;this._requestsInfos$=b;this._warning$=e;this._prioritizer=new l.default}a.prototype.createPipeline=function(a,b){a=f.default(a,this._transport,this._metrics$,this._requestsInfos$,
...
this.buffered.insert(a.start/d,null==b?Number.MAX_VALUE:b/d)};b.prototype._remove=function(){};b.prototype._abort=function(){};return b}(a(61).default);b.default=e},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});a(4);var g=a(17);e=function(){function a(){this._ranges=[];this.length=0}a.prototype.insert=function(a,b){g.insertInto(this._ranges,{start:a,end:b});this.length=this._ranges.length};a.prototype.remove=function(a,b){var c=[];0<a&&c.push({start:0,end:a});Infinity>b&&c.push({start:b,
end:Infinity});g.keepRangeIntersection(this._ranges,c);this.length=this._ranges.length};a.prototype.start=function(a){if(a>=this._ranges.length)throw Error("INDEX_SIZE_ERROR");return this._ranges[a].start};a.prototype.end=function(a){if(a>=this._ranges.length)throw Error("INDEX_SIZE_ERROR");return this._ranges[a].end};return a}();b.default=e},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(0),l=a(6),f=a(1),k;(function(a){a[a.Append=0]="Append";a[a.Remove=1]="Remove"})(k||
(k={}));e=function(){function a(a){this._buffer=a;this._queue=[];this._lastInitSegment=this._flushing=null;this.__onUpdate=this._onUpdate.bind(this);this.__onError=this._onError.bind(this);this.__flush=this._flush.bind(this);this._buffer.addEventListener("update",this.__onUpdate);this._buffer.addEventListener("error",this.__onError);this._buffer.addEventListener("updateend",this.__flush)}a.prototype.appendBuffer=function(a,b){var c=this;return g.Observable.defer(function(){return c._queueAction({type:k.Append,
segment:b,initSegment:a})})};a.prototype.removeBuffer=function(a){var b=this,c=a.start,d=a.end;return g.Observable.defer(function(){return b._queueAction({type:k.Remove,start:c,end:d})})};a.prototype.abort=function(){this.dispose();this._buffer.abort()};a.prototype.getBuffered=function(){return this._buffer.buffered};a.prototype.dispose=function(){this._buffer.removeEventListener("update",this.__onUpdate);this._buffer.removeEventListener("error",this.__onError);this._buffer.removeEventListener("updateend",
this.__flush);this._queue.length=0;this._flushing=null};a.prototype._onUpdate=function(){this._flushing&&(this._flushing.next(void 0),this._flushing.complete(),this._flushing=null)};a.prototype._onError=function(a){this._flushing&&(this._flushing.error(a),this._flushing=null)};a.prototype._queueAction=function(a){var b=!this._queue.length,c=new l.Subject;if(a.type===k.Append){var d=a.segment;a=a.initSegment;if(null===a&&null===d)return f.default.warn("QueuedSourceBuffer: no segment appended."),g.Observable.of(void 0);
if(null===a)this._queue.unshift({type:k.Append,args:d,subject:c});else if(null===d){if(this._lastInitSegment===a)return g.Observable.of(void 0);this._queue.unshift({type:k.Append,args:a,subject:c})}else this._lastInitSegment!==a&&this._queue.unshift({type:k.Append,args:a,subject:null}),this._queue.unshift({type:k.Append,args:d,subject:c});this._lastInitSegment=a}else if(a.type===k.Remove)this._queue.unshift({type:k.Remove,args:{start:a.start,end:a.end},subject:c});else throw Error("QueuedSourceBuffer: unrecognized action");
b&&this._flush();return c.mapTo(void 0)};a.prototype._flush=function(){if(!this._flushing&&0!==this._queue.length&&!this._buffer.updating){var a=this._queue.pop();this._flushing=a.subject;try{switch(a.type){case k.Append:f.default.debug("pushing data to source buffer",a.args);this._buffer.appendBuffer(a.args);break;case k.Remove:var b=a.args,c=b.start,e=b.end;f.default.debug("removing data from source buffer",c,e);this._buffer.remove(c,e)}}catch(p){this._onError(p)}}};return a}();b.default=e},function(e,
b,a){Object.defineProperty(b,"__esModule",{value:!0});e=a(330).default;b.HTMLTextSourceBuffer=e;a=a(347).default;b.NativeTextSourceBuffer=a},function(e,b,a){function g(a){var b=d.onSeeking$(a),c=d.onSeeked$(a);a=d.onEnded$(a);c=k.Observable.merge(c,a);a=k.Observable.interval(u).startWith(null);return c.startWith(null).switchMapTo(a.mapTo(!0).takeUntil(b).concat(k.Observable.of(!1)))}function l(a,b){if(b)try{a.removeChild(b)}catch(t){h.default.warn("Can't remove text track: not in the element.")}}
var f=this&&this.__extends||function(){var a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(a,b){a.__proto__=b}||function(a,b){for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c])};return function(b,c){function d(){this.constructor=b}a(b,c);b.prototype=null===c?Object.create(c):(d.prototype=c.prototype,new d)}}();Object.defineProperty(b,"__esModule",{value:!0});var k=a(0),c=a(6),d=a(18);e=a(3);var h=a(1),n=a(61),m=a(331),p=a(332),u=e.default.MAXIMUM_HTML_TEXT_TRACK_UPDATE_INTERVAL;a=function(a){function b(b,
d){var f=this;h.default.debug("creating html text track source buffer");f=a.call(this)||this;f._videoElement=b;f._textTrackElement=d;f._destroy$=new c.Subject;f._buffer=new m.default;f._currentElement=null;g(f._videoElement).takeUntil(f._destroy$).subscribe(function(a){a?(a=f._buffer.get(Math.max(f._videoElement.currentTime-u/2E3,0)),a)?f._currentElement!==a.element&&(l(d,f._currentElement),f._currentElement=a.element,d.appendChild(f._currentElement)):(l(d,f._currentElement),f._currentElement=null):
(l(d,f._currentElement),f._currentElement=null)});return f}f(b,a);b.prototype._append=function(a){h.default.debug("appending new html text tracks",a);var b=a.timescale,c=a.start,d=a.end,f=a.data,e=a.type,k=a.language;a=a.timeOffset;d&&0>=d-c?h.default.warn("Invalid text track appended: the start time is inferior or equal to the end time."):(c/=b,b=null!=d?d/b:void 0,f=p.default(e,f,a,k),e=null!=b?b:f[f.length-1].end,this._buffer.insert(f,c,e),this.buffered.insert(c,e))};b.prototype._remove=function(a,
b){h.default.debug("removing html text track data",a,b);this._buffer.remove(a,b);this.buffered.remove(a,b)};b.prototype._abort=function(){h.default.debug("aborting html text track source buffer");this._destroy$.next();this._destroy$.complete();l(this._textTrackElement,this._currentElement)};return b}(n.default);b.default=a},function(e,b,a){function g(a,b){for(var c=0;c<a.length;c++)if(b<a[c].end)return a.slice(0,c);return a.slice()}function l(a,b){for(var c=0;c<a.length;c++)if(b<a[c].end)return a.slice(c+
1,a.length);return[]}function f(a,b,d){b={start:a.start,end:b,cues:g(a.cues,b)};a={start:d,end:a.end,cues:l(a.cues,d)};return[b,a]}Object.defineProperty(b,"__esModule",{value:!0});a(4);e=function(){function a(){this._cuesBuffer=[]}a.prototype.get=function(a){for(var b=this._cuesBuffer,c=b.length-1;0<=c;c--)for(var f=b[c].cues,e=f.length-1;0<=e;e--){var g=f[e];if(a>=g.start){if(a<g.end)return g;return}}};a.prototype.remove=function(a,b){var c=Math.max(a,b);b=this._cuesBuffer;for(var d=b.length;0<d;){var e=
b[0];if(e.end>=c){c=f(e,a,c);d=c[1];this._cuesBuffer[0]=c[0];b.splice(1,0,d);break}else e.cues=g(e.cues,a),e.end=a;for(a=1;a<d;a++)if(e=b[0],c<e.end){b.splice(1,a-1);e.cues=l(e.cues,c);e.start=c;return}b.splice(1,b.length-1);break}};a.prototype.insert=function(a,b,e){var c=this._cuesBuffer;a={start:b,end:e,cues:a};for(var d=0;d<c.length;d++){var h=c[d];if(b<h.end){if(.2>=Math.abs(b-h.start)){if(.2>=Math.abs(e-h.end)){c[d]=a;return}if(e<h.end){h.cues=l(h.cues,e);h.start=e;c.splice(d,0,a);return}do c.splice(d,
1),h=c[d];while(h&&e>h.end);if(!h){c[d]=a;return}if(.2>=Math.abs(e-h.end)){c[d]=a;return}h.cues=l(h.cues,e);h.start=e;c.splice(d,0,a);return}if(b<h.start){if(e<h.start){c.splice(d,0,a);return}if(.2>=Math.abs(e-h.start)){h.start=e;c.splice(d,0,a);return}h.cues=l(h.cues,e);h.start=e;c.splice(d,0,a);return}if(e>h.end||.2>=Math.abs(e-h.end)){h.cues=g(h.cues,b);h.end=b;c.splice(d+1,0,a);return}b=f(h,b,e);e=b[1];this._cuesBuffer[d]=b[0];c.splice(d+1,0,a);c.splice(d+2,0,e);return}}c.push(a)};return a}();
b.default=e},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(1),l={};l.sami=a(333).default;l.ttml=a(334).default;l.srt=a(340).default;l.vtt=a(341).default;b.default=function(a,b,c,d){g.default.debug("finding parser for html text tracks:",a);a=l[a];if(!a)throw Error("no parser found for the given text track");g.default.debug("parser found, parsing...");b=a(b,c,d);g.default.debug("parsed successfully!",b);return b}},function(e,b,a){function g(a){return a.replace(f,function(a,
b){return String.fromCharCode(b)})}Object.defineProperty(b,"__esModule",{value:!0});var l=a(4),f=/&#([0-9]+);/g,k=/<br>/gi,c=/<style[^>]*>([\s\S]*?)<\/style[^>]*>/i,d=/\s*<p class=([^>]+)>(.*)/i,h=/<sync[^>]+?start="?([0-9]*)"?[^0-9]/i;b.default=function(a,b,f){var e=/<sync[ >]/ig,m=/<sync[ >]|<\/body>/ig,p=[],n=a.match(c);n=n?n[1]:"";m.exec(a);var x=/\.(\S+)\s*{([^}]*)}/gi;for(var v={},w;w=x.exec(n);){var y=w[1];w=(w=w[2].match(/\s*lang:\s*(\S+);/i))?w[1]:null;null!=y&&null!=w&&(v[w]=y)}n=(n=/p\s*{([^}]*)}/gi.exec(n))?
n[1]:"";v=v[f];for(l.default(!!v,"sami: could not find lang "+f+" in CSS");;){f=e.exec(a);x=m.exec(a);if(!f&&!x)break;if(!f||!x||f.index>=x.index)throw Error("parse error");f=a.slice(f.index,x.index);x=f.match(h);if(!x)throw Error("parse error (sync time attribute)");x=+x[1];if(isNaN(x))throw Error("parse error (sync time attribute NaN)");f=f.split("\n");x/=1E3;for(y=f.length;0<=--y;)if(w=f[y].match(d)){var z=w[2];if(v===w[1])if("&nbsp;"===z)p[p.length-1].end=x;else{w=document.createElement("DIV");
w.className="rxp-texttrack-region";var B=document.createElement("DIV");B.className="rxp-texttrack-div";B.style.position="absolute";B.style.bottom="0";B.style.width="100%";B.style.color="#fff";B.style.textShadow="-1px -1px 0 #000,1px -1px 0 #000,-1px 1px 0 #000,1px 1px 0 #000";var A=document.createElement("div");A.className="rxp-texttrack-p";n&&(A.style.cssText=n);z=z.split(k);for(var C=0;C<z.length;C++){C&&A.appendChild(document.createElement("BR"));var D=document.createElement("SPAN");D.className=
"rxp-texttrack-span";D.textContent=g(z[C]);A.appendChild(D)}B.appendChild(A);w.appendChild(B);p.push({element:w,start:x+b,end:-1})}}}return p}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(12),l=a(5),f=a(106),k=a(62),c=a(107),d=a(63),h=a(336),n=a(337);b.default=function(a,b){var e=[];if(a=(new DOMParser).parseFromString(a,"text/xml")){var m=a.getElementsByTagName("tt")[0];if(!m)throw Error("invalid XML");a=c.getBodyNode(m);var p=c.getStyleNodes(m),t=c.getRegionNodes(m),
x=c.getTextNodes(m);m=f.default(m);for(var v=[],w=0;w<=p.length-1;w++){var y=p[w];if(y instanceof Element){var z=y.getAttribute("xml:id");null!==z&&v.push({id:z,style:d.getStylingFromElement(y)})}}var B=[];p=function(a){var b=t[a];if(b instanceof Element&&(a=b.getAttribute("xml:id"),null!==a)){var c=d.getStylingFromElement(b),f=b.getAttribute("style");f&&(b=g(v,function(a){return a.id===f}))&&(c=l({},b.style,c));B.push({id:a,style:c})}};for(w=0;w<=t.length-1;w++)p(w);p=null!==a?d.getStylingAttributes(h.STYLE_ATTRIBUTES,
[a],v,B):d.getStylingAttributes(h.STYLE_ATTRIBUTES,[],v,B);for(w=0;w<x.length;w++)y=x[w],y instanceof Element&&(z=k.default(y,"div"),z=l({},p,d.getStylingAttributes(h.STYLE_ATTRIBUTES,[y].concat(z),v,B)),(y=n.default(y,b,v,B,a,z,m))&&e.push(y))}return e}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});b.default=function(a,b,f){return"function"===typeof String.prototype.startsWith?a.startsWith(b,f):a.substr(f||0,b.length)===b}},function(e,b,a){Object.defineProperty(b,"__esModule",
{value:!0});b.STYLE_ATTRIBUTES="backgroundColor color direction display displayAlign extent fontFamily fontSize fontStyle fontWeight lineHeight opacity origin overflow padding textAlign textDecoration textOutline unicodeBidi visibility wrapOption writingMode".split(" ")},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(108),l=a(339);b.default=function(a,b,c,d,e,n,m){if(!a.hasAttribute("begin")&&!a.hasAttribute("end")&&/^\s*$/.test(a.textContent||""))return null;var f=g.default(a,
m),h=f.start;f=f.end;a=l.default(a,e,d,c,n,"default"===m.spaceStyle);return{start:h+b,end:f+b,element:a}}},function(e,b,a){function g(a,b){a=a.exec(b);return null===a||""===a[0]?null:(Number(a[4])||0)/1E3+(Number(a[3])||0)+60*(Number(a[2])||0)+3600*(Number(a[1])||0)}Object.defineProperty(b,"__esModule",{value:!0});var l=a(64);b.default=function(a,b){if(l.REGXP_TIME_COLON_FRAMES.test(a)){a=l.REGXP_TIME_COLON_FRAMES.exec(a);var c=Number(a[1]),d=Number(a[2]),f=Number(a[3]),e=Number(a[4]);e+=(Number(a[5])||
0)/b.subFrameRate;f+=e/b.frameRate;return f+60*d+3600*c}if(l.REGXP_TIME_COLON.test(a))return g(l.REGXP_TIME_COLON,a);if(l.REGXP_TIME_COLON_MS.test(a))return g(l.REGXP_TIME_COLON_MS,a);if(l.REGXP_TIME_FRAMES.test(a))return a=l.REGXP_TIME_FRAMES.exec(a),Number(a[1])/b.frameRate;if(l.REGXP_TIME_TICK.test(a))return a=l.REGXP_TIME_TICK.exec(a),Number(a[1])/b.tickRate;if(l.REGXP_TIME_HMS.test(a))return g(l.REGXP_TIME_HMS,a)}},function(e,b,a){function g(a){var b=d.REGXP_8_HEX_COLOR.exec(a);if(null!=b)return"rgba("+
parseInt(b[1],16)+","+parseInt(b[2],16)+","+parseInt(b[3],16)+","+parseInt(b[4],16)/255+")";b=d.REGXP_4_HEX_COLOR.exec(a);return null!=b?"rgba("+parseInt(b[1]+b[1],16)+","+parseInt(b[2]+b[2],16)+","+parseInt(b[3]+b[3],16)+","+parseInt(b[4]+b[4],16)/255+")":a}function l(a,b){return"-1px -1px "+b+" "+a+","+("1px -1px "+b+" "+a+",")+("-1px 1px "+b+" "+a+",")+("1px 1px "+b+" "+a)}function f(a,b,c,d,f){function e(a,d,m){a=a.childNodes;for(var p=[],q=0;q<a.length;q++){var u=a[q];if("#text"===u.nodeName){var t=
h.getStylingAttributes(["backgroundColor"],m,c,b).backgroundColor;t?d.backgroundColor=t:delete d.backgroundColor;var r=u,v=d;t=f;u=document.createElement("span");r=r.textContent||"";t&&(t=r.trim(),r=t=t.replace(/\s+/g," "));u.innerHTML=r;u.className="rxp-texttrack-span";var x;t=u;if(r=v.color)t.style.color=g(r);if(x=v.backgroundColor)t.style.backgroundColor=g(x);(x=v.wrapOption)&&"noWrap"===x&&(t.style.whiteSpace="nowrap");if(x=v.textOutline){x=x.trim().replace(/\s+/g," ").split(" ");var w=x.length;
if(3===w)r=g(x[0]),x=x[1],t.style.textShadow=l(r,x);else if(r&&1===w)x=x[0],t.style.textShadow=l(r,x);else if(2===w){w=/^[#A-Z]/i.test(x[0]);var E=/^[0-9]/.test(x[0]);w!==E&&(w?(r=g(x[0]),x=x[1],t.style.textShadow=l(r,x)):r&&(x=x[0],t.style.textShadow=l(r,x)))}}if(r=v.textDecoration)switch(r){case "noUnderline":case "noLineThrough":case "noOverline":t.style.textDecoration="none";break;case "lineThrough":t.style.textDecoration="line-through";break;default:t.style.textDecoration=r}if(r=v.fontFamily)switch(r){case "proportionalSansSerif":t.style.fontFamily=
"Arial, Helvetica, Liberation Sans, sans-serif";break;case "monospaceSansSerif":case "sansSerif":t.style.fontFamily="sans-serif";break;case "monospaceSerif":case "default":t.style.fontFamily="Courier New, Liberation Mono, monospace";break;case "proportionalSerif":t.style.fontFamily="serif";break;default:t.style.fontFamily=r}if(r=v.fontStyle)t.style.fontStyle=r;if(r=v.fontWeight)t.style.fontWeight=r;if(r=v.fontSize)t.style.fontSize=r;if(r=v.direction)t.style.direction=r;if(r=v.unicodeBidi)switch(r){case "bidiOverride":t.style.unicodeBidi=
"bidi-override";break;case "embed":t.style.unicodeBidi="embed";break;default:t.style.unicodeBidi="normal"}if(r=v.visibility)t.style.visibility=r;"none"===v.display&&(t.style.display="none");p.push(u)}else"br"===u.nodeName?(u=document.createElement("BR"),p.push(u)):"span"===u.nodeName&&0<u.childNodes.length&&(t=k({},d,h.getStylingAttributes(n,[u],c,b)),p.push.apply(p,e(u,t,[u].concat(m))))}return p}return e(a,k({},d),[])}Object.defineProperty(b,"__esModule",{value:!0});var k=a(5),c=a(62),d=a(64),h=
a(63),n="color direction display fontFamily fontSize fontStyle fontWeight textDecoration textOutline unicodeBidi visibility wrapOption".split(" ");b.default=function(a,b,e,k,l,t){var m=c.default(a,"div"),p=document.createElement("DIV");p.className="rxp-texttrack-region";var q=l.extent;q&&(q=d.REGXP_PERCENT_VALUES.exec(q),null!=q&&(p.style.width=q[1]+"%",p.style.height=q[2]+"%"));p.style.overflow=l.overflow||"hidden";if(q=l.padding)p.style.padding=q;if(q=l.origin)q=d.REGXP_PERCENT_VALUES.exec(q),null!=
q&&(p.style.position="relative",p.style.left=q[1]+"%",p.style.top=q[2]+"%");q=l.displayAlign;p.style.display="flex";p.style.flexDirection="column";if(q)switch(q){case "before":p.style.justifyContent="flex-start";break;case "center":p.style.justifyContent="center";break;case "after":p.style.justifyContent="flex-end"}if(q=l.opacity)p.style.opacity=q;if(q=l.visibility)p.style.visibility=q;"none"===l.display&&(p.style.display="none");b&&(b=h.getStylingAttributes(["backgroundColor"],m.concat([b]),k,e).bodyBackgroundColor)&&
(p.style.backgroundColor=g(b));b=document.createElement("p");b.className="rxp-texttrack-p";if(m=l.backgroundColor)b.style.backgroundColor=g(m);if(m=l.lineHeight)b.style.lineHeight=m;if(m=l.textAlign)switch(m){case "center":b.style.textAlign="center";break;case "left":case "start":b.style.textAlign="left";break;case "right":case "end":b.style.textAlign="right"}a=f(a,e,k,l,t);for(e=0;e<a.length;e++)b.appendChild(a[e]);p.appendChild(b);return p}},function(e,b,a){function g(a){var b=document.createElement("div");
b.innerHTML=a;var c=function(a){var b=a.childNodes,d=document.createElement("span");d.className="rxp-texttrack-span";for(var f=0;f<b.length;f++){var e=b[f];"#text"===e.nodeName?d.innerHTML+=e.textContent:("B"===e.nodeName?(a=c(e),a.style.fontWeight="bold"):"I"===e.nodeName?(a=c(e),a.style.fontStyle="italic"):"U"===e.nodeName?(a=c(e),a.style.textDecoration="underline"):"FONT"===e.nodeName&&null!=e.color?(a=c(e),a.style.color=e.color):a=c(e),d.appendChild(a))}return d};return c(b)}Object.defineProperty(b,
"__esModule",{value:!0});var l=a(109);b.default=function(a,b){var c=a.split(/\r\n|\n|\r/);a=[];for(var d=0;d<c.length;d++)if(c[d]){var f=d;for(d++;c[d];)d++;a.push(c.slice(f,d))}c=[];for(d=0;d<a.length;d++){var e=a[d];f=b;var k=e[1].split(" --\x3e "),p=k[0];k=k[1];e=e.slice(2,e.length);if(p&&k&&e.length)if(p=l.default(p),k=l.default(k),null==p||null==k)f=null;else{var u=document.createElement("div");u.className="rxp-texttrack-p";u.style.fontSize="28px";u.style.position="absolute";u.style.bottom="5%";
u.style.width="100%";u.style.textAlign="center";u.style.color="#fff";u.style.textShadow="-1px -1px 2px #000,1px -1px 2px #000,-1px 1px 2px #000,1px 1px 2px #000";for(var q=0;q<e.length;q++){q&&u.appendChild(document.createElement("br"));var r=g(e[q]);u.appendChild(r)}f={start:p+f,end:k+f,element:u}}else f=null;f&&c.push(f)}return c}},function(e,b,a){function g(a,b,d){var e=document.createElement("div"),h=document.createAttribute("style"),g=0;h.value="width:100%;     height:100%;     display:flex;     flex-direction:column;     justify-content:flex-end;     align-items:center;";
e.setAttributeNode(h);var k=a[g];g++;if((h=c.default(a[g]))&&void 0!==h.start&&void 0!==h.end){g++;var m=document.createElement("p"),n=document.createAttribute("style");n.value="text-align:center";m.setAttributeNode(n);var v=document.createElement("span");n=document.createAttribute("style");n.value="background-color:rgba(0,0,0,0.8);     color:white;";v.setAttributeNode(n);var w=d.filter(function(a){return a.className===k&&!a.isGlobalStyle||a.isGlobalStyle}).map(function(a){return a.styleContent});
w&&(n.value+=w.join(),v.setAttributeNode(n));for(;a[g];)0!==v.childNodes.length&&v.appendChild(document.createElement("br")),f.default(a[g],d).forEach(function(a){v.appendChild(a)}),g++;e.appendChild(m);m.appendChild(v);return{start:h.start+b,end:h.end+b,element:e}}l.default.warn("VTT: Invalid cue, the timecode line could not be parsed.")}Object.defineProperty(b,"__esModule",{value:!0});var l=a(1),f=a(342),k=a(343),c=a(344),d=a(346);b.default=function(a,b){a=a.split(/\r\n|\n|\r/g);var c=[],f=[];if(!a[0].match(/^WEBVTT( |\t|\n|\r|$)/))throw Error("Can't parse WebVTT: Invalid File.");
for(var e=d.getFirstLineAfterHeader(a),h=e;h<a.length;h++)if(d.isStartOfStyleBlock(a[h])){var l=h;for(h++;a[h];)h++;l=a.slice(l,h);l=k.default(l);f.push.apply(f,l)}for(h=e;h<a.length;h++)if(0!==a[h].length)if(d.isStartOfCueBlock(a[h])){e=h;for(h++;a[h];)h++;e=a.slice(e,h);(e=g(e,b,f))&&c.push(e)}else for(;a[h];)h++;return c}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(14);b.default=function(a,b){var f=["u","i","b"],c=["u","i","b","c","#text"],d=b.map(function(a){return a.className});
a=a.replace(/<[0-9]{2}:[0-9]{2}.[0-9]{3}>/,"").replace(/<([u,i,b,c])(\..*?)?(?: .*?)?>(.*?)<\/\1>/g,"<$1$2>$3</$1$2>");return function(a){function e(a){var h=a.nodeName.toLowerCase().split(".")[0];if(g.default(c,h))if("#text"===h)h=document.createTextNode(a.wholeText);else{var k=[];a.nodeName.toLowerCase().split(".").forEach(function(a){-1!==d.indexOf(a)&&k.push(d.indexOf(a))});if(0!==k.length){var l=document.createAttribute("style");k.forEach(function(a){l.value+=b[a].styleContent});h=g.default(f,
h)?h:"span";h=document.createElement(h);h.setAttributeNode(l)}else h=g.default(f,h)?h:"span",h=document.createElement(h);for(var m=0;m<a.childNodes.length;m++)h.appendChild(e(a.childNodes[m]))}else for(h=document.createElement("span"),m=0;m<a.childNodes.length;m++)h.appendChild(e(a.childNodes[m]));return h}for(var h=[],k=0;k<a.length;k++)h[k]=e(a[k]);return h}((new DOMParser).parseFromString(a,"text/html").body.childNodes)}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});b.default=
function(a){var b=[],f=1,e=[];if(a[f].match(/::cue {/))e.push({isGlobalStyle:!0}),f++;else for(var c=void 0;c=a[f].match(/::cue\(\.?(.*?)\)(?:,| {)/);)e.push({className:c[1],isGlobalStyle:!1}),f++;for(var d="";!a[f].match(/}/)&&0!==a[f].length;)d+=a[f],f++;e.forEach(function(a){b.push({className:a.className,isGlobalStyle:a.isGlobalStyle,styleContent:d.replace(/\s/g,"")})});return b}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(345);b.default=function(a){var b=a.match("((?:[0-9]{2}:)?[0-9]{2}:[0-9]{2}.[0-9]{2,3})(?: |\t)--\x3e(?: |\t)((?:[0-9]{2}:)?[0-9]{2}:[0-9]{2}.[0-9]{2,3})");
if(b&&3<=b.length)return a=g.default(b[1]),b=g.default(b[2]),{start:a,end:b}}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});b.default=function(a){var b=a.split(":").reverse();if(b[2]||b[1]){a=b[2]?parseInt(b[2],10):0;var f=parseInt(b[1],10);b=parseFloat(b[0].replace(",","."));return isNaN(a)||isNaN(f)||isNaN(b)?void 0:3600*a+60*f+b}}},function(e,b,a){function g(a){return/^STYLE( .*)?$/g.test(a)}function l(a){return/^NOTE( .*)?$/g.test(a)}function f(a){return/^REGION( .*)?$/g.test(a)}
Object.defineProperty(b,"__esModule",{value:!0});b.getFirstLineAfterHeader=function(a){for(var b=0;b<a.length;){if(""===a[b])return b+1;b++}return b};b.isStartOfStyleBlock=g;b.isStartOfNoteBlock=l;b.isStartOfRegionBlock=f;b.isStartOfCueBlock=function(a){return!l(a)&&!g(a)&&!f(a)&&0!==a.length}},function(e,b,a){var g=this&&this.__extends||function(){var a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(a,b){a.__proto__=b}||function(a,b){for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c])};
...
a);var b=a.timescale,c=a.start,d=a.end,e=a.data,h=a.type,g=a.language;a=a.timeOffset;if(null!=d&&0>=d-c)f.default.warn("Invalid subtitles appended");else if(c/=b,b=null!=d?d/b:void 0,e=k.default(h,e,a,g),0<e.length){h=e[0];g=this._track.cues;0<g.length&&h.startTime<g[g.length-1].startTime&&this._remove(h.startTime,Infinity);for(h=0;h<e.length;h++)this._track.addCue(e[h]);this.buffered.insert(c,null!=b?b:e[e.length-1].endTime)}else null!=b&&this.buffered.insert(c,b)};b.prototype._remove=function(a,
b){f.default.debug("removing native text track data",a,b);for(var c=this._track,d=c.cues,e=d.length-1;0<=e;e--){var h=d[e],g=h.startTime,k=h.endTime;g>=a&&g<=b&&k<=b&&c.removeCue(h)}this.buffered.remove(a,b)};b.prototype._abort=function(){f.default.debug("aborting native text track source buffer");var a=this._trackElement,b=this._videoElement;if(a&&b&&b.hasChildNodes())try{b.removeChild(a)}catch(m){f.default.warn("Can't remove track element from the video")}this._track&&(this._track.mode="disabled");
this._trackElement&&(this._trackElement.innerHTML="")};return b}(e.default);b.default=a},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(1),l={};l.vtt=a(349).default;l.ttml=a(350).default;l.sami=a(351).default;l.srt=a(352).default;b.default=function(a,b,c,d){g.default.debug("finding parser for native text tracks:",a);a=l[a];if(!a)throw Error("no parser found for the given text track");g.default.debug("parser found, parsing...");b=a(b,c,d);g.default.debug("parsed successfully!",
b);return b}},function(e,b,a){function g(a){var b=a.split(":");if(3===b.length){var c=parseInt(b[0],10);a=parseInt(b[1],10);b=parseFloat(b[2]);return isNaN(c)||isNaN(a)||isNaN(b)?void 0:3600*c+60*a+b}if(2===b.length)return a=parseInt(b[0],10),b=parseFloat(b[1]),isNaN(a)||isNaN(b)?void 0:60*a+b}function l(a){return a.split(/ |\t/).reduce(function(a,b){b=b.split(":");2===b.length&&(a[b[0]]=b[1]);return a},{})}Object.defineProperty(b,"__esModule",{value:!0});var f=a(14),k=a(7);b.default=function(a,b){var c=
a.split(/\r\n|\n|\r/);if(!/^WEBVTT($| |\t)/.test(c[0]))throw Error("Can't parse WebVTT: Invalid file.");a=[];for(var d=1;d<c.length;d++){var e=c[d];e=!e||/^(NOTE)|(REGION)|(STYLE)($| |\t)/.test(e)?!1:!0;if(e){e=d;for(d++;c[d];)d++;a.push(c.slice(e,d))}else if(c[d])for(;c[d];)d++}c=[];for(d=0;d<a.length;d++){a:{var p=a[d];e=b;var u=/--\x3e/;if(u.test(p[0]))u=p[0],p=p.slice(1,p.length);else{if(!u.test(p[1])){e=null;break a}u=p[1];p=p.slice(2,p.length)}var q;if(q=u.match(/^([\d:.]+)[ |\t]+--\x3e[ |\t]+([\d:.]+)[ |\t]*(.*)$/)){u=
g(q[1]);var r=g(q[2]);null==u||null==r?q=null:(q=l(q[3]),q={start:u,end:r,settings:q})}else q=null;if(q){if(u=q.start,r=q.end,q=q.settings,p=p.join("\n"),(e=k.makeCue(u+e,r+e,p))&&e instanceof VTTCue){p=q;u=e;!p.vertical||"rl"!==p.vertical&&"lr"!==p.vertical||(u.vertical=p.vertical);if(p.line)if(r=p.line.match(/^(\d+(\.\d+)?)%(,([a-z]+))?/))u.line=r[1],u.snapToLines=!1,f.default(["start","center","end"],r[4])&&(u.lineAlign=r[4]);else if(r=p.line.match(/^(-?\d+)(,([a-z]+))?/))u.line=r[1],u.snapToLines=
!0,f.default(["start","center","end"],r[3])&&(u.lineAlign=r[3]);p.position&&(r=/^([\d\.]+)%(?:,(line-left|line-right|center))?$/.exec(p.position))&&2<=r.length&&(q=parseInt(r[1],10),isNaN(q)||(u.position=q,null!=r[2]&&(u.positionAlign=r[2])));p.size&&(u.size=p.size);p.align&&f.default(["start","center","end","left"],p.align)&&(u.align=p.align)}}else e=null}e&&c.push(e)}return c}},function(e,b,a){function g(a,b,d,e,f,h){if(!a.hasAttribute("begin")&&!a.hasAttribute("end")&&/^\s*$/.test(a.textContent||
""))return null;e=n.default(a,h);d=e.start;e=e.end;a=l(a,"default"===h.spaceStyle);b=c.makeCue(d+b,e+b,a);if(!b)return null;if(b instanceof VTTCue){if(a=f.extent)a=p.REGXP_PERCENT_VALUES.exec(a),null!=a&&(b.size=Number(a[1]));switch(f.writingMode){case "tb":case "tblr":b.vertical="lr";break;case "tbrl":b.vertical="rl"}(a=f.origin)&&p.REGXP_PERCENT_VALUES.exec(a);if(f=f.align)b.align=f,"center"===f&&("center"!==b.align&&(b.align="middle"),b.position="auto"),b.positionAlign=t[f]||"",b.lineAlign=r[f]||
""}return b}function l(a,b){function c(a){a=a.childNodes;for(var d="",e=0;e<a.length;e++){var f=a[e];"#text"===f.nodeName?(f=f.textContent||"",b&&(f=f.trim(),f=f.replace(/\s+/g," ")),d+=f):"br"===f.nodeName?d+="\n":"span"===f.nodeName&&0<f.childNodes.length&&(d+=c(f))}return d}return c(a)}Object.defineProperty(b,"__esModule",{value:!0});var f=a(12),k=a(5),c=a(7),d=a(106),h=a(62),n=a(108),m=a(107),p=a(64),u=a(63),q=["extent","writingMode","origin","align"],r={left:"start",center:"center",right:"end",
start:"start",end:"end"},t={left:"line-left",center:"center",right:"line-right"};b.default=function(a,b){var c=[];if(a=(new DOMParser).parseFromString(a,"text/xml")){var e=a.getElementsByTagName("tt")[0];if(!e)throw Error("invalid XML");var l=m.getBodyNode(e),p=m.getStyleNodes(e),t=m.getRegionNodes(e);a=m.getTextNodes(e);e=d.default(e);for(var r=[],n=0;n<=p.length-1;n++){var v=p[n];if(v instanceof Element){var x=v.getAttribute("xml:id");null!=x&&r.push({id:x,style:u.getStylingFromElement(v)})}}var E=
[];p=function(a){var b=t[a];if(b instanceof Element&&(a=b.getAttribute("xml:id"),null!=a)){var c=u.getStylingFromElement(b),d=b.getAttribute("style");d&&(b=f(r,function(a){return a.id===d}))&&(c=k({},b.style,c));E.push({id:a,style:c})}};for(n=0;n<=t.length-1;n++)p(n);l=l?u.getStylingAttributes(q,[l],r,E):u.getStylingAttributes(q,[],r,E);for(n=0;n<a.length;n++)p=a[n],p instanceof Element&&(v=h.default(p,"div"),v=k({},l,u.getStylingAttributes(q,[p].concat(v),r,E)),(p=g(p,b,r,E,v,e))&&c.push(p))}return c}},
function(e,b,a){function g(a){return a.replace(c,"\n").replace(k,function(a,b){return String.fromCharCode(b)})}Object.defineProperty(b,"__esModule",{value:!0});var l=a(7),f=a(4),k=/&#([0-9]+);/g,c=/<br>/gi,d=/<style[^>]*>([\s\S]*?)<\/style[^>]*>/i,h=/\s*<p class=([^>]+)>(.*)/i,n=/<sync[^>]+?start="?([0-9]*)"?[^0-9]/i;b.default=function(a,b,c){var e=/<sync[ >]/ig,k=/<sync[ >]|<\/body>/ig,m=[],p=a.match(d);p=p?p[1]:"";k.exec(a);var u=/\.(\S+)\s*{([^}]*)}/gi;for(var w={},y;y=u.exec(p);){var z=y[1];y=
(y=y[2].match(/\s*lang:\s*(\S+);/i))?y[1]:null;null!=z&&null!=y&&(w[y]=z)}p=w[c];for(f.default(!!p,"sami: could not find lang "+c+" in CSS");;){c=e.exec(a);u=k.exec(a);if(!c&&!u)break;if(!c||!u||c.index>=u.index)throw Error("parse error");c=a.slice(c.index,u.index);u=c.match(n);if(!u)throw Error("parse error (sync time attribute)");u=+u[1];if(isNaN(u))throw Error("parse error (sync time attribute NaN)");c=c.split("\n");w=u/1E3;for(z=c.length;0<=--z;)if(u=c[z].match(h))y=u[2],p===u[1]&&("&nbsp;"===
y?m[m.length-1].end=w:m.push({text:g(y),start:w+b}))}a=[];for(b=0;b<m.length;b++)p=m[b],e=p.start,k=p.end,(p=p.text)&&null!=k&&(e=l.makeCue(e,k,p),null!=e&&a.push(e));return a}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(7),l=a(109);b.default=function(a,b){var c=a.split(/\r\n|\n|\r/);a=[];for(var d=0;d<c.length;d++)if(c[d]){var e=d;for(d++;c[d];)d++;a.push(c.slice(e,d))}c=[];for(d=0;d<a.length;d++){var f=a[d];e=b;var k=f[1].split(" --\x3e "),p=k[0];k=k[1];f=f.slice(2,
f.length);p&&k&&f.length?(p=l.default(p),k=l.default(k),null==p||null==k?e=null:(f=f.join("\n"),e=g.makeCue(p+e,k+e,f))):e=null;e&&c.push(e)}return c}},function(e,b,a){function g(a,b,c){return{cache:p.default(["audio","video"],a)?new u.default:void 0,maxRetry:"image"===a?0:null!=b?b:n.default.DEFAULT_MAX_PIPELINES_RETRY_ON_ERROR,maxRetryOffline:null!=c?c:n.default.DEFAULT_MAX_PIPELINES_RETRY_ON_OFFLINE}}function l(){for(var a=[],b=0;b<arguments.length;b++)a[b]=arguments[b];a=a.map(function(a){return a.filter(function(a){return"complete-buffer"===
a.type||"active-buffer"===a.type}).map(function(a){return"complete-buffer"===a.type}).startWith(!1).distinctUntilChanged()});return c.Observable.combineLatest.apply(c.Observable,a).filter(function(a){return a.every(function(a){return a})}).mapTo(void 0)}function f(a){a=a.representations;return a[0]&&a[0].getMimeTypeString()||""}function k(a,b){Object.keys(b.adaptations).map(function(c){if(x.default.isNative(c)){var d=b.adaptations[c]||[];d=d?d[0].representations:[];d.length&&(d=d[0].getMimeTypeString(),
a.createSourceBuffer(c,d))}})}Object.defineProperty(b,"__esModule",{value:!0});var c=a(0),d=a(38),h=a(6),n=a(3),m=a(8),p=a(14),u=a(354),q=a(1),r=a(65),t=a(101),x=a(60),v=a(355),w=a(41);b.default=function(a,b,e,p,n,u,H,F,E,G){function y(a,d){var e=new r.default(function(a,b){return a.start-b.start}),f=new h.Subject,g=b.filter(function(a){var b=a.currentTime;a=a.timeOffset;if(!z.getPeriodForTime(a+b))return!1;b=a+b;a=e.head();var c=e.last();b=null==a||null==c?!0:a.start>b||(c.end||Infinity)<b;return b}).take(1).do(function(b){q.default.info("Current position out of the bounds of the active periods,re-creating buffers.",
...
0)}Object.defineProperty(b,"__esModule",{value:!0});var l=a(0),f=a(6),k=a(7),c=a(1),d=a(57),h=a(110),n=a(111),m=a(112),p=a(41),u=a(113);b.default=function(a){var b=a.autoPlay,e=a.clock$,q=a.keySystems,v=a.mediaElement,w=a.speed$,y=a.startAt,z=a.url,B=new f.Subject;a=B.map(p.default.warning);k.clearElementSrc(v);c.default.debug("calculating initial time");var A=function(){return g(v,y)};c.default.debug("initial time calculated:",A);A=u.default(v,A,b);b=A.initialSeek$;A=A.loadAndPlay$;q=d.default(v,
...
r="canplay play progress seeking seeked loadedmetadata canplay ratechange".split(" ");b.default=function(a,b){var d=b.withMediaSource;return k.Observable.create(function(b){function c(c){c=l(a,c&&c.type||"timeupdate");var h;var k=c.state,m=c.currentTime,p=c.bufferGap,t=c.paused,r=c.readyState,n=c.ended,u=e.stalled,v=e.state,x=e.currentTime;var w=c.currentRange;w=null!=w&&c.duration-(p+w.end)<=q;var y=1<=r&&"loadedmetadata"!==k&&!u&&!(w||n),z;d?y&&(p<=q||Infinity===p||1===r)?h=!0:u&&1<r&&Infinity>
p&&(p>g(u)||w||n)&&(z=!0):y&&(!t&&"timeupdate"===k&&"timeupdate"===v&&m===x||"seeking"===k&&Infinity===p)?h=!0:u&&("seeking"!==k&&m!==x||"canplay"===k||Infinity>p&&(p>g(u)||w||n))&&(z=!0);h=h?{reason:"seeking"===k?k:1===r?"not-ready":"buffering",timestamp:Date.now()}:z?null:u;e=f(c,{stalled:h});b.next(e)}var e=f(l(a,"init"),{stalled:null}),k=setInterval(c,d?h:n);r.forEach(function(b){return a.addEventListener(b,c)});b.next(e);return function(){clearInterval(k);r.forEach(function(b){return a.removeEventListener(b,
c)})}}).multicast(function(){return new c.ReplaySubject(1)}).refCount()}},function(e,b,a){Object.defineProperty(b,"__esModule",{value:!0});var g=a(3),l=a(114);b.default=function(a,b,c){if(a.ended)return l.PLAYER_STATES.ENDED;if(c){b=g.default.FORCED_ENDED_THRESHOLD;a=Math.abs(a.duration-a.currentTime);if(null!=b&&a<b)return l.PLAYER_STATES.ENDED;switch(c.reason){case "seeking":return l.PLAYER_STATES.SEEKING;default:return l.PLAYER_STATES.BUFFERING}}return b?l.PLAYER_STATES.PLAYING:l.PLAYER_STATES.PAUSED}},
