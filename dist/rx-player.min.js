...
this._priv_abrManager=null);this._priv_currentManifest=this._priv_isDirectFile=this._priv_activeAdaptations=this._priv_activeRepresentations=null;this._priv_contentURL=void 0;this._priv_contentEventsMemory={period:null,audioTrack:null,textTrack:null,videoBitrate:null,audioBitrate:null,bitrateEstimation:void 0};this._priv_currentImagePlaylist=this._priv_fatalError=null;var c=function(){a._priv_streamLock$.next(!1)};v.clearEMESession().catch(function(){return k.Observable.empty()}).subscribe(m.default,
