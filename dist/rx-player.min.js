...
{}:arguments[0];a.errorCode&&(a={systemCode:a.systemCode,code:a.errorCode.code});this.name="KeySessionError";this.mediaKeyError=a;this.message="MediaKeyError code:"+a.code+" and systemCode:"+a.systemCode}d.prototype=Error();return function(e,n){var f="function"==typeof c?c.call(this):this,l=P(f),b=E(f).map(function(a){throw new d(f.error||a);});try{return a.call(this,e,n),p(l,b).take(1)}catch(r){return q["throw"](r)}}}function f(a,c){if(c instanceof M)return c._setVideo(a);if(a.setMediaKeys)return a.setMediaKeys(c);
...
c;this._mediaKeys=d;this._configuration=e}a.prototype.createMediaKeys=function(){return q.of(this._mediaKeys)};a.prototype.getConfiguration=function(){return this._configuration};d(a,[{key:"keySystem",get:function(){return this._keyType}}]);return a}(),T=m(["loadedmetadata"]),R=m(["sourceopen","webkitsourceopen"]);g=m(["encrypted","needkey"]);var S=m(["keymessage","message"]),P=m(["keyadded","ready"]),E=m(["keyerror","error"]),F=m(["keystatuseschange"]);g={onEncrypted:g,onKeyMessage:S,onKeyStatusesChange:F,
onKeyError:E};!I&&a.prototype.webkitGenerateKeyRequest?function(){var a=function(a,c){var d=this;r.call(this);this._vid=a;this._key=c;this._con=p(S(a),P(a),E(a)).subscribe(function(a){return d.trigger(a.type,a)})};a.prototype=c({},r.prototype,{generateRequest:function(a,c){this._vid.webkitGenerateKeyRequest(this._key,c)},update:l(function(a,c){if(0<=this._key.indexOf("clearkey")){var d=JSON.parse(u(a)),e=x(atob(d.keys[0].k)),d=x(atob(d.keys[0].kid));this._vid.webkitAddKey(this._key,e,d,c)}else this._vid.webkitAddKey(this._key,
a,null,c)}),close:function(){this._con&&this._con.unsubscribe();this._vid=this._con=null}});M=function(a){this.ks_=a};M.prototype={_setVideo:function(a){this._vid=a},createSession:function(){return new a(this._vid,this.ks_)}};var d=function(a){var c=v.querySelector("video")||v.createElement("video");return c&&c.canPlayType?!!c.canPlayType("video/mp4",a):!1};I=function(a,c){if(!d(a))return q["throw"]();for(var e=0;e<c.length;e++){var f=c[e],n=f.videoCapabilities,l=f.audioCapabilities,b=f.initDataTypes,
r=f.sessionTypes,m=f.distinctiveIdentifier,f=f.persistentState,k=!0;if(k=(k=(k=(k=k&&(!b||!!C(b,function(a){return"cenc"===a})))&&(!r||r.filter(function(a){return"temporary"===a}).length===r.length))&&"required"!==m)&&"required"!==f)return e={videoCapabilities:n,audioCapabilities:l,initDataTypes:["cenc"],distinctiveIdentifier:"not-allowed",persistentState:"not-allowed",sessionTypes:["temporary"]},q.of(new L(a,new M(a),e))}return q["throw"]()}}():G&&!I&&function(){var a=function(a){r.call(this);this._mk=
a};a.prototype=c({},r.prototype,{generateRequest:function(a,c){var d=this;this._ss=this._mk.memCreateSession("video/mp4",c);this._con=p(S(this._ss),P(this._ss),E(this._ss)).subscribe(function(a){return d.trigger(a.type,a)})},update:l(function(a,c){t(this._ss);this._ss.update(a,c)},function(){return this._ss}),close:function(){this._ss&&(this._ss.close(),this._ss=null);this._con&&(this._con.unsubscribe(),this._con=null)}});G.prototype.alwaysRenew=!0;G.prototype.memCreateSession=G.prototype.createSession;
G.prototype.createSession=function(){return new a(this)};I=function(a,c){if(!G.isTypeSupported(a))return q["throw"]();for(var d=0;d<c.length;d++){var e=c[d],f=e.videoCapabilities,n=e.audioCapabilities,l=e.initDataTypes,e=e.distinctiveIdentifier,b=!0;if(b=(b=b&&(!l||C(l,function(a){return"cenc"===a})))&&"required"!==e)return d={videoCapabilities:f,audioCapabilities:n,initDataTypes:["cenc"],distinctiveIdentifier:"not-allowed",persistentState:"required",sessionTypes:["temporary","persistent-license"]},
q.of(new L(a,new G(a),d))}return q["throw"]()}}();G||(F=function(){throw Error("eme: MediaKeys is not available");},G={create:F,isTypeSupported:F});if(B.WebKitSourceBuffer&&!B.WebKitSourceBuffer.prototype.addEventListener){var F=B.WebKitSourceBuffer.prototype,N;for(N in r.prototype)F[N]=r.prototype[N];F.__listeners=[];F.appendBuffer=function(a){if(this.updating)throw Error("SourceBuffer updating");this.trigger("updatestart");this.updating=!0;try{this.append(a)}catch(c){this.__emitUpdate("error",c);
return}this.__emitUpdate("update")};F.__emitUpdate=function(a,c){var d=this;setTimeout(function(){d.trigger(a,c);d.updating=!1;d.trigger("updateend")},0)}}N=m(["fullscreenchange","FullscreenChange"],D.concat("MS"));b.exports={HTMLVideoElement_:a,MediaSource_:H,isCodecSupported:function(a){return!!H&&H.isTypeSupported(a)},sourceOpen:function(a){return"open"==a.readyState?q.of(null):R(a).take(1)},canSeek:function(a){return 1<=a.readyState?q.of(null):T(a).take(1)},canPlay:function(a){return 4<=a.readyState?
q.of(null):z(a,"canplay").take(1)},KeySystemAccess:L,requestMediaKeySystemAccess:I,setMediaKeys:function(a,c){return A(f(a,c))},emeEvents:g,shouldRenewMediaKeys:function(){return K},isFullscreen:e,onFullscreenChange:N,requestFullscreen:function(a){e()||(a.requestFullscreen?a.requestFullscreen():a.msRequestFullscreen?a.msRequestFullscreen():a.mozRequestFullScreen?a.mozRequestFullScreen():a.webkitRequestFullscreen&&a.webkitRequestFullscreen(Element.ALLOW_KEYBOARD_INPUT))},exitFullscreen:function(){e()&&
(v.exitFullscreen?v.exitFullscreen():v.msExitFullscreen?v.msExitFullscreen():v.mozCancelFullScreen?v.mozCancelFullScreen():v.webkitExitFullscreen&&v.webkitExitFullscreen())},videoSizeChange:function(){return z(B,"resize")},visibilityChange:function(){var a=void 0;null!=v.hidden?a="":null!=v.mozHidden?a="moz":null!=v.msHidden?a="ms":null!=v.webkitHidden&&(a="webkit");var c=a?a+"Hidden":"hidden";return z(v,a+"visibilitychange").map(function(){return v[c]})},clearVideoSrc:function(a){K?a.removeAttribute("src"):
a.src=""},addTextTrack:function(a){var c=void 0,d=void 0;K?(c=a.addTextTrack("subtitles"),c.mode=c.SHOWING):(d=document.createElement("track"),c=d.track,d.kind="subtitles",c.mode="showing",a.appendChild(d));return{track:c,trackElement:d}},isVTTSupported:function(){return!K},isIE:K}},function(b,g,a){var h=a(8).Observable,k=h.fromEvent,m=h.merge,l=h.timer,f=a(54).getBackedoffDelay,e=a(13),c=a(55);h.prototype.log=function(a,c){a||(a="");return this["do"](function(f){return e.debug(a,"next",c?c(f):f)},
function(c){return e.debug(a,"error",c)},function(){return e.debug(a,"completed")})};b.exports={on:function(a,c){return Array.isArray(c)?m.apply(null,c.map(function(c){return k(a,c)})):k(a,c)},first:function(a){return a.take(1)},only:function(a){return h.never().startWith(a)},retryWithBackoff:function(a,e){var b=e.retryDelay,m=e.totalRetry,k=e.shouldRetry,g=e.resetDelay,h=0,p;0<g&&(p=c(function(){return h=0},g));return function y(){for(var c=0,e=arguments.length,n=Array(e);c<e;c++)n[c]=arguments[c];
return a.apply(null,n)["catch"](function(a){if(k&&!k(a,h)||h++>=m)throw a;a=f(b,h);return l(a).flatMap(function(){p&&p();return y.apply(null,n)})})}}}},function(b,g){b.exports=function(a){return"number"==typeof a&&-1<a&&0==a%1&&9007199254740991>=a}},function(b,g){var a="function"===typeof Symbol&&"symbol"===typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&"function"===typeof Symbol&&a.constructor===Symbol?"symbol":typeof a};b.exports=function(b){return!!b&&"object"==("undefined"===
typeof b?"undefined":a(b))}},function(b,g,a){g=a(66);var h=a(34),k=a(18),m=a(128),l=g(Object,"keys");b.exports=l?function(a){var e=null==a?void 0:a.constructor;return"function"==typeof e&&e.prototype===a||"function"!=typeof a&&h(a)?m(a):k(a)?l(a):[]}:m},function(b,g,a){var h=function(a,b){function l(){this.constructor=a}for(var f in b)b.hasOwnProperty(f)&&(a[f]=b[f]);a.prototype=null===b?Object.create(b):(l.prototype=b.prototype,new l)};b=function(a){function b(l){a.call(this);this.scheduler=l}h(b,
a);b.create=function(a){return new b(a)};b.dispatch=function(a){a.subscriber.complete()};b.prototype._subscribe=function(a){var f=this.scheduler;if(f)return f.schedule(b.dispatch,0,{subscriber:a});a.complete()};return b}(a(1).Observable);g.EmptyObservable=b},function(b,g,a){var h=a(72);g.multicast=function(a){return new h.ConnectableObservable(this,"function"===typeof a?a:function(){return a})}},function(b,g,a){function h(a){var c=m(a);f(c,a);e(c);k(c);return c}function k(a){a["for"]||(a["for"]=l)}
function m(a){a.Symbol||(a.Symbol=function(a){return"@@Symbol("+a+"):"+c++});return a.Symbol}function l(a){return"@@"+a}function f(a,c){if(!a.iterator)if("function"===typeof a["for"])a.iterator=a["for"]("iterator");else if(c.Set&&"function"===typeof(new c.Set)["@@iterator"])a.iterator="@@iterator";else if(c.Map)for(var e=Object.getOwnPropertyNames(c.Map.prototype),f=0;f<e.length;++f){var l=e[f];if("entries"!==l&&"size"!==l&&c.Map.prototype[l]===c.Map.prototype.entries){a.iterator=l;break}}else a.iterator=
...
var e=!1,b=null;c(0);(function(){e=!0;b&&b.unsubscribe()})})}function e(a,c,d){var e=W,b=N;return C(d.createMediaKeys()).flatMap(function(f){N=f;U=d.getConfiguration();O=c;W=a;if(a.mediaKeys===f)return A.of(f);b&&b!==N&&F.dispose();var n=void 0;e&&e!==W?(p.debug("eme: unlink old video element and set mediakeys"),n=G(e,null).concat(G(W,f))):(p.debug("eme: set mediakeys"),n=G(W,f));return n.mapTo(f)})}function c(a,c){p.debug("eme: create a new "+c+" session");return a.createSession(c)}function d(a,
d,e,b,f){var n=c(a,e);F.add(f,n,d);p.debug("eme: generate request",b,f);return C(n.generateRequest(b,f))["do"](function(){"persistent-license"==e&&E.add(f,n)}).mapTo(n)}function n(a,d,e,b,f){p.debug("eme: load persisted session",e);var n=c(a,"persistent-license");return C(n.load(e)).map(function(a){a?(E.add(f,n,d),F.add(f,n)):(p.warn("eme: no data stored for the loaded session, removing it",e),C(n.remove())["catch"](function(a){return p.warn("eme: could not remove session",a)}),E["delete"](f),F["delete"](e));
return{success:a,session:n}})["catch"](function(a){E["delete"](f);F["delete"](e);throw a;})}function r(a,c,e,b,f){return d(a,c,e,b,f)["catch"](function(n){var l=F.getFirst();if(!l)throw n;p.warn("eme: could not create a new session, retry after closing a currently loaded session",n);return C(l.close()).flatMap(function(){return d(a,c,e,b,f)})})}function u(a,c,e,d,b){return n(a,c,e,d,b)["catch"](function(f){p.warn("eme: failed to load persisted session, do fallback",e,f);return r(a,c,"persistent-license",
...
var S={audio:new c(Infinity),video:new c(Infinity)},P={audio:new c(Infinity),video:new c(Infinity)},E={audio:new c(D),video:new c(D),text:new c(D)};return{setLanguage:function(a){I.next(a)},setSubtitle:function(a){L.next(a)},getLanguage:function(){return I.value},getSubtitle:function(){return L.value},getAverageBitrates:function(){return T},getAudioMaxBitrate:function(){return P.audio.value},getVideoMaxBitrate:function(){return P.video.value},getAudioBufferSize:function(){return E.audio.value},getVideoBufferSize:function(){return E.video.value},
setAudioBitrate:function(a){S.audio.next(h(a,Infinity))},setVideoBitrate:function(a){S.video.next(h(a,Infinity))},setAudioMaxBitrate:function(a){P.audio.next(h(a,Infinity))},setVideoMaxBitrate:function(a){P.video.next(h(a,Infinity))},setAudioBufferSize:function(a){E.audio.next(h(a,D))},setVideoBufferSize:function(a){E.video.next(h(a,D))},getBufferAdapters:function(a){var b=a.type,d=a.bitrates,f=a.representations;a=f[0];var g=void 0;if(1<f.length){a=S[b];var g=P[b],h=T[b].map(function(a,b){var c=void 0,
c=0===b?0:J;return k(d,a,c)}).distinctUntilChanged().debounceTime(2E3).startWith(k(d,T[b].getValue(),0));"video"==b&&(g=n(g,K,M,function(a,b,c){if(c)return d[0];b=m(f,b);return b<a?b:a}));g=n(a,g,h,function(a,b,c){var e=void 0,e=Infinity>a?a:Infinity>b?Math.min(b,c):c;return u(f,function(a){return a.bitrate===k(d,e)})}).distinctUntilChanged(function(a,b){return a.id===b.id})["do"](function(a){return e.info("bitrate",b,a.bitrate)})}else g=r(a);return{representations:g,bufferSizes:E[b]||new c(D)}},
...
if(a.isInitSegment()||0>a.getTime())return!0;var d=c.scale(a.getTime()),e=c.scale(a.getDuration());return(d=E.hasRange(d,e))?1.5*d.bitrate<a.getRepresentation().bitrate:!0}var c=new p(H,a),f=new q,g=e(M,P,N).flatMap(function(e,g){var h=e[0],l=e[1],n=new m(J.buffered);I&&!E.equals(n)&&(k.debug("intersect new buffer",D),E.intersect(n));var u=void 0;try{var q=c,t=[];0===g&&(k.debug("add init segment",D),t.push(q.getInitSegment()));if(0===h.readyState)u=t;else{var r=h.ts,p=Math.max(0,Math.min(l,h.liveGap,
(h.duration||Infinity)-r)),h=void 0,x=n.getGap(r),h=x>T&&Infinity>x?Math.min(x,R):0,H=E.getRange(r);if(H&&H.bitrate===a.bitrate){var G=Math.floor(H.end-r);G>h&&(h=G)}var K=q.getSegments(r,h,p),u=t.concat(K)}u=u.filter(b)}catch(O){if(O instanceof w)return L.next({type:"out-of-index",value:O}),d();throw O;}for(n=0;n<u.length;n++)f.add(u[n].getId());return u}).concatMap(function(a){return G({segment:a})}).concatMap(v,function(b){var d=b.parsed;f.remove(b.segment.getId());var e=d.timescale;e&&c.setTimescale(e);
var e=d.nextSegments,d=d.currentSegment,g=void 0,g=e?c.insertNewSegments(e,d):[];d&&E.insert(a.bitrate,c.scale(d.ts),c.scale(d.ts+d.d));return{type:"pipeline",value:h({bufferType:D,addedSegments:g},b)}});return r(g,L)["catch"](function(b){if(412!==b.code)throw b;return l.of({type:"precondition-failed",value:b}).concat(u(2E3)).concat(B(a))}).startWith({type:"buffer",value:{bufferType:D,adaptation:H,representation:a}})}var D=a.bufferType,J=a.sourceBuffer,H=a.adaptation,G=a.pipeline,K=a.adapters,M=a.timings;
a=a.seekings;var I="audio"==D||"video"==D,L=new f,T="video"==D?4:1,R="video"==D?6:1,S=K.representations,P=K.bufferSizes,E=new m,F=r(t(J,"update"),t(J,"error").map(function(a){if(a.target&&a.target.error)throw a.target.error;k.error("buffer: error event",a);throw Error("buffer: error event");})).share(),N=F.ignoreElements().startWith(!0),U=b(function(a){J.appendBuffer(a);return x(F)}),O=b(function(a){J.remove(a.start,a.end);return x(F)});return e(S,a,function(a){return a}).switchMap(B)},EmptyBuffer:function(a){return l.of({type:"buffer",
...
y=a(95),D=y.getEmptyTimings,J=y.timingsSampler,H=y.toWallClockTime,G=y.fromWallClockTime,K=y.getLiveGap,M=a(347).InitializationSegmentCache,I=a(32).BufferedRanges,L=a(357).parseTimeFragment,T=a(348),R=a(53),S=a(362),P=a(352),E=a(345),F=a(355),N=a(92);a=function(a){function b(c){if(!(this instanceof b))throw new TypeError("Cannot call a class as a function");var e=c.videoElement,f=c.transport,g=c.transportOptions,k=c.defaultLanguage,l=c.defaultSubtitle,m=c.initVideoBitrate;c=c.initAudioBitrate;var n=
h(this,a.call(this));n.defaultTransport=f;n.defaultTransportOptions=g||{};e||(e=document.createElement("video"));w(e instanceof z,"requires an actual HTMLVideoElement");e.preload="auto";n.version="2.0.0-alpha1";n.video=e;n.fullscreen=B(e).subscribe(function(){return n.trigger("fullscreenChange",n.isFullscreen())});n.playing=new u;n.stream=new x;var g=P(),f=g.createPipelines,g=g.metrics,q=J(e),e=T(e);n.createPipelines=f;n.metrics=g;n.timings=q;n.adaptive=E(g,q,e,{initVideoBitrate:m,initAudioBitrate:c,
...
b,k.info("set duration",c.duration))}var b=P(a),d=b.timings,e=b.seekings,b=l.of({type:"manifest",value:a}),f=N(),g=U(d,{changePlayback:aa.requiresMediaSource()}),g=F(a).concat(g);a=ha(c,a,d,e);d=ia();return x(b,g,f,a,d)})},L);return function(a,b){return l.create(function(c){m(p,"player: browser is required to support MediaSource");var d=void 0,e=void 0;aa.requiresMediaSource()?(d=new p,e=URL.createObjectURL(d)):(d=null,e=a);b.src=e;c.next({url:a,mediaSource:d});k.info("create mediasource object",
