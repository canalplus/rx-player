 ...
 * @returns {Object}
 */
export default function getLoadedReference(playbackObserver: IReadOnlyPlaybackObserver<IPlaybackObservation>, mediaElement: IMediaElement, isDirectfile: boolean, cancelSignal: CancellationSignal): IReadOnlySharedReference<boolean>;
