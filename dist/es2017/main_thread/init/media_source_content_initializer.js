...
export default class MediaSourceContentInitializer extends ContentInitializer {
    ...
    start(mediaElement, playbackObserver) {
        ...
        this._initializeMediaSourceAndDecryption(mediaElement, protectionRef)
            .then((initResult) => this._onInitialMediaSourceReady(mediaElement, initResult.mediaSource, playbackObserver, {
            protectionRef,
    ...
    async _onInitialMediaSourceReady(mediaElement, initialMediaSource, playbackObserver, decryptionParameters, initialMediaSourceCanceller) {
        var _a;
