 ...
 */
import type { ISegmentSinksStore, IBufferType, IAdaptationChoice, IInbandEvent } from "../../core/types";
...
export declare abstract class ContentInitializer extends EventEmitter<IContentInitializerEvents> {
     ...
     * intervals.
     */
    abstract start(mediaElement: HTMLMediaElement, playbackObserver: IMediaElementPlaybackObserver): void;
    /**
