...
class Player extends EventEmitter {
    ...
    constructor(options = {}) {
        ...
        this.version = /* PLAYER_VERSION */ "4.1.0-tsbdtolerance";
        this.log = log;
        this.state = "STOPPED";
