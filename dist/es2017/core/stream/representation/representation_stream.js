 ...
 * doing.
 */
export default function RepresentationStream({ content, options, playbackObserver, segmentSink, segmentFetcher, terminate, }, callbacks, parentCancelSignal) {
    const { period, adaptation, representation } = content;
    const { bufferGoal, maxBufferSize, drmSystemId, canFilterProtectionData, fastSwitchThreshold, } = options;
