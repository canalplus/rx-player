 ...
 * doing.
 */
export default function StreamOrchestrator(content, playbackObserver, representationEstimator, segmentSinksStore, segmentFetcherCreator, options, callbacks, orchestratorCancelSignal) {
    ...
    // will.
    const shouldReloadOnEncryptedContent = options.failOnEncryptedAfterClear && !hasEncryptedContentInPeriod(initialPeriod);
