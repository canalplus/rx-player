 ...
 * doing.
 */
export default function AdaptationStream({ playbackObserver, content, options, representationEstimator, segmentSink, segmentFetcherCreator, wantedBufferAhead, maxVideoBufferSize, }, callbacks, parentCancelSignal) {
