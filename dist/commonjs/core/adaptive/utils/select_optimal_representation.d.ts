 ...
 */
export default function selectOptimalRepresentation(representations: IRepresentation[], wantedBitrate: number): IRepresentation;
//# sourceMappingURL=select_optimal_representation.d.ts.map