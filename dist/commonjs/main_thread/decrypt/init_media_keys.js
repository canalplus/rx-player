 ...
 */
function initMediaKeys(mediaElement, keySystemsConfigs, cancelSignal) {
    return __awaiter(this, void 0, void 0, function () {
        var mediaKeysInfo, mediaKeys, shouldDisableOldMediaKeys;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, get_media_keys_1.default)(mediaElement, keySystemsConfigs, cancelSignal)];
                case 1:
                    ...
                    if (!browser_detection_1.isWebOs) return [3 /*break*/, 3];
                    return [4 /*yield*/, (0, attach_media_keys_1.disableMediaKeys)(mediaElement)];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
                    (0, attach_media_keys_1.disableMediaKeys)(mediaElement).catch(noop_1.default);
                    _a.label = 4;
