...
exports.getMissingInitDataKeyIds = exports.getMissingKnownKeyIds = exports.getMissingKeyIds = void 0;
...
var ContentDecryptor = /** @class */ (function (_super) {
    ...
    function ContentDecryptor(mediaElement, ksOptions) {
        ...
        _this._stateData = {
            state: {
                name: types_1.ContentDecryptorState.Initializing,
                payload: null,
            },
        ...
        (0, init_media_keys_1.default)(mediaElement, ksOptions, canceller.signal)
            ...
            var mediaKeySystemAccess = mediaKeysInfo.mediaKeySystemAccess;
            /**
             ...
             */
            var systemId = (0, get_drm_system_id_1.default)(mediaKeySystemAccess.keySystem);
            _this.systemId = systemId;
            if (_this._stateData.state.name === types_1.ContentDecryptorState.Initializing) {
                _this._stateData = {
                    state: {
                        name: types_1.ContentDecryptorState.WaitingForAttachment,
                        payload: null,
                    },
                    isInitDataQueueLocked: true,
                    isMediaKeysAttached: 0 /* MediaKeyAttachmentStatus.NotAttached */,
    ...
    ContentDecryptor.prototype.attach = function () {
        var _this = this;
        if (this._stateData.state.name !== types_1.ContentDecryptorState.WaitingForAttachment) {
        ...
        var canFilterProtectionData = (0, is_null_or_undefined_1.default)(options.persistentLicenseConfig) ||
            options.persistentLicenseConfig.disableRetroCompatibility === true;
        if (shouldDisableLock) {
            this._stateData = {
                state: {
                    name: types_1.ContentDecryptorState.ReadyForContent,
                    payload: {
    ...
    ContentDecryptor.prototype.dispose = function () {
        ...
        this._stateData = {
            state: {
                name: types_1.ContentDecryptorState.Disposed,
                payload: null,
            },
    ...
    ContentDecryptor.prototype._processInitializationData = function (initializationData, mediaKeysData) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var mediaKeySystemAccess, stores, options, firstCreatedSession, keyIds, hexKids, period, createdSessions, periodKeys, createdSessions_1, createdSessions_1_1, createdSess, periodKeysArr, periodKeysArr_1, periodKeysArr_1_1, kid, _loop_1, periodKeysArr_2, periodKeysArr_2_1, innerKid, wantedSessionType, _d, EME_DEFAULT_MAX_SIMULTANEOUS_MEDIA_KEY_SESSIONS, EME_MAX_STORED_PERSISTENT_SESSION_INFORMATION, maxSessionCacheSize, sessionRes, sessionInfo, _e, mediaKeySession, sessionType, isSessionPersisted, requestData, error_1, entry, indexInCurrent;
                ...
                switch (_j.label) {
                    case 0:
                        if (log_1.default.hasLevel("DEBUG")) {
                            log_1.default.debug("DRM: processing init data", (_a = initializationData.content) === null || _a === void 0 ? void 0 : _a.adaptation.type, (_b = initializationData.content) === null || _b === void 0 ? void 0 : _b.representation.bitrate, ((_c = initializationData.keyIds) !== null && _c !== void 0 ? _c : []).map(function (k) { return (0, string_parsing_1.bytesToHex)(k); }).join(", "));
                        }
                            ...
                            try {
                                for (createdSessions_1 = __values(createdSessions), createdSessions_1_1 = createdSessions_1.next(); !createdSessions_1_1.done; createdSessions_1_1 = createdSessions_1.next()) {
                                    ...
                                    try {
                                        for (periodKeysArr_1 = (e_2 = void 0, __values(periodKeysArr)), periodKeysArr_1_1 = periodKeysArr_1.next(); !periodKeysArr_1_1.done; periodKeysArr_1_1 = periodKeysArr_1.next()) {
                                            ...
                                            if (createdSess.record.isAssociatedWithKeyId(kid)) {
                                                ...
                                                try {
                                                    ...
                                                    try {
                                                        if (periodKeysArr_2_1 && !periodKeysArr_2_1.done && (_h = periodKeysArr_2.return)) _h.call(periodKeysArr_2);
                                                    }
                                        ...
                                        try {
                                            if (periodKeysArr_1_1 && !periodKeysArr_1_1.done && (_g = periodKeysArr_1.return)) _g.call(periodKeysArr_1);
                                        }
                                ...
                                try {
                                    if (createdSessions_1_1 && !createdSessions_1_1.done && (_f = createdSessions_1.return)) _f.call(createdSessions_1);
                                }
                        ...
                        _d = config_1.default.getCurrent(), EME_DEFAULT_MAX_SIMULTANEOUS_MEDIA_KEY_SESSIONS = _d.EME_DEFAULT_MAX_SIMULTANEOUS_MEDIA_KEY_SESSIONS, EME_MAX_STORED_PERSISTENT_SESSION_INFORMATION = _d.EME_MAX_STORED_PERSISTENT_SESSION_INFORMATION;
                    ...
                    case 1:
                        ...
                        _e = sessionRes.value, mediaKeySession = _e.mediaKeySession, sessionType = _e.sessionType;
    ...
    ContentDecryptor.prototype._onFatalError = function (err) {
        ...
        this._stateData = {
            state: {
                name: types_1.ContentDecryptorState.Error,
        ...
        if (this._stateData.state.name === types_1.ContentDecryptorState.Error) {
            this.trigger("stateChange", this._stateData.state);
        }
    };
    /**
    ...
    ContentDecryptor.prototype._isStopped = function () {
        return (this._stateData.state.name === types_1.ContentDecryptorState.Disposed ||
            this._stateData.state.name === types_1.ContentDecryptorState.Error);
    };
    /**
