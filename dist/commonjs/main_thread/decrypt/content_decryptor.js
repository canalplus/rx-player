...
var should_call_generate_request_before_buffering_media_1 = require("../../compat/should_call_generate_request_before_buffering_media");
...
var ContentDecryptor = /** @class */ (function (_super) {
    ...
    ContentDecryptor.prototype.attach = function () {
        ...
        (0, attach_media_keys_1.default)(mediaElement, stateToAttach, this._canceller.signal)
            ...
            var serverCertificate, resSsc, session, initData, err_1, error, prevState;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (!(0, should_call_generate_request_before_buffering_media_1.default)(mediaKeySystemAccess.keySystem)) return [3 /*break*/, 6];
                        _a.label = 3;
                    case 3:
                        _a.trys.push([3, 5, , 6]);
                    ...
                    case 4:
                        _a.sent();
                        (0, eme_1.closeSession)(session);
                        return [3 /*break*/, 6];
                    case 5:
                        err_1 = _a.sent();
                        error = err_1 instanceof Error ? err_1 : new Error("Unknown Error");
                        log_1.default.warn("DRM: unable to fully perform fake generateRequest call", error);
                        return [3 /*break*/, 6];
                    case 6:
                        if (this._isStopped()) {
                            // We might be stopped since then
