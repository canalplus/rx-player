 ...
 */
export declare function emitSeekEvents(mediaElement: IMediaElement | null, playbackObserver: IReadOnlyPlaybackObserver<IPlaybackObservation>, onSeeking: () => void, onSeeked: () => void, cancelSignal: CancellationSignal): void;
/**
 * @param {HTMLMediaElement} mediaElement
...
export declare function constructPlayerStateReference(initializer: ContentInitializer, mediaElement: IMediaElement, playbackObserver: IReadOnlyPlaybackObserver<IPlaybackObservation>, cancelSignal: CancellationSignal): IReadOnlySharedReference<IPlayerState>;
/**
 ...
 * @returns {string}
 */
export declare function getLoadedContentState(mediaElement: IMediaElement, stalledStatus: IStallingSituation | null): IPlayerState;
