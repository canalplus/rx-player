...
var MediaSourceContentInitializer = /** @class */ (function (_super) {
    ...
    MediaSourceContentInitializer.prototype.start = function (mediaElement, playbackObserver) {
        ...
        this._initializeMediaSourceAndDecryption(mediaElement, protectionRef)
            ...
            return _this._onInitialMediaSourceReady(mediaElement, initResult.mediaSource, playbackObserver, {
                        ...
                        drmInitRef.onUpdate(function (newDrmStatus, stopListeningToDrmUpdatesAgain) {
                            if (newDrmStatus.type === "initialized") {
                                ...
                                resolve({
                                    ...
                                    canFilterProtectionData: newDrmStatus.value.canFilterProtectionData,
                                    failOnEncryptedAfterClear: newDrmStatus.value.failOnEncryptedAfterClear,
    ...
    MediaSourceContentInitializer.prototype._onInitialMediaSourceReady = function (mediaElement, initialMediaSource, playbackObserver, decryptionParameters, initialMediaSourceCanceller) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            ...
            function recursivelyLoadOnMediaSource(mediaSource, startingPos, shouldPlay, currentCanceller) {
                var opts = {
                    ...
                    speed: speed,
                    protectionRef: decryptionParameters.protectionRef,
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 6:
                        ...
                        subBufferOptions = (0, object_assign_1.default)({
