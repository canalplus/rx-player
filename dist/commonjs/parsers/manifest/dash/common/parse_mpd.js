...
function parseCompleteIntermediateRepresentation(mpdIR, args, warnings, xlinkInfos) {
    ...
    var _e = (0, get_minimum_and_maximum_positions_1.default)(parsedPeriods), minimumSafePosition = _e.minimumSafePosition, maximumSafePosition = _e.maximumSafePosition, maximumUnsafePosition = _e.maximumUnsafePosition;
    var now = (0, monotonic_timestamp_1.default)();
    if (!isDynamic) {
        minimumTime = minimumSafePosition;
        if (minimumTime === undefined) {
            minimumTime = (_b = (_a = parsedPeriods[0]) === null || _a === void 0 ? void 0 : _a.start) !== null && _b !== void 0 ? _b : 0;
        }
        ...
        if (parsedPeriods[parsedPeriods.length - 1] !== undefined) {
            ...
            var lastPeriodEnd = (_c = lastPeriod.end) !== null && _c !== void 0 ? _c : (lastPeriod.duration !== undefined
    ...
    var isLastPeriodKnown = !isDynamic ||
        (mpdIR.attributes.minimumUpdatePeriod === undefined &&
            (((_d = parsedPeriods[parsedPeriods.length - 1]) === null || _d === void 0 ? void 0 : _d.end) !== undefined ||
