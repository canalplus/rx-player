 ...
 * @returns {Promise}
 */
export default function removeBufferAroundTime(videoElement: IMediaElement, sourceBufferInterface: MainSourceBufferInterface, time: number, margin: number | undefined): Promise<unknown>;
//# sourceMappingURL=remove_buffer_around_time.d.ts.map