...
describe("Manifest - Manifest", () => {
  const fakeLogger = { warn: jest.fn(() => undefined), info: jest.fn(() => undefined) };
  ...
  beforeEach(() => {
    ...
    jest.mock("../../log", () => ({ __esModule: true as const, default: fakeLogger }));
  ...
  it("should create a Period for each manifest.periods given", () => {
    ...
    jest.mock("../period", () => ({ __esModule: true as const, default: fakePeriod }));
