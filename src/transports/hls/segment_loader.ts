...
export default function generateSegmentLoader({
  ...
  > {
    // XXX TODO
    // const url = constructSegmentUrl(_wantedCdn, context.segment);
    const url = context.segment.url;
    if (url === null) {
