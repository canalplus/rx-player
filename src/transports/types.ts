...
> {
  loadSegment : ISegmentLoader<LoadedFormat>;
  parseSegment : ISegmentParser<LoadedFormat, ParsedSegmentDataFormat>;
}
...
export type ISegmentLoader<LoadedFormat> = (
  ...
  cancelSignal : CancellationSignal,
  callbacks : ISegmentLoaderCallbacks<LoadedFormat>
) => Promise<ISegmentLoaderResultSegmentCreated<LoadedFormat> |
             ISegmentLoaderResultSegmentLoaded<LoadedFormat> |
