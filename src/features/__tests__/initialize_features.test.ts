...
describe("Features - initializeFeaturesObject", () => {
  ...
  it("should set no feature if nothing is enabled", () => {
    ...
    const feat = {};
    jest.mock("../features_object", () => ({ default: feat, __esModule: true as const }));
  ...
  it("should set the right features when everything is enabled", () => {
    ...
    expect(feat).toEqual({
      ...
      mediaSourceInit: jest.requireActual(
        "../../core/init/media_source_content_initializer",
      ).default,
      ...
      directfile: {
        ...
        mediaElementTrackChoiceManager: jest.requireActual(
