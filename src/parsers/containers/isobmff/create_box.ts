 ...
 * @type {Object}
 */
const boxNamesMem: { [boxName: string]: Uint8Array<ArrayBuffer> } = {};
 ...
 * @returns {Uint8Array}
 */
function boxName(str: string): Uint8Array<ArrayBuffer> {
 ...
 */
function createBox(name: string, buff: Uint8Array): Uint8Array<ArrayBuffer> {
