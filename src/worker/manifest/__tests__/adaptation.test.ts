...
import { IRepresentationInfos } from "../../../common/public_types";
...
describe("Manifest - Adaptation", () => {
  ...
  it("should normalize a given language", () => {
    ...
    jest.mock("../../../common/utils/languages", () => ({ __esModule: true as const,
  ...
  /* eslint-enable max-len */
    ...
    jest.mock("../../../common/utils/uniq", () => ({ __esModule: true as const,
                                                     default: mockUniq }));
