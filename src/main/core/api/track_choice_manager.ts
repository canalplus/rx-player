...
import arrayFind from "../../../common/utils/array_find";
import arrayIncludes from "../../../common/utils/array_includes";
import isNullOrUndefined from "../../../common/utils/is_null_or_undefined";
import normalizeLanguage from "../../../common/utils/languages";
import { objectValues } from "../../../common/utils/object_values";
import SortedList from "../../../common/utils/sorted_list";
import takeFirstSet from "../../../common/utils/take_first_set";
import {
  IAdaptationType,
  ISentAdaptation,
  ISentPeriod,
...
function getRightVideoTrack(
   ...
   */
function getSupportedAdaptations(
  period : ISentPeriod,
 ...
 * @returns {Array.<Object>}
 */
function getAdaptations(period : ISentPeriod) : ISentAdaptation[] {
