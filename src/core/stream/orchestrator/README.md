...
called segments - and has to push them to media buffers, called `SegmentBuffers` in the
RxPlayer code.
...
browser-defined _MSE_ SourceBuffers. For any other types, such as "text" and "image",
those buffers are entirely defined in the code of the RxPlayer.
