 ...
 * @returns {Number}
 */
function getPlayedSizeOfRange(timeRanges: TimeRanges, currentTime: number): number {
  const range = getRange(timeRanges, currentTime);
 ...
 * @returns {Number}
 */
function getLeftSizeOfRange(timeRanges: TimeRanges, currentTime: number): number {
  const range = getRange(timeRanges, currentTime);
