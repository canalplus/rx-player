...
describe("utils - bytes", () => {
  ...
  describe("bytesToStr", () => {
    it("should return an empty string for an empty typedArray", () => {
      expect(bytes.bytesToStr(new Uint8Array())).to.equal("");
      expect(bytes.bytesToStr(new Uint16Array())).to.equal("");
      expect(bytes.bytesToStr(new Uint32Array())).to.equal("");
    });
    ...
    it("should return the right string for any typedArray", () => {
      ...
      const arr32 = new Uint32Array(arr);
      ...
      expect(bytes.bytesToStr(arr16)).to.equal(someLetters);
      expect(bytes.bytesToStr(arr32)).to.equal(someLetters);
    });
  });
  ...
  describe("bytesToUTF16Str", () => {
    it("should return an empty string for an empty typedArray", () => {
      ...
      expect(bytes.bytesToUTF16Str(new Uint16Array())).to.equal("");
      expect(bytes.bytesToUTF16Str(new Uint32Array())).to.equal("");
    });
    ...
    it("should consider every other byte for any typedArray", () => {
      ...
      expect(bytes.bytesToUTF16Str(arr16)).to.equal(skipOddLetters);
      expect(bytes.bytesToUTF16Str(arr32)).to.equal(skipOddLetters);
    });
  });
  ...
  describe("bytesToHex", () => {
    it("should return an empty string for an empty typedArray", () => {
      ...
      expect(bytes.bytesToHex(new Uint16Array())).to.equal("");
      expect(bytes.bytesToHex(new Uint32Array())).to.equal("");
    });
  ...
  describe("be2toi", () => {
    it("should return 0 for an empty TypedArray", () => {
      expect(bytes.be2toi(new Uint8Array())).to.equal(0);
      expect(bytes.be2toi(new Uint16Array())).to.equal(0);
      expect(bytes.be2toi(new Uint32Array())).to.equal(0);
    });
  ...
  describe("le2toi", () => {
    it("should return 0 for an empty TypedArray", () => {
      expect(bytes.le2toi(new Uint8Array())).to.equal(0);
      expect(bytes.le2toi(new Uint16Array())).to.equal(0);
      expect(bytes.le2toi(new Uint32Array())).to.equal(0);
    });
