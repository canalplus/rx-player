...
You can then either link directly to the `dist/rx-player.min.js` file (which is our last released version, ``v3.0.0-alpha7``, compiled and minified):
```html
