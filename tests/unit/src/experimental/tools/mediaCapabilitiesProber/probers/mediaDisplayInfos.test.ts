...
import type IProbeMediaDisplayInfos from "../../../../../../../src/experimental/tools/mediaCapabilitiesProber/probers/mediaDisplayInfos.ts";
  ...
  it("should throw if matchMedia is undefined", async () => {
    ...
    const probeMediaDisplayInfos = (
      await vi.importActual(
        "../../../../../../../src/experimental/tools/mediaCapabilitiesProber/probers/mediaDisplayInfos",
      )
