...
import parseWebVTT from "../../../../../../../src/parsers/texttracks/webvtt/html/parse_webvtt_plain_text.ts";
...
vi.mock("../../../../../../../src/parsers/texttracks/webvtt/get_style_blocks", () => ({
  default: mocks.getStyleBlocks,
}));
vi.mock("../../../../../../../src/parsers/texttracks/webvtt/get_cue_blocks", () => ({
  default: mocks.getCueBlocks,
}));
vi.mock("../../../../../../../src/parsers/texttracks/webvtt/parse_cue_block", () => ({
  default: mocks.parseCueBlock,
}));
vi.mock("../../../../../../../src/parsers/texttracks/webvtt/parse_style_block", () => ({
  default: mocks.parseStyleBlock,
}));
vi.mock("../../../../../../../src/parsers/texttracks/webvtt/html/to_html", () => ({
  default: mocks.toHtml,
}));
vi.mock("../../../../../../../src/parsers/texttracks/webvtt/utils", () => ({
