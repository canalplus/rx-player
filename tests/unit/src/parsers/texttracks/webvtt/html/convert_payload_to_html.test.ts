...
import convertPayloadToHTML from "../../../../../../../src/parsers/texttracks/webvtt/html/convert_payload_to_html.ts";
...
vi.mock(
  "../../../../../../../src/parsers/texttracks/webvtt/html/create_styled_element",
  () => ({
