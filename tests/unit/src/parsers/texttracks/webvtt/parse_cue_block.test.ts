...
import parseCueBlock from "../../../../../../src/parsers/texttracks/webvtt/parse_cue_block.ts";
import type parseTimestamp from "../../../../../../src/parsers/texttracks/webvtt/parse_timestamp.ts";
...
vi.mock("../../../../../../src/parsers/texttracks/webvtt/parse_timestamp", () => ({
...
describe("parsers - srt - parseCueBlocks", () => {
  beforeEach(async () => {
    vi.resetModules();
    const actualParseTimestamp = (
      await vi.importActual(
        "../../../../../../src/parsers/texttracks/webvtt/parse_timestamp",
      )
