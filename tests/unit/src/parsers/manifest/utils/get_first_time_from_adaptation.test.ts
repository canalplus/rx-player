...
import type { IRepresentationIndex } from "../../../../../../src/manifest/index.ts";
import getFirstPositionFromAdaptation from "../../../../../../src/parsers/manifest/utils/get_first_time_from_adaptation.ts";
