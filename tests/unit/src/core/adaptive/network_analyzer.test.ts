...
import type { IPlaybackConditionsInfo } from "../../../../../src/core/adaptive/network_analyzer.ts";
import NetworkAnalyzer, {
  estimateRequestBandwidth,
} from "../../../../../src/core/adaptive/network_analyzer.ts";
import type BandwidthEstimator from "../../../../../src/core/adaptive/utils/bandwidth_estimator.ts";
import type {
