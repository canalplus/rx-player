...
import type CmcdDataBuilder from "../../../../../../src/core/cmcd/index.ts";
...
} from "../../../../../../src/core/fetchers/segment/segment_fetcher.ts";
import type {
...
} from "../../../../../../src/core/fetchers/segment/segment_queue.ts";
...
vi.mock(
  "../../../../../../src/core/fetchers/segment/initialization_segment_cache",
  () => ({
    default: mockInitializationSegmentCache,
  }),
);
vi.mock("../../../../../../src/utils/is_null_or_undefined", () => ({
  default: (val: unknown) => val === null || val === undefined,
}));
vi.mock("../../../../../../src/utils/object_assign", () => ({
