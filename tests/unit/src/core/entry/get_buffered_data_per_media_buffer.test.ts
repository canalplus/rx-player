...
import getBufferedDataPerMediaBuffer from "../../../../../src/core/entry/get_buffered_data_per_media_buffer.ts";
import { SourceBufferType } from "../../../../../src/mse/index.ts";

const mockArrayFind = vi.hoisted(() => vi.fn());

vi.mock("../../../../../src/utils/array_find", () => ({
