...
import type {
  ...
  IThumbnailTrack,
} from "../../../../../src/manifest/classes/period.ts";
import {
  replacePeriods,
  updatePeriods,
} from "../../../../../src/manifest/classes/update_periods.ts";
import type { IPeriod, IPeriodMetadata } from "../../../../../src/manifest/index.ts";
import type { IManifestStreamEvent } from "../../../../../src/parsers/manifest/index.ts";
...
vi.mock("../../../../../src/manifest/classes/update_period_in_place.ts", () => ({
