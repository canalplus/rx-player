...
import {
  ...
  createSMHDBox,
  createVMHDBox,
} from "../../../../../../src/transports/smooth/isobmff/create_boxes.ts";
...
vi.mock("../../../../../../src/utils/byte_parsing", () => ({
...
vi.mock("../../../../../../src/utils/string_parsing", () => ({
...
describe("Smooth - ISOBMFF - boxes creation", () => {
  beforeEach(async () => {
    ...
    const actualIsobmff = await vi.importActual(
      "../../../../../../src/parsers/containers/isobmff",
    );
    const actualByteParsing = await vi.importActual(
      "../../../../../../src/utils/byte_parsing",
    );
    const actualStringParsing = await vi.importActual(
      "../../../../../../src/utils/string_parsing",
    );
