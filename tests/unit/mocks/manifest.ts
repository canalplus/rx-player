 ...
 */
import type Adaptation from "../../../src/manifest/classes/adaptation.ts";
import type Manifest from "../../../src/manifest/classes/manifest.ts";
import type Period from "../../../src/manifest/classes/period.ts";
import type Representation from "../../../src/manifest/classes/representation.ts";
import type { IRepresentationIndex, ISegment } from "../../../src/manifest/index.ts";
import { ManifestMetadataFormat } from "../../../src/manifest/types.ts";
...
export const DummyManifest = makeMockedClass<Manifest>(
  {
    ...
    getRefreshUrls: notImplemented("getRefreshUrls"),
