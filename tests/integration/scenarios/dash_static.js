...
describe("dash static SegmentTimeline content", function () {
  ...
  it("should fetch and correctly parse the manifest", async function () {
    ...
    expect(initAudioSegment.media).to.equal("http://demo.unified-streaming.com/video/ateam/ateam.ism/dash/dash/ateam-audio=128000.dash");
    ...
    expect(initVideoSegment.media).to.equal("http://demo.unified-streaming.com/video/ateam/ateam.ism/dash/dash/ateam-video=400000.dash");
    ...
    expect(nextVideoSegment1[0].media).to.equal("http://demo.unified-streaming.com/video/ateam/ateam.ism/dash/dash/ateam-video=400000-0.dash");
    ...
    expect(nextVideoSegment2[1].media).to.equal("http://demo.unified-streaming.com/video/ateam/ateam.ism/dash/dash/ateam-video=400000-4004.dash");
