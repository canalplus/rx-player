...
export default {
  ...
  audio: [{
    init: {
      ...
      data: new Uint8Array(require("arraybuffer-loader!./fixtures/dash_static_SegmentTimeline/ateam-audio=128000.dash")),
    ...
    segments: [
      {
        ...
        data: new Uint8Array(require("arraybuffer-loader!./fixtures/dash_static_SegmentTimeline/ateam-audio=128000-0.dash")),
        contentType: "audio/mp4",
      },
      {
        url: baseURL + "dash/ateam-audio=128000-177341.dash",
        data: new Uint8Array(require("arraybuffer-loader!./fixtures/dash_static_SegmentTimeline/ateam-audio=128000-177341.dash")),
        contentType: "audio/mp4",
      },
      {
        url: baseURL + "dash/ateam-audio=128000-353469.dash",
        data: new Uint8Array(require("arraybuffer-loader!./fixtures/dash_static_SegmentTimeline/ateam-audio=128000-353469.dash")),
        contentType: "audio/mp4",
      },
      {
        url: baseURL + "dash/ateam-audio=128000-530621.dash",
        data: new Uint8Array(require("arraybuffer-loader!./fixtures/dash_static_SegmentTimeline/ateam-audio=128000-530621.dash")),
        contentType: "audio/mp4",
      },
      {
        url: baseURL + "dash/ateam-audio=128000-706749.dash",
        data: new Uint8Array(require("arraybuffer-loader!./fixtures/dash_static_SegmentTimeline/ateam-audio=128000-706749.dash")),
        contentType: "audio/mp4",
      },
      {
        url: baseURL + "dash/ateam-audio=128000-883901.dash",
        data: new Uint8Array(require("arraybuffer-loader!./fixtures/dash_static_SegmentTimeline/ateam-audio=128000-883901.dash")),
        contentType: "audio/mp4",
      },
    ],
  }],
  ...
  video: [
    {
      init: {
        ...
        data: new Uint8Array(require("arraybuffer-loader!./fixtures/dash_static_SegmentTimeline/ateam-video=400000.dash")),
        contentType: "video/mp4",
      },
      segments: [
        {
          url: baseURL + "dash/ateam-video=400000-0.dash",
          data: new Uint8Array(require("arraybuffer-loader!./fixtures/dash_static_SegmentTimeline/ateam-video=400000-0.dash")),
          contentType: "video/mp4",
        },
        {
          url: baseURL + "dash/ateam-video=400000-4004.dash",
          data: new Uint8Array(require("arraybuffer-loader!./fixtures/dash_static_SegmentTimeline/ateam-video=400000-4004.dash")),
          contentType: "video/mp4",
        },
        {
          url: baseURL + "dash/ateam-video=400000-8008.dash",
          data: new Uint8Array(require("arraybuffer-loader!./fixtures/dash_static_SegmentTimeline/ateam-video=400000-8008.dash")),
          contentType: "video/mp4",
        },
        {
          url: baseURL + "dash/ateam-video=400000-12012.dash",
          data: new Uint8Array(require("arraybuffer-loader!./fixtures/dash_static_SegmentTimeline/ateam-video=400000-12012.dash")),
          contentType: "video/mp4",
        },
        {
          url: baseURL + "dash/ateam-video=400000-16016.dash",
          data: new Uint8Array(require("arraybuffer-loader!./fixtures/dash_static_SegmentTimeline/ateam-video=400000-16016.dash")),
          contentType: "video/mp4",
        },
        {
          url: baseURL + "dash/ateam-video=400000-20020.dash",
          data: new Uint8Array(require("arraybuffer-loader!./fixtures/dash_static_SegmentTimeline/ateam-video=400000-20020.dash")),
          contentType: "video/mp4",
        },
      ],
    },
