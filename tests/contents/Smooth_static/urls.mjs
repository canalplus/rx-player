...
const audioSegments = flatMap(
  [
    0, 20053333, 40106666, 60160000, 80000000, 100053333, 120106666, 140160000, 160000000,
    180053333, 200106666, 220160000, 240000000, 260053333, 280106666, 300160000,
    320000000, 340053333, 360106666, 380160000, 400000000, 420053333, 440106666,
    460160000, 480000000, 500053333, 520106666, 540160000, 560000000, 580053333,
    600106666, 620160000, 640000000, 660053333, 680106666, 700160000, 720000000,
    740053333,
  ],
  (time) => {
    return [
      {
        ...
        path: path.join(currentDirectory, `./media/Fragments(audio_und=${time}).mp4`),
...
export default [
  {
    ...
    path: path.join(currentDirectory, "./media/Manifest_Regular.xml"),
    contentType: "text/xml",
  },
  {
    url: BASE_URL + "Manifest_Not_Starting_at_0.xml",
    path: path.join(currentDirectory, "./media/Manifest_Not_Starting_at_0.xml"),
    contentType: "text/xml",
  },
  {
    url: BASE_URL + "Manifest_Empty_Text_Track.xml",
    path: path.join(currentDirectory, "./media/Manifest_Empty_Text_Track.xml"),
    contentType: "text/xml",
  },
  {
    url: BASE_URL + "Manifest_Custom_Attributes.xml",
    path: path.join(currentDirectory, "./media/Manifest_Custom_Attributes.xml"),
    contentType: "text/xml",
  },
  ...audioSegments,
  ...videoSegments,
