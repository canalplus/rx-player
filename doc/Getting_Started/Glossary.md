...
A Period is a sub-element of the [Manifest](#manifest) which defines what the content will
be from a starting time to an ending time.
...
- for DASH contents, it is more or less the same thing as an MPD's `<Period>` element
