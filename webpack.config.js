...
const generateWebpackConfiguration = require("./scripts/generate_webpack_configuration.js");

const shouldMinify = !!process.env.RXP_MINIFY;
const isBarebone = process.env.RXP_BAREBONE === "true";

module.exports = generateWebpackConfiguration(
  "./src/exports.ts",
  {
    library: "RxPlayer",
    libraryTarget: "umd",
  ...
  },
  {
    ...
    features: {
      ...
      BIF_IMAGES: isBarebone ?
        process.env.RXP_BIF_IMAGES === "true" :
        process.env.RXP_BIF_IMAGES !== "false",
    },
  }
);
