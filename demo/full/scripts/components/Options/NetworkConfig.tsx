...
const DEFAULT_SEGMENT_RETRY = DEFAULT_VALUES.loadVideo.networkConfig.segmentRetry;
const DEFAULT_SEGMENT_REQUEST_TIMEOUT =
  DEFAULT_VALUES.loadVideo.networkConfig.segmentRequestTimeout;
const DEFAULT_MANIFEST_RETRY = DEFAULT_VALUES.loadVideo.networkConfig.manifestRetry;
const DEFAULT_MANIFEST_REQUEST_TIMEOUT =
  DEFAULT_VALUES.loadVideo.networkConfig.manifestRequestTimeout;
const DEFAULT_OFFLINE_RETRY = DEFAULT_VALUES.loadVideo.networkConfig.offlineRetry;
...
function RequestConfig({
  ...
  const [offlineRetryStr, setOfflineRetryStr] = useState(String(offlineRetry));
  ...
  useEffect(() => {
    ...
    newVal = isNaN(newVal) ? DEFAULT_OFFLINE_RETRY : newVal;
  ...
  const onChangeLimitOfflineRetry = useCallback((isNotLimited: boolean) => {
    if (isNotLimited) {
